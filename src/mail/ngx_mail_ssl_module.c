...
name|char
modifier|*
name|ngx_mail_ssl_conf_command_check
parameter_list|(
name|ngx_conf_t
modifier|*
name|cf
...
begin_decl_stmt
DECL|variable|ngx_mail_ssl_conf_command_post
specifier|static
name|ngx_conf_post_t
name|ngx_mail_ssl_conf_command_post
init|=
block|{
name|ngx_mail_ssl_conf_command_check
block|}
...
specifier|static
name|int
DECL|function|ngx_mail_ssl_alpn_select (ngx_ssl_conn_t * ssl_conn,const unsigned char ** out,unsigned char * outlen,const unsigned char * in,unsigned int inlen,void * arg)
name|ngx_mail_ssl_alpn_select
parameter_list|(
name|ngx_ssl_conn_t
modifier|*
...
name|char
modifier|*
DECL|function|ngx_mail_ssl_conf_command_check (ngx_conf_t * cf,void * post,void * data)
name|ngx_mail_ssl_conf_command_check
parameter_list|(
name|ngx_conf_t
modifier|*
