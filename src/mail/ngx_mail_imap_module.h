...
ifndef|#
directive|ifndef
name|_NGX_MAIL_IMAP_MODULE_H_INCLUDED_
end_ifndef

begin_define
DECL|macro|_NGX_MAIL_IMAP_MODULE_H_INCLUDED_
define|#
directive|define
name|_NGX_MAIL_IMAP_MODULE_H_INCLUDED_
end_define
...
begin_typedef
DECL|struct|__anon28d19c8d0108
typedef|typedef
struct|struct
block|{
...
name|capabilities
decl_stmt|;
DECL|typedef|ngx_mail_imap_srv_conf_t
block|}
...
begin_comment
comment|/* _NGX_MAIL_IMAP_MODULE_H_INCLUDED_ */
end_comment
