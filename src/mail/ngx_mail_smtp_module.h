...
ifndef|#
directive|ifndef
name|_NGX_MAIL_SMTP_MODULE_H_INCLUDED_
end_ifndef

begin_define
DECL|macro|_NGX_MAIL_SMTP_MODULE_H_INCLUDED_
define|#
directive|define
name|_NGX_MAIL_SMTP_MODULE_H_INCLUDED_
end_define
...
begin_typedef
DECL|struct|__anon29e9c6050108
typedef|typedef
struct|struct
block|{
DECL|member|greeting_delay
name|ngx_msec_t
name|greeting_delay
decl_stmt|;
DECL|member|client_buffer_size
name|size_t
...
name|capabilities
decl_stmt|;
DECL|typedef|ngx_mail_smtp_srv_conf_t
block|}
name|ngx_mail_smtp_srv_conf_t
typedef|;
end_typedef
...
begin_comment
comment|/* _NGX_MAIL_SMTP_MODULE_H_INCLUDED_ */
end_comment
