...
begin_typedef
DECL|struct|__anon288c73e00108
typedef|typedef
struct|struct
block|{
DECL|member|peer
...
name|timeout
decl_stmt|;
DECL|member|pass_client_cert
name|ngx_flag_t
name|pass_client_cert
decl_stmt|;
...
name|ngx_string
argument_list|(
literal|"auth_http_pass_client_cert"
argument_list|)
block|,
name|NGX_MAIL_MAIN_CONF
operator||
...
condition|)
block|{
comment|/* certificate itself, if configured */
if|if
condition|(
...
sizeof|sizeof
argument_list|(
literal|"Proxy-Protocol-Server-Addr: "
argument_list|)
operator|-
literal|1
operator|+
...
sizeof|sizeof
argument_list|(
literal|"Proxy-Protocol-Server-Port: "
argument_list|)
operator|-
literal|1
operator|+
...
name|last
argument_list|,
literal|"Proxy-Protocol-Server-Port: %d"
name|CRLF
argument_list|,
name|c
operator|->
...
condition|)
block|{
comment|/* HELO, MAIL FROM, and RCPT TO can't contain CRLF, no need to escape */
name|b
operator|->
name|last
operator|=
...
literal|0
argument_list|,
literal|"mail auth http header:%N\"%*s\""
argument_list|,
operator|(
name|size_t
operator|)
