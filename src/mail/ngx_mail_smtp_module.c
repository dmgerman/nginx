...
name|void
modifier|*
name|ngx_mail_smtp_create_srv_conf
parameter_list|(
name|ngx_conf_t
modifier|*
name|cf
...
name|char
modifier|*
name|ngx_mail_smtp_merge_srv_conf
parameter_list|(
name|ngx_conf_t
modifier|*
name|cf
...
begin_decl_stmt
DECL|variable|ngx_mail_smtp_auth_methods
specifier|static
name|ngx_conf_bitmask_t
name|ngx_mail_smtp_auth_methods
index|[]
init|=
block|{
block|{
...
begin_decl_stmt
DECL|variable|ngx_mail_smtp_auth_methods_names
specifier|static
name|ngx_str_t
name|ngx_mail_smtp_auth_methods_names
index|[]
init|=
block|{
name|ngx_string
...
begin_decl_stmt
DECL|variable|ngx_mail_smtp_protocol
specifier|static
...
begin_decl_stmt
DECL|variable|ngx_mail_smtp_commands
specifier|static
name|ngx_command_t
name|ngx_mail_smtp_commands
index|[]
init|=
block|{
block|{
...
begin_decl_stmt
DECL|variable|ngx_mail_smtp_module_ctx
specifier|static
name|ngx_mail_module_t
name|ngx_mail_smtp_module_ctx
init|=
block|{
operator|&
name|ngx_mail_smtp_protocol
...
begin_decl_stmt
DECL|variable|ngx_mail_smtp_module
name|ngx_module_t
...
name|void
modifier|*
DECL|function|ngx_mail_smtp_create_srv_conf (ngx_conf_t * cf)
name|ngx_mail_smtp_create_srv_conf
parameter_list|(
name|ngx_conf_t
modifier|*
...
name|char
modifier|*
DECL|function|ngx_mail_smtp_merge_srv_conf (ngx_conf_t * cf,void * parent,void * child)
name|ngx_mail_smtp_merge_srv_conf
parameter_list|(
name|ngx_conf_t
modifier|*
...
literal|0
argument_list|,
literal|"undefined resolver for server in %s:%ui"
argument_list|,
name|cscf
operator|->
name|file_name
