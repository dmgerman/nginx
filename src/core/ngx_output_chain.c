...
name|last_out
decl_stmt|;
comment|/*      * the short path for the case when the ctx->in chain is empty      * and the incoming chain is empty too or it has the single buf      * that does not require the copy      */
if|if
condition|(
name|ctx
operator|->
