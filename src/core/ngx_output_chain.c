...
condition|)
block|{
comment|/*              * allocate a temp buf that equals to a last buf, if the last buf              * size is lesser than 1.25 of bufs.size and the temp buf is single              */
name|size
operator|=
operator|(
name|size_t
...
return|;
block|}
comment|/* allocate block aligned to a disk sector size to enable O_DIRECT */
name|b
operator|->
name|start
operator|=
