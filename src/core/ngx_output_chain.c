...
literal|0
argument_list|,
literal|"negative size buf in output "
literal|"t:%d r:%d f:%d %p %p-%p %p %O-%O"
argument_list|,
name|ctx
operator|->
...
operator|)
comment|/*      * With DIRECTIO, disable sendfile() unless sendfile(SF_NOCACHE)      * is available.      */
if|if
condition|(
name|buf
operator|->
...
literal|0
argument_list|,
literal|"negative size buf in chain writer "
literal|"t:%d r:%d f:%d %p %p-%p %p %O-%O"
argument_list|,
name|in
operator|->
