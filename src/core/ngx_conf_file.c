...
begin_define
DECL|macro|NGX_CONF_BUFFER
define|#
directive|define
name|NGX_CONF_BUFFER
value|4096
end_define
...
begin_comment
comment|/* The eight fixed arguments */
end_comment
...
name|char
modifier|*
DECL|function|ngx_conf_param (ngx_conf_t * cf)
name|ngx_conf_param
parameter_list|(
name|ngx_conf_t
modifier|*
...
specifier|static
name|ngx_int_t
DECL|function|ngx_conf_add_dump (ngx_conf_t * cf,ngx_str_t * filename)
name|ngx_conf_add_dump
parameter_list|(
name|ngx_conf_t
modifier|*
...
literal|0
block|,
DECL|enumerator|parse_block
name|parse_block
block|,
DECL|enumerator|parse_param
name|parse_param
block|}
name|type
enum|;
...
literal|0
argument_list|,
literal|"unexpected end of file, expecting \"}\""
argument_list|)
expr_stmt|;
goto|goto
name|failed
...
literal|0
argument_list|,
literal|"block directives are not supported "
literal|"in -g option"
argument_list|)
expr_stmt|;
goto|goto
...
block|}
block|}
comment|/* rc == NGX_OK || rc == NGX_CONF_BLOCK_START */
if|if
condition|(
name|cf
operator|->
...
literal|0
argument_list|,
literal|"directive \"%s\" is not terminated by \";\""
argument_list|,
name|name
operator|->
name|data
...
literal|0
argument_list|,
literal|"directive \"%s\" has no opening \"{\""
argument_list|,
name|name
operator|->
name|data
...
literal|0
argument_list|,
literal|"unexpected end of parameter, "
literal|"expecting \";\""
argument_list|)
expr_stmt|;
return|return
...
literal|0
argument_list|,
literal|"too long parameter \"%*s...\" started"
argument_list|,
literal|10
argument_list|,
name|start
...
literal|" returned "
literal|"only %z bytes instead of %z"
argument_list|,
name|n
argument_list|,
name|size
...
begin_function
name|ngx_int_t
DECL|function|ngx_conf_full_name (ngx_cycle_t * cycle,ngx_str_t * name,ngx_uint_t conf_prefix)
name|ngx_conf_full_name
parameter_list|(
name|ngx_cycle_t
modifier|*
