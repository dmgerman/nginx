...
begin_typedef
DECL|struct|__anon28feac5e0108
typedef|typedef
struct|struct
block|{
...
specifier|static
name|void
DECL|function|ngx_pcre_free_studies (void * data)
name|ngx_pcre_free_studies
parameter_list|(
name|void
modifier|*
...
expr_stmt|;
comment|/*          * The PCRE JIT compiler uses mmap for its executable codes, so we          * have to explicitly call the pcre_free_study() function to free          * this memory.          */
name|cln
operator|=
