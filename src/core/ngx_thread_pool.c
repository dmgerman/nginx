...
begin_typedef
DECL|struct|__anon2c1539fd0108
typedef|typedef
struct|struct
block|{
DECL|member|pools
...
begin_typedef
DECL|struct|__anon2c1539fd0208
typedef|typedef
struct|struct
block|{
DECL|member|mtx
...
specifier|static
name|ngx_int_t
name|ngx_thread_pool_queue_destroy
parameter_list|(
name|ngx_thread_pool_queue_t
modifier|*
name|queue
...
specifier|static
name|ngx_int_t
DECL|function|ngx_thread_pool_queue_init (ngx_thread_pool_queue_t * queue,ngx_log_t * log)
name|ngx_thread_pool_queue_init
parameter_list|(
name|ngx_thread_pool_queue_t
modifier|*
...
specifier|static
name|ngx_int_t
DECL|function|ngx_thread_pool_queue_destroy (ngx_thread_pool_queue_t * queue,ngx_log_t * log)
name|ngx_thread_pool_queue_destroy
parameter_list|(
name|ngx_thread_pool_queue_t
modifier|*
