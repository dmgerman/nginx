...
begin_comment
comment|/*  * An internal implementation, based on Alexander Peslyak's  * public domain implementation:  * http://openwall.info/wiki/people/solar/software/public-domain-source-code/md5  */
end_comment
