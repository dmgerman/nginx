...
begin_typedef
DECL|struct|__anon2bf792670108
typedef|typedef
struct|struct
block|{
DECL|member|udp
...
begin_typedef
DECL|struct|__anon2bf792670208
typedef|typedef
struct|struct
block|{
DECL|member|sockaddr
...
name|weight
decl_stmt|;
DECL|typedef|ngx_resolver_addr_t
block|}
...
begin_typedef
DECL|struct|__anon2bf792670308
typedef|typedef
struct|struct
block|{
DECL|member|name
...
name|port
decl_stmt|;
DECL|typedef|ngx_resolver_srv_t
block|}
...
begin_typedef
DECL|struct|__anon2bf792670408
typedef|typedef
struct|struct
block|{
DECL|member|name
...
name|addrs
decl_stmt|;
DECL|typedef|ngx_resolver_srv_name_t
block|}
...
begin_typedef
DECL|struct|__anon2bf792670508
typedef|typedef
struct|struct
block|{
DECL|member|node
...
name|name_sentinel
decl_stmt|;
DECL|member|srv_rbtree
name|ngx_rbtree_t
name|srv_rbtree
decl_stmt|;
DECL|member|srv_sentinel
name|ngx_rbtree_node_t
name|srv_sentinel
decl_stmt|;
