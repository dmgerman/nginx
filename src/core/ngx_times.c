...
begin_decl_stmt
DECL|variable|cached_err_log_time0
specifier|static
name|u_char
name|cached_err_log_time0
index|[]
init|=
...
begin_decl_stmt
DECL|variable|cached_err_log_time1
specifier|static
name|u_char
name|cached_err_log_time1
index|[]
init|=
literal|"1970/09/28 12:00:00"
decl_stmt|;
...
begin_decl_stmt
DECL|variable|cached_http_time0
specifier|static
name|u_char
name|cached_http_time0
index|[]
init|=
...
begin_decl_stmt
DECL|variable|cached_http_time1
specifier|static
name|u_char
name|cached_http_time1
index|[]
init|=
literal|"Mon, 28 Sep 1970 06:00:00 GMT"
decl_stmt|;
...
begin_decl_stmt
DECL|variable|cached_http_log_time0
specifier|static
name|u_char
name|cached_http_log_time0
index|[]
init|=
...
begin_decl_stmt
DECL|variable|cached_http_log_time1
specifier|static
name|u_char
name|cached_http_log_time1
index|[]
init|=
literal|"28/Sep/1970:12:00:00 +0600"
decl_stmt|;
...
name|WIN32
operator|)
comment|/*      * we do not use GetLocalTime() because it does not return GMT offset,      * and our ngx_gmtime() is fast enough      */
if|if
condition|(
...
condition|)
block|{
comment|/*          * yday is not used in Win32 SYSTEMTIME          *          * yday -= 306;          */
name|year
operator|++
expr_stmt|;
name|mon
...
block|}
block|}
comment|/*  *  yday is not used in Win32 SYSTEMTIME  *  *  } else {  *      yday += 31 + 28;  *  *      if ((year % 4 == 0)&& (year % 100 || (year % 400 == 0))) {  *           yday++;  *      }  */
block|}
name|tp
operator|->
name|ngx_tm_sec
