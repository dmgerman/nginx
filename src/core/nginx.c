...
literal|0
comment|/* STUB */
block_content|cycle->log->log_level = NGX_LOG_DEBUG|NGX_LOG_DEBUG_HTTP;
endif|#
directive|endif
if|#
directive|if
...
argument|log
argument_list|,
literal|"REOPEN: %d:%d:%s"
argument|_ fd _ file[i].fd _ file[i].name.data
argument_list|)
empty_stmt|;
if|if
condition|(
...
literal|0
comment|/* STUB */
block_content|cycle->log->log_level = NGX_LOG_DEBUG;
endif|#
directive|endif
if|if
condition|(
