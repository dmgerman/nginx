...
directive|if
literal|0
block_content|ngx_memzero(&conf, sizeof(ngx_conf_t));     ngx_test_null(conf.args,                   ngx_create_array(ngx_pool, 10, sizeof(ngx_str_t)), 1);     conf.pool = ngx_pool;     conf.log =&ngx_log;      conf_file.len = sizeof("nginx.conf") - 1;     conf_file.data = "nginx.conf";      ngx_conf_parse(&conf,&conf_file);
endif|#
directive|endif
name|ngx_test_null
argument_list|(
