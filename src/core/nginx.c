...
name|ngx_string
argument_list|(
literal|"worker_shutdown_timeout"
argument_list|)
block|,
name|NGX_MAIN_CONF
operator||
...
specifier|static
name|void
DECL|function|ngx_cleanup_environment (void * data)
name|ngx_cleanup_environment
parameter_list|(
name|void
modifier|*
...
condition|)
block|{
comment|/*          * if the environment is still used, as it happens on exit,          * the only option is to leak it          */
return|return;
block|}
name|ngx_free
argument_list|(
...
return|;
block|}
comment|/*      * set by ngx_pcalloc()      *      *     ccf->pid = NULL;      *     ccf->oldpid = NULL;      *     ccf->priority = 0;      *     ccf->cpu_affinity_auto = 0;      *     ccf->cpu_affinity_n = 0;      *     ccf->cpu_affinity = NULL;      */
name|ccf
operator|->
name|daemon
operator|=
...
literal|0
argument_list|,
literal|"invalid number of arguments in "
literal|"\"worker_cpu_affinity\" directive"
argument_list|)
expr_stmt|;
return|return
name|NGX_CONF_ERROR
...
literal|0
argument_list|,
literal|"\"worker_cpu_affinity\" supports up to %d CPUs only"
argument_list|,
name|CPU_SETSIZE
argument_list|)
expr_stmt|;
...
name|char
modifier|*
DECL|function|ngx_set_worker_processes (ngx_conf_t * cf,ngx_command_t * cmd,void * conf)
name|ngx_set_worker_processes
parameter_list|(
name|ngx_conf_t
modifier|*
...
name|char
modifier|*
DECL|function|ngx_load_module (ngx_conf_t * cf,ngx_command_t * cmd,void * conf)
name|ngx_load_module
parameter_list|(
name|ngx_conf_t
modifier|*
...
literal|0
argument_list|,
literal|"\"load_module\" is not supported "
...
specifier|static
name|void
DECL|function|ngx_unload_module (void * data)
name|ngx_unload_module
parameter_list|(
name|void
modifier|*
