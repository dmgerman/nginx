...
begin_typedef
DECL|struct|__anon2c4f85c10108
typedef|typedef
struct|struct
block|{
DECL|member|start
...
name|written
decl_stmt|;
DECL|typedef|ngx_log_memory_buf_t
block|}
name|ngx_log_memory_buf_t
typedef|;
end_typedef
...
literal|0
argument_list|,
literal|"nginx was built without debug support"
argument_list|)
expr_stmt|;
return|return
name|NGX_CONF_ERROR
...
specifier|static
name|void
DECL|function|ngx_log_memory_writer (ngx_log_t * log,ngx_uint_t level,u_char * buf,size_t len)
name|ngx_log_memory_writer
parameter_list|(
name|ngx_log_t
modifier|*
...
specifier|static
name|void
DECL|function|ngx_log_memory_cleanup (void * data)
name|ngx_log_memory_cleanup
parameter_list|(
name|void
modifier|*
...
literal|0
argument_list|,
literal|"destroy memory log buffer"
argument_list|)
expr_stmt|;
name|log
operator|->
