...
directive|if
literal|0
block_content|ngx_log_debug2(NGX_LOG_DEBUG_ALLOC, ngx_cycle->log, 0,                    "slab alloc: page %p next: %p", page, page->next);
endif|#
directive|endif
if|if
condition|(
