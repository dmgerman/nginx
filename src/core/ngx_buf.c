...
begin_function
name|void
DECL|function|ngx_chain_update_chains (ngx_pool_t * p,ngx_chain_t ** free,ngx_chain_t ** busy,ngx_chain_t ** out,ngx_buf_tag_t tag)
...
begin_function
name|off_t
DECL|function|ngx_chain_coalesce_file (ngx_chain_t ** in,off_t limit)
