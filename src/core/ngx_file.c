...
begin_function
name|ngx_int_t
DECL|function|ngx_create_path_and_rename_file (ngx_str_t * src,ngx_str_t * to,ngx_uint_t access,ngx_uint_t full_path,ngx_uint_t delete,ngx_log_t * log)
name|ngx_create_path_and_rename_file
parameter_list|(
name|ngx_str_t
modifier|*
name|src
