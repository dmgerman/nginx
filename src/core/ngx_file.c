...
begin_function
name|ngx_int_t
DECL|function|ngx_get_full_name (ngx_pool_t * pool,ngx_str_t * prefix,ngx_str_t * name)
...
specifier|static
name|ngx_int_t
DECL|function|ngx_test_full_name (ngx_str_t * name)
name|ngx_test_full_name
parameter_list|(
name|ngx_str_t
modifier|*
...
literal|0
argument_list|,
literal|"the same path name \"%V\" "
literal|"used in %s:%ui and"
argument_list|,
operator|&
name|p
index|[
