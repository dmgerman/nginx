...
directive|if
literal|0
block_content|n = old_cycle->open_files.nelts ? old_cycle->open_files.nelts : 20;     cycle->open_files.elts = ngx_pcalloc(pool, n * sizeof(ngx_open_file_t));     if (cycle->open_files.elts == NULL) {         ngx_destroy_pool(pool);         return NULL;     }     cycle->open_files.nelts = 0;     cycle->open_files.size = sizeof(ngx_open_file_t);     cycle->open_files.nalloc = n;     cycle->open_files.pool = pool;
endif|#
directive|endif
if|if
condition|(
...
directive|if
literal|0
block_content|file = cycle->open_files.elts;         for (i = 0; i< cycle->open_files.nelts; i++) {
endif|#
directive|endif
if|if
condition|(
...
directive|if
literal|0
block_content|file = old_cycle->open_files.elts;     for (i = 0; i< old_cycle->open_files.nelts; i++) {
endif|#
directive|endif
if|if
condition|(
