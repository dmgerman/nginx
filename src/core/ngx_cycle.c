...
specifier|static
name|void
name|ngx_shutdown_timer_handler
parameter_list|(
name|ngx_event_t
modifier|*
name|ev
...
begin_decl_stmt
DECL|variable|ngx_shutdown_event
specifier|static
name|ngx_event_t
name|ngx_shutdown_event
decl_stmt|;
end_decl_stmt
...
block|}
block|}
comment|/* free the newly created shared memory */
name|part
operator|=
operator|&
name|cycle
...
name|NGX_WIN32
operator|)
comment|/* remap at the required address */
if|if
condition|(
name|ngx_shm_remap
argument_list|(
...
literal|0
argument_list|,
literal|"shared zone \"%V\" has no equal addresses: %p vs %p"
argument_list|,
operator|&
name|zn
operator|->
...
begin_function
name|void
DECL|function|ngx_set_shutdown_timer (ngx_cycle_t * cycle)
...
specifier|static
name|void
DECL|function|ngx_shutdown_timer_handler (ngx_event_t * ev)
name|ngx_shutdown_timer_handler
parameter_list|(
name|ngx_event_t
modifier|*
