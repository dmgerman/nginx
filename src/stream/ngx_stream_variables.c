...
specifier|static
name|ngx_int_t
name|ngx_stream_variable_proxy_protocol_tlv
parameter_list|(
name|ngx_stream_session_t
modifier|*
name|s
...
specifier|static
name|ngx_int_t
DECL|function|ngx_stream_variable_proxy_protocol_tlv (ngx_stream_session_t * s,ngx_stream_variable_value_t * v,uintptr_t data)
name|ngx_stream_variable_proxy_protocol_tlv
parameter_list|(
name|ngx_stream_session_t
modifier|*
