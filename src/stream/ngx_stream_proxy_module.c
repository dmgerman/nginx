...
specifier|static
name|ngx_int_t
name|ngx_stream_proxy_test_finalize
parameter_list|(
name|ngx_stream_session_t
modifier|*
name|s
...
name|char
modifier|*
name|ngx_stream_proxy_ssl_conf_command_check
parameter_list|(
name|ngx_conf_t
modifier|*
name|cf
...
specifier|static
name|void
name|ngx_stream_proxy_ssl_save_session
parameter_list|(
name|ngx_connection_t
modifier|*
name|c
...
specifier|static
name|ngx_int_t
name|ngx_stream_proxy_ssl_certificate
parameter_list|(
name|ngx_stream_session_t
modifier|*
name|s
...
specifier|static
name|ngx_int_t
name|ngx_stream_proxy_merge_ssl
parameter_list|(
name|ngx_conf_t
modifier|*
name|cf
...
begin_decl_stmt
DECL|variable|ngx_stream_proxy_ssl_conf_command_post
specifier|static
name|ngx_conf_post_t
name|ngx_stream_proxy_ssl_conf_command_post
init|=
block|{
name|ngx_stream_proxy_ssl_conf_command_check
block|}
...
literal|0
argument_list|,
literal|"stream proxy add preread buffer: %uz"
argument_list|,
name|c
operator|->
name|buffer
...
literal|0
argument_list|,
literal|"stream proxy add PROXY protocol header"
argument_list|)
expr_stmt|;
name|cl
operator|=
...
name|char
modifier|*
DECL|function|ngx_stream_proxy_ssl_conf_command_check (ngx_conf_t * cf,void * post,void * data)
name|ngx_stream_proxy_ssl_conf_command_check
parameter_list|(
name|ngx_conf_t
modifier|*
...
specifier|static
name|void
DECL|function|ngx_stream_proxy_ssl_save_session (ngx_connection_t * c)
name|ngx_stream_proxy_ssl_save_session
parameter_list|(
name|ngx_connection_t
modifier|*
...
specifier|static
name|ngx_int_t
DECL|function|ngx_stream_proxy_ssl_certificate (ngx_stream_session_t * s)
name|ngx_stream_proxy_ssl_certificate
parameter_list|(
name|ngx_stream_session_t
modifier|*
...
literal|0
argument_list|,
literal|"stream upstream ssl cert: \"%s\""
argument_list|,
name|cert
operator|.
name|data
...
literal|0
argument_list|,
literal|"stream upstream ssl key: \"%s\""
argument_list|,
name|key
operator|.
name|data
...
condition|)
block|{
comment|/*                      * successfully terminate timed out UDP session                      * if expected number of responses was received                      */
name|handler
operator|=
name|c
operator|->
...
literal|0
argument_list|,
literal|"udp timed out"
literal|", packets from/to client:%ui/%ui"
...
literal|0
argument_list|,
literal|"stream proxy %s socket shutdown"
argument_list|,
name|from_upstream
condition|?
literal|"client"
...
specifier|static
name|ngx_int_t
DECL|function|ngx_stream_proxy_test_finalize (ngx_stream_session_t * s,ngx_uint_t from_upstream)
name|ngx_stream_proxy_test_finalize
parameter_list|(
name|ngx_stream_session_t
modifier|*
...
condition|)
block|{
comment|/* avoid closing live connections until both read ends get EOF */
if|if
condition|(
operator|!
operator|(
...
return|;
block|}
comment|/*      * set by ngx_pcalloc():      *      *     conf->ssl_protocols = 0;      *     conf->ssl_ciphers = { 0, NULL };      *     conf->ssl_trusted_certificate = { 0, NULL };      *     conf->ssl_crl = { 0, NULL };      *      *     conf->ssl = NULL;      *     conf->upstream = NULL;      *     conf->upstream_value = NULL;      */
name|conf
operator|->
name|connect_timeout
operator|=
...
specifier|static
name|ngx_int_t
DECL|function|ngx_stream_proxy_merge_ssl (ngx_conf_t * cf,ngx_stream_proxy_srv_conf_t * conf,ngx_stream_proxy_srv_conf_t * prev)
name|ngx_stream_proxy_merge_ssl
parameter_list|(
name|ngx_conf_t
modifier|*
...
name|log
expr_stmt|;
comment|/*      * special handling to preserve conf->ssl      * in the "stream" section to inherit it to all servers      */
if|if
condition|(
name|preserve
condition|)
