...
begin_typedef
DECL|struct|__anon27ba7bb10108
typedef|typedef
struct|struct
block|{
DECL|member|addr
...
begin_typedef
DECL|struct|__anon27ba7bb10208
typedef|typedef
struct|struct
block|{
...
return|;
block|}
comment|/*      * set by ngx_pcalloc():      *      *     conf->ssl_protocols = 0;      *     conf->ssl_ciphers = { 0, NULL };      *     conf->ssl_trusted_certificate = { 0, NULL };      *     conf->ssl_crl = { 0, NULL };      *     conf->ssl_certificate = { 0, NULL };      *     conf->ssl_certificate_key = { 0, NULL };      *      *     conf->ssl = NULL;      *     conf->upstream = NULL;      *     conf->upstream_value = NULL;      */
name|conf
operator|->
name|connect_timeout
operator|=
