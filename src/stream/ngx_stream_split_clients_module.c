...
begin_typedef
DECL|struct|__anon28b5ffb00108
typedef|typedef
struct|struct
block|{
DECL|member|percent
...
name|value
decl_stmt|;
DECL|typedef|ngx_stream_split_clients_part_t
block|}
name|ngx_stream_split_clients_part_t
typedef|;
end_typedef

begin_typedef
DECL|struct|__anon28b5ffb00208
typedef|typedef
struct|struct
block|{
DECL|member|value
...
name|parts
decl_stmt|;
DECL|typedef|ngx_stream_split_clients_ctx_t
block|}
name|ngx_stream_split_clients_ctx_t
typedef|;
end_typedef
...
begin_decl_stmt
DECL|variable|ngx_stream_split_clients_commands
specifier|static
name|ngx_command_t
name|ngx_stream_split_clients_commands
index|[]
init|=
block|{
block|{
...
begin_decl_stmt
DECL|variable|ngx_stream_split_clients_module_ctx
specifier|static
name|ngx_stream_module_t
name|ngx_stream_split_clients_module_ctx
init|=
block|{
name|NULL
block|,
...
begin_decl_stmt
DECL|variable|ngx_stream_split_clients_module
name|ngx_module_t
...
specifier|static
name|ngx_int_t
DECL|function|ngx_stream_split_clients_variable (ngx_stream_session_t * s,ngx_stream_variable_value_t * v,uintptr_t data)
name|ngx_stream_split_clients_variable
parameter_list|(
...
name|char
modifier|*
DECL|function|ngx_stream_split_clients (ngx_conf_t * cf,ngx_command_t * dummy,void * conf)
name|ngx_stream_split_clients
parameter_list|(
name|ngx_conf_t
modifier|*
