...
begin_define
DECL|macro|NGX_IMAP_WAIT_OK
define|#
directive|define
name|NGX_IMAP_WAIT_OK
value|0
end_define

begin_define
DECL|macro|NGX_IMAP_WAIT_NEXT
define|#
directive|define
name|NGX_IMAP_WAIT_NEXT
value|1
end_define
...
specifier|static
name|ngx_int_t
DECL|function|ngx_imap_proxy_read_response (ngx_imap_session_t * s,ngx_uint_t what)
name|ngx_imap_proxy_read_response
parameter_list|(
name|ngx_imap_session_t
modifier|*
