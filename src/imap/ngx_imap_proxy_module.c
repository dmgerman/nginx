...
name|timeout
decl_stmt|;
DECL|typedef|ngx_imap_proxy_conf_t
block|}
name|ngx_imap_proxy_conf_t
typedef|;
end_typedef
...
specifier|static
name|void
name|ngx_imap_proxy_imap_handler
parameter_list|(
name|ngx_event_t
modifier|*
name|rev
...
specifier|static
name|void
name|ngx_imap_proxy_pop3_handler
parameter_list|(
name|ngx_event_t
modifier|*
name|rev
...
specifier|static
name|void
name|ngx_imap_proxy_upstream_error
parameter_list|(
name|ngx_imap_session_t
modifier|*
name|s
...
name|void
modifier|*
name|ngx_imap_proxy_create_conf
parameter_list|(
name|ngx_conf_t
modifier|*
name|cf
...
name|char
modifier|*
name|ngx_imap_proxy_merge_conf
parameter_list|(
name|ngx_conf_t
modifier|*
name|cf
...
begin_decl_stmt
DECL|variable|ngx_imap_proxy_commands
specifier|static
name|ngx_command_t
name|ngx_imap_proxy_commands
index|[]
init|=
block|{
block|{
...
begin_decl_stmt
DECL|variable|ngx_imap_proxy_module_ctx
specifier|static
name|ngx_imap_module_t
name|ngx_imap_proxy_module_ctx
init|=
block|{
name|NULL
block|,
...
begin_decl_stmt
DECL|variable|ngx_imap_proxy_module
name|ngx_module_t
name|ngx_imap_proxy_module
init|=
block|{
name|NGX_MODULE_V1
block|,
...
specifier|static
name|void
DECL|function|ngx_imap_proxy_imap_handler (ngx_event_t * rev)
name|ngx_imap_proxy_imap_handler
parameter_list|(
name|ngx_event_t
modifier|*
...
literal|0
argument_list|,
literal|"imap proxy imap auth handler"
argument_list|)
expr_stmt|;
name|c
operator|=
...
specifier|static
name|void
DECL|function|ngx_imap_proxy_pop3_handler (ngx_event_t * rev)
name|ngx_imap_proxy_pop3_handler
parameter_list|(
name|ngx_event_t
modifier|*
...
literal|0
argument_list|,
literal|"imap proxy pop3 auth handler"
argument_list|)
expr_stmt|;
name|c
operator|=
...
specifier|static
name|void
DECL|function|ngx_imap_proxy_dummy_handler (ngx_event_t * wev)
name|ngx_imap_proxy_dummy_handler
parameter_list|(
name|ngx_event_t
modifier|*
...
specifier|static
name|ngx_int_t
DECL|function|ngx_imap_proxy_read_response (ngx_imap_session_t * s,ngx_uint_t state)
name|ngx_imap_proxy_read_response
parameter_list|(
name|ngx_imap_session_t
modifier|*
...
specifier|static
name|void
DECL|function|ngx_imap_proxy_upstream_error (ngx_imap_session_t * s)
name|ngx_imap_proxy_upstream_error
parameter_list|(
name|ngx_imap_session_t
modifier|*
...
literal|0
argument_list|,
literal|"close imap proxy connection: %d"
argument_list|,
name|s
operator|->
name|proxy
...
specifier|static
name|void
DECL|function|ngx_imap_proxy_internal_server_error (ngx_imap_session_t * s)
name|ngx_imap_proxy_internal_server_error
parameter_list|(
name|ngx_imap_session_t
modifier|*
...
name|void
modifier|*
DECL|function|ngx_imap_proxy_create_conf (ngx_conf_t * cf)
name|ngx_imap_proxy_create_conf
parameter_list|(
name|ngx_conf_t
modifier|*
...
name|char
modifier|*
DECL|function|ngx_imap_proxy_merge_conf (ngx_conf_t * cf,void * parent,void * child)
name|ngx_imap_proxy_merge_conf
parameter_list|(
name|ngx_conf_t
modifier|*
