...
specifier|static
name|void
name|ngx_imap_proxy_greeting_handler
parameter_list|(
name|ngx_event_t
modifier|*
name|rev
...
begin_function
DECL|function|ngx_imap_proxy_greeting_handler (ngx_event_t * rev)
specifier|static
name|void
name|ngx_imap_proxy_greeting_handler
parameter_list|(
...
literal|0
argument_list|,
literal|"imap proxy greeting handler"
argument_list|)
expr_stmt|;
name|c
operator|=
