...
specifier|static
name|ngx_int_t
name|ngx_imap_decode_auth_plain
parameter_list|(
...
return|return;
block|}
comment|/* rc == NGX_IMAP_PARSE_INVALID_COMMAND */
break|break;
block|}
name|rc
operator|=
...
specifier|static
name|ngx_int_t
DECL|function|ngx_imap_decode_auth_plain (ngx_imap_session_t * s,ngx_str_t * encoded)
name|ngx_imap_decode_auth_plain
parameter_list|(
name|ngx_imap_session_t
modifier|*
...
specifier|static
name|void
DECL|function|ngx_imap_do_auth (ngx_imap_session_t * s)
name|ngx_imap_do_auth
parameter_list|(
name|ngx_imap_session_t
modifier|*
