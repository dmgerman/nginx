...
begin_comment
comment|/*     The data is ready - 3 syscalls:         aio_read(), aio_error(), aio_return()     The data is not ready - 4 (kqueue) or 5 syscalls:         aio_read(), aio_error(), notifiction,                                              aio_error(), aio_return()                                              aio_cancel(), aio_error() */
end_comment

begin_function
DECL|function|ngx_event_aio_read (ngx_connection_t * c,char * buf,size_t size)
name|ssize_t
name|ngx_event_aio_read
parameter_list|(
