...
begin_typedef
DECL|struct|__anon28bf2b260108
typedef|typedef
struct|struct
block|{
DECL|member|engine
...
begin_function
name|ngx_int_t
DECL|function|ngx_ssl_client_certificate (ngx_conf_t * cf,ngx_ssl_t * ssl,ngx_str_t * cert)
...
name|u_char
modifier|*
DECL|function|ngx_ssl_get_protocol (ngx_connection_t * c)
...
name|u_char
modifier|*
DECL|function|ngx_ssl_get_cipher_name (ngx_connection_t * c)
