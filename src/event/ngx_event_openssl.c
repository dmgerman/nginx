...
begin_typedef
DECL|struct|__anon29c1e5d30108
typedef|typedef
struct|struct
block|{
DECL|member|engine
...
condition|)
block|{
comment|/*          * if the previous key is no longer needed (or not initialized),          * replace it with the current key and generate new current key          */
name|key
index|[
literal|1
index|]
