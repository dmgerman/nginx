...
begin_function
name|ngx_int_t
DECL|function|ngx_ssl_certificate (ngx_ssl_t * ssl,u_char * cert,u_char * key)
...
literal|0
argument_list|,
literal|"\"ssl_engine\" is not supported: "
name|NGX_SSL_NAME
literal|" library does not support crypto accelerators"
argument_list|)
expr_stmt|;
return|return
name|NGX_CONF_ERROR
