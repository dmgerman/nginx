...
condition|)
block|{
comment|/*          * there should be at least one connection for each listening          * socket, plus an additional connection for channel          */
name|ngx_log_error
argument_list|(
name|NGX_LOG_EMERG
argument_list|,
...
literal|"for %ui listening sockets"
argument_list|,
name|cycle
operator|->
name|connection_n
...
return|;
block|}
comment|/* cloning may change cycle->listening.elts */
name|ls
operator|=
name|cycle
operator|->
...
literal|0
argument_list|,
literal|"the \"timer_resolution\" directive is not supported "
literal|"with the configured event method, ignored"
argument_list|)
expr_stmt|;
name|ngx_timer_resolution
operator|=
...
literal|0
argument_list|,
literal|"%s in debug_connection \"%V\""
argument_list|,
name|u
operator|.
name|err
