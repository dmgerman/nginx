...
name|resolver_timeout
decl_stmt|;
DECL|typedef|ngx_ssl_ocsp_conf_t
block|}
name|ngx_ssl_ocsp_conf_t
typedef|;
end_typedef
...
name|expire_queue
decl_stmt|;
DECL|typedef|ngx_ssl_ocsp_cache_t
block|}
name|ngx_ssl_ocsp_cache_t
typedef|;
end_typedef
...
name|valid
decl_stmt|;
DECL|typedef|ngx_ssl_ocsp_cache_node_t
block|}
name|ngx_ssl_ocsp_cache_node_t
typedef|;
end_typedef
...
specifier|static
name|void
name|ngx_ssl_ocsp_validate_next
parameter_list|(
...
specifier|static
name|ngx_int_t
name|ngx_ssl_ocsp_cache_lookup
parameter_list|(
name|ngx_ssl_ocsp_ctx_t
modifier|*
name|ctx
...
specifier|static
name|ngx_int_t
DECL|function|ngx_ssl_stapling_certificate (ngx_conf_t * cf,ngx_ssl_t * ssl,X509 * cert,ngx_str_t * file,ngx_str_t * responder,ngx_uint_t verify)
name|ngx_ssl_stapling_certificate
parameter_list|(
name|ngx_conf_t
modifier|*
...
name|valid
expr_stmt|;
comment|/*      * refresh before the response expires,      * but not earlier than in 5 minutes, and at least in an hour      */
name|staple
operator|->
name|loading
operator|=
...
specifier|static
name|time_t
DECL|function|ngx_ssl_stapling_time (ASN1_GENERALIZEDTIME * asn1time)
name|ngx_ssl_stapling_time
parameter_list|(
name|ASN1_GENERALIZEDTIME
modifier|*
...
begin_function
name|ngx_int_t
DECL|function|ngx_ssl_ocsp (ngx_conf_t * cf,ngx_ssl_t * ssl,ngx_str_t * responder,ngx_uint_t depth,ngx_shm_zone_t * shm_zone)
name|ngx_ssl_ocsp
parameter_list|(
name|ngx_conf_t
modifier|*
...
begin_function
name|ngx_int_t
DECL|function|ngx_ssl_ocsp_resolver (ngx_conf_t * cf,ngx_ssl_t * ssl,ngx_resolver_t * resolver,ngx_msec_t resolver_timeout)
...
begin_function
name|ngx_int_t
DECL|function|ngx_ssl_ocsp_validate (ngx_connection_t * c)
...
literal|0
argument_list|,
literal|"X509_STORE_CTX_get1_chain() failed"
argument_list|)
expr_stmt|;
name|X509_STORE_CTX_free
argument_list|(
...
specifier|static
name|void
DECL|function|ngx_ssl_ocsp_validate_next (ngx_connection_t * c)
name|ngx_ssl_ocsp_validate_next
parameter_list|(
name|ngx_connection_t
modifier|*
...
literal|0
argument_list|,
literal|"ssl ocsp validated, certs:%ui"
argument_list|,
name|ocsp
operator|->
name|ncert
...
literal|0
argument_list|,
literal|"ssl ocsp validate cert:%ui"
argument_list|,
name|ocsp
operator|->
name|ncert
...
literal|0
argument_list|,
literal|"ssl ocsp cached status \"%s\""
argument_list|,
name|OCSP_cert_status_str
argument_list|(
name|ctx
...
specifier|static
name|void
DECL|function|ngx_ssl_ocsp_handler (ngx_ssl_ocsp_ctx_t * ctx)
name|ngx_ssl_ocsp_handler
parameter_list|(
name|ngx_ssl_ocsp_ctx_t
modifier|*
...
specifier|static
name|ngx_int_t
DECL|function|ngx_ssl_ocsp_responder (ngx_connection_t * c,ngx_ssl_ocsp_ctx_t * ctx)
name|ngx_ssl_ocsp_responder
parameter_list|(
name|ngx_connection_t
modifier|*
...
literal|0
argument_list|,
literal|"no OCSP responder URL in certificate"
argument_list|)
expr_stmt|;
return|return
name|NGX_ERROR
...
literal|0
argument_list|,
literal|"%s in OCSP responder \"%V\" in certificate"
argument_list|,
name|u
operator|.
name|err
...
literal|0
argument_list|,
literal|"empty host in OCSP responder in certificate"
argument_list|)
expr_stmt|;
return|return
name|NGX_ERROR
...
begin_function
name|ngx_int_t
DECL|function|ngx_ssl_ocsp_get_status (ngx_connection_t * c,const char ** s)
...
name|s
operator|=
literal|"certificate status request failed"
expr_stmt|;
return|return
name|NGX_DECLINED
return|;
...
break|break;
default|default:
comment|/* V_OCSP_CERTSTATUS_UNKNOWN */
operator|*
name|s
operator|=
literal|"certificate status unknown"
expr_stmt|;
block|}
return|return
name|NGX_DECLINED
...
begin_function
name|void
DECL|function|ngx_ssl_ocsp_cleanup (ngx_connection_t * c)
...
name|ngx_ssl_ocsp_ctx_t
modifier|*
DECL|function|ngx_ssl_ocsp_start (ngx_log_t * log)
name|ngx_ssl_ocsp_start
parameter_list|(
name|ngx_log_t
modifier|*
...
specifier|static
name|void
DECL|function|ngx_ssl_ocsp_next (ngx_ssl_ocsp_ctx_t * ctx)
name|ngx_ssl_ocsp_next
parameter_list|(
name|ngx_ssl_ocsp_ctx_t
modifier|*
...
literal|0
argument_list|,
literal|"ssl ocsp connect %ui/%ui"
argument_list|,
name|ctx
operator|->
name|naddr
...
specifier|static
name|ngx_int_t
DECL|function|ngx_ssl_ocsp_verify (ngx_ssl_ocsp_ctx_t * ctx)
name|ngx_ssl_ocsp_verify
parameter_list|(
name|ngx_ssl_ocsp_ctx_t
modifier|*
...
literal|0
argument_list|,
literal|"invalid nextUpdate time in certificate status"
argument_list|)
expr_stmt|;
goto|goto
name|error
...
begin_function
name|ngx_int_t
DECL|function|ngx_ssl_ocsp_cache_init (ngx_shm_zone_t * shm_zone,void * data)
...
specifier|static
name|ngx_int_t
DECL|function|ngx_ssl_ocsp_cache_lookup (ngx_ssl_ocsp_ctx_t * ctx)
name|ngx_ssl_ocsp_cache_lookup
parameter_list|(
name|ngx_ssl_ocsp_ctx_t
modifier|*
...
literal|0
argument_list|,
literal|"ssl ocsp cache expired"
argument_list|)
expr_stmt|;
return|return
name|NGX_DECLINED
...
specifier|static
name|ngx_int_t
DECL|function|ngx_ssl_ocsp_cache_store (ngx_ssl_ocsp_ctx_t * ctx)
name|ngx_ssl_ocsp_cache_store
parameter_list|(
name|ngx_ssl_ocsp_ctx_t
modifier|*
...
literal|0
argument_list|,
literal|"ssl ocsp cache store, valid:%T"
argument_list|,
name|valid
operator|-
name|now
...
literal|0
argument_list|,
literal|"could not allocate new entry%s"
argument_list|,
name|shpool
operator|->
name|log_ctx
...
specifier|static
name|ngx_int_t
DECL|function|ngx_ssl_ocsp_create_key (ngx_ssl_ocsp_ctx_t * ctx)
name|ngx_ssl_ocsp_create_key
parameter_list|(
name|ngx_ssl_ocsp_ctx_t
modifier|*
...
literal|0
argument_list|,
literal|"\"ssl_ocsp\" is not supported on this platform"
argument_list|)
expr_stmt|;
return|return
name|NGX_ERROR
