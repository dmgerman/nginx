...
begin_typedef
DECL|struct|__anon278fd1320108
typedef|typedef
struct|struct
block|{
DECL|member|staple
...
begin_typedef
DECL|struct|__anon278fd1320208
typedef|typedef
struct|struct
block|{
DECL|member|addrs
...
begin_function
name|ngx_int_t
DECL|function|ngx_ssl_ocsp (ngx_conf_t * cf,ngx_ssl_t * ssl,ngx_str_t * responder,ngx_uint_t depth)
name|ngx_ssl_ocsp
parameter_list|(
name|ngx_conf_t
modifier|*
