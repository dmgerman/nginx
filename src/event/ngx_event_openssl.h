...
begin_typedef
DECL|struct|__anon2b7bf4090108
typedef|typedef
struct|struct
block|{
DECL|member|ctx
...
begin_typedef
DECL|struct|__anon2b7bf4090208
typedef|typedef
struct|struct
block|{
...
begin_typedef
DECL|typedef|ngx_ssl_cached_sess_t
typedef|typedef
name|struct
name|ngx_ssl_cached_sess_s
...
value|(4096 - offsetof(ngx_ssl_cached_sess_t, asn1))
end_define

begin_typedef
DECL|struct|__anon2b7bf4090308
typedef|typedef
struct|struct
block|{
DECL|member|node
...
begin_struct
DECL|struct|ngx_ssl_cached_sess_s
struct|struct
name|ngx_ssl_cached_sess_s
block|{
DECL|member|prev
...
begin_typedef
DECL|struct|__anon2b7bf4090408
typedef|typedef
struct|struct
block|{
