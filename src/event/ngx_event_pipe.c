...
literal|0
argument_list|,
literal|"pipe read upstream: aio"
argument_list|)
expr_stmt|;
return|return
name|NGX_AGAIN
...
literal|0
argument_list|,
literal|"pipe read upstream: writing"
argument_list|)
expr_stmt|;
name|rc
operator|=
...
literal|0
argument_list|,
literal|"recycled buffer in pipe out chain"
argument_list|)
expr_stmt|;
block|}
name|p
...
literal|0
argument_list|,
literal|"pipe buf ls:%d %p, pos %p, size: %z"
argument_list|,
name|cl
operator|->
name|buf
...
condition|)
block|{
comment|/* update previous buffer or add new buffer */
if|if
condition|(
name|p
operator|->
...
literal|0
argument_list|,
literal|"input data after close"
argument_list|)
expr_stmt|;
return|return
name|NGX_OK
