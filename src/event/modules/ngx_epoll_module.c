...
begin_decl_stmt
DECL|variable|ngx_use_epoll_rdhup
name|ngx_uint_t
...
specifier|static
name|ngx_int_t
DECL|function|ngx_epoll_notify_init (ngx_log_t * log)
name|ngx_epoll_notify_init
parameter_list|(
name|ngx_log_t
modifier|*
...
specifier|static
name|void
DECL|function|ngx_epoll_notify_handler (ngx_event_t * ev)
name|ngx_epoll_notify_handler
parameter_list|(
name|ngx_event_t
modifier|*
...
literal|0
argument_list|,
literal|"read() eventfd %d: %z count:%uL"
argument_list|,
name|notify_fd
argument_list|,
name|n
...
specifier|static
name|ngx_int_t
DECL|function|ngx_epoll_notify (ngx_event_handler_pt handler)
name|ngx_epoll_notify
parameter_list|(
name|ngx_event_handler_pt
name|handler
...
name|ngx_errno
argument_list|,
literal|"write() to eventfd %d failed"
argument_list|,
name|notify_fd
argument_list|)
expr_stmt|;
...
specifier|static
name|ngx_int_t
DECL|function|ngx_epoll_module_init (ngx_cycle_t * cycle)
name|ngx_epoll_module_init
parameter_list|(
name|ngx_cycle_t
modifier|*
...
literal|0
argument_list|,
literal|"testing the EPOLLRDHUP flag: %s"
argument_list|,
name|ngx_use_epoll_rdhup
condition|?
literal|"success"
