...
begin_decl_stmt
DECL|variable|master_read_fds
specifier|static
name|fd_set
name|master_read_fds
decl_stmt|;
end_decl_stmt

begin_decl_stmt
DECL|variable|master_write_fds
specifier|static
name|fd_set
name|master_write_fds
decl_stmt|;
end_decl_stmt

begin_decl_stmt
DECL|variable|work_read_fds
specifier|static
name|fd_set
name|work_read_fds
decl_stmt|;
...
literal|0
argument_list|,
literal|"ngx_select_init: maximum number of descriptors "
...
literal|0
argument_list|,
literal|"ngx_select_init: maximum descriptor number"
literal|"supported by select() is %d"
argument_list|,
name|FD_SETSIZE
operator|-
...
name|ngx_assert
argument_list|(
argument|(flags != NGX_ONESHOT_EVENT)
argument_list|,
argument|return -
literal|1
argument_list|,
argument|ev->log
argument_list|,
literal|"ngx_select_add_event: NGX_ONESHOT_EVENT is not supported"
argument_list|)
empty_stmt|;
name|fds
operator|=
...
begin_function
DECL|function|ngx_select_get_fd_set (ngx_socket_t fd,int event,ngx_log_t * log)
specifier|static
name|fd_set
modifier|*
name|ngx_select_get_fd_set
...
argument|log
argument_list|,
literal|"ngx_select_get_fd_set: %d %d"
argument|_ fd _ event
argument_list|)
empty_stmt|;
if|#
directive|if
...
literal|0
argument_list|,
literal|"ngx_select_get_event: maximum descriptor number"
literal|"supported by select() is %d"
argument_list|,
name|FD_SETSIZE
operator|-
...
literal|0
argument_list|,
literal|"ngx_select_get_event: maximum number of descriptors "
literal|"supported by select() is %d"
argument_list|,
name|FD_SETSIZE
argument_list|)
...
argument|log
argument_list|,
literal|"ngx_select_get_fd_set: invalid event %d"
argument|_ event
argument_list|)
empty_stmt|;
block|}
...
argument|log
argument_list|,
literal|"ngx_select_process_events: change max_fd: %d"
argument|_                       max_fd
argument_list|)
empty_stmt|;
block|}
