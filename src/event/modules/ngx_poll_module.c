...
directive|if
literal|0
block_content|ngx_log_debug4(NGX_LOG_DEBUG_EVENT, cycle->log, 0,                        "poll: %d: fd:%d ev:%04Xd rev:%04Xd",                        i, event_list[i].fd, event_list[i].events, revents);
else|#
directive|else
if|if
condition|(
