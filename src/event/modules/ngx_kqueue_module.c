...
begin_typedef
DECL|struct|__anon27cc5d580108
typedef|typedef
struct|struct
block|{
DECL|member|changes
...
begin_comment
comment|/*  * The "change_list" should be declared as ngx_thread_volatile.  * However, the use of the change_list is localized in kqueue functions and  * is protected by the mutex so even the "icc -ipo" should not build the code  * with the race condition.  Thus we avoid the declaration to make a more  * readable code.  */
end_comment

begin_decl_stmt
DECL|variable|change_list
DECL|variable|change_list0
DECL|variable|change_list1
specifier|static
name|struct
name|kevent
modifier|*
...
literal|0
argument_list|,
literal|"kevent timer: %M, delta: %M"
argument_list|,
name|timer
argument_list|,
name|delta
