...
directive|if
literal|0
block_content|timer_queue.timer_prev =&timer_queue;     timer_queue.timer_next =&timer_queue;
endif|#
directive|endif
if|#
directive|if
...
directive|if
literal|0
block_content|if (timer_queue.timer_next !=&timer_queue) {         timer = timer_queue.timer_next->timer_delta;         ts.tv_sec = timer / 1000;         ts.tv_nsec = (timer % 1000) * 1000000;         tp =&ts;         gettimeofday(&tv, NULL);         delta = tv.tv_sec * 1000 + tv.tv_usec / 1000;      } else {         timer = 0;         delta = 0;         tp = NULL;     }
endif|#
directive|endif
if|#
directive|if
