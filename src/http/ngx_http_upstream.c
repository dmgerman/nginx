...
specifier|static
name|ngx_int_t
name|ngx_http_upstream_cache_get
parameter_list|(
name|ngx_http_request_t
modifier|*
name|r
...
specifier|static
name|ngx_int_t
name|ngx_http_upstream_cache_background_update
parameter_list|(
name|ngx_http_request_t
modifier|*
name|r
...
specifier|static
name|ngx_int_t
name|ngx_http_upstream_cache_check_range
parameter_list|(
name|ngx_http_request_t
modifier|*
name|r
...
specifier|static
name|ngx_int_t
name|ngx_http_upstream_cache_last_modified
parameter_list|(
name|ngx_http_request_t
modifier|*
name|r
...
specifier|static
name|ngx_int_t
name|ngx_http_upstream_cache_etag
parameter_list|(
name|ngx_http_request_t
modifier|*
name|r
...
specifier|static
name|ngx_int_t
name|ngx_http_upstream_send_request_body
parameter_list|(
name|ngx_http_request_t
modifier|*
name|r
...
specifier|static
name|void
name|ngx_http_upstream_read_request_handler
parameter_list|(
name|ngx_http_request_t
modifier|*
name|r
...
specifier|static
name|ngx_int_t
name|ngx_http_upstream_process_trailers
parameter_list|(
name|ngx_http_request_t
modifier|*
name|r
...
specifier|static
name|ngx_int_t
name|ngx_http_upstream_thread_handler
parameter_list|(
...
specifier|static
name|void
name|ngx_http_upstream_thread_event_handler
parameter_list|(
name|ngx_event_t
modifier|*
name|ev
...
specifier|static
name|ngx_int_t
name|ngx_http_upstream_output_filter
parameter_list|(
name|void
modifier|*
name|data
...
specifier|static
name|ngx_int_t
name|ngx_http_upstream_process_last_modified
parameter_list|(
name|ngx_http_request_t
modifier|*
name|r
...
specifier|static
name|ngx_int_t
name|ngx_http_upstream_process_vary
parameter_list|(
name|ngx_http_request_t
modifier|*
name|r
...
specifier|static
name|ngx_int_t
name|ngx_http_upstream_trailer_variable
parameter_list|(
name|ngx_http_request_t
modifier|*
name|r
...
specifier|static
name|ngx_int_t
name|ngx_http_upstream_set_local
parameter_list|(
name|ngx_http_request_t
modifier|*
name|r
...
specifier|static
name|void
name|ngx_http_upstream_ssl_handshake_handler
parameter_list|(
name|ngx_connection_t
modifier|*
name|c
...
specifier|static
name|void
name|ngx_http_upstream_ssl_save_session
parameter_list|(
name|ngx_connection_t
modifier|*
name|c
...
specifier|static
name|ngx_int_t
name|ngx_http_upstream_ssl_name
parameter_list|(
name|ngx_http_request_t
modifier|*
name|r
...
specifier|static
name|ngx_int_t
name|ngx_http_upstream_ssl_certificate
parameter_list|(
name|ngx_http_request_t
modifier|*
name|r
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_upstream_cache_get (ngx_http_request_t * r,ngx_http_upstream_t * u,ngx_http_file_cache_t ** cache)
name|ngx_http_upstream_cache_get
parameter_list|(
name|ngx_http_request_t
modifier|*
...
literal|0
argument_list|,
literal|"cache file \"%s\" contains invalid header"
argument_list|,
name|c
operator|->
name|file
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_upstream_cache_background_update (ngx_http_request_t * r,ngx_http_upstream_t * u)
name|ngx_http_upstream_cache_background_update
parameter_list|(
name|ngx_http_request_t
modifier|*
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_upstream_cache_check_range (ngx_http_request_t * r,ngx_http_upstream_t * u)
name|ngx_http_upstream_cache_check_range
parameter_list|(
name|ngx_http_request_t
modifier|*
...
literal|0
argument_list|,
literal|"http upstream resolve: \"%V?%V\""
argument_list|,
operator|&
name|r
operator|->
...
name|err
argument_list|,
literal|"epoll_wait() reported that client prematurely closed "
literal|"connection, so upstream connection is closed too"
argument_list|)
expr_stmt|;
name|ngx_http_upstream_finalize_request
...
return|return;
block|}
comment|/* abbreviated SSL handshake may interact badly with Nagle */
name|clcf
operator|=
name|ngx_http_get_module_loc_conf
argument_list|(
...
specifier|static
name|void
DECL|function|ngx_http_upstream_ssl_handshake_handler (ngx_connection_t * c)
name|ngx_http_upstream_ssl_handshake_handler
parameter_list|(
name|ngx_connection_t
modifier|*
...
literal|0
argument_list|,
literal|"http upstream ssl handshake: \"%V?%V\""
argument_list|,
operator|&
name|r
operator|->
...
specifier|static
name|void
DECL|function|ngx_http_upstream_ssl_handshake (ngx_http_request_t * r,ngx_http_upstream_t * u,ngx_connection_t * c)
name|ngx_http_upstream_ssl_handshake
parameter_list|(
name|ngx_http_request_t
modifier|*
...
specifier|static
name|void
DECL|function|ngx_http_upstream_ssl_save_session (ngx_connection_t * c)
name|ngx_http_upstream_ssl_save_session
parameter_list|(
name|ngx_connection_t
modifier|*
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_upstream_ssl_name (ngx_http_request_t * r,ngx_http_upstream_t * u,ngx_connection_t * c)
name|ngx_http_upstream_ssl_name
parameter_list|(
name|ngx_http_request_t
modifier|*
...
goto|;
block|}
comment|/*      * ssl name here may contain port, notably if derived from $proxy_host      * or $http_host; we have to strip it      */
name|p
operator|=
name|name
operator|.
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_upstream_ssl_certificate (ngx_http_request_t * r,ngx_http_upstream_t * u,ngx_connection_t * c)
name|ngx_http_upstream_ssl_certificate
parameter_list|(
name|ngx_http_request_t
modifier|*
...
literal|0
argument_list|,
literal|"http upstream ssl cert: \"%s\""
argument_list|,
name|cert
operator|.
name|data
...
literal|0
argument_list|,
literal|"http upstream ssl key: \"%s\""
argument_list|,
name|key
operator|.
name|data
...
specifier|static
name|void
DECL|function|ngx_http_upstream_send_request (ngx_http_request_t * r,ngx_http_upstream_t * u,ngx_uint_t do_write)
name|ngx_http_upstream_send_request
parameter_list|(
name|ngx_http_request_t
modifier|*
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_upstream_send_request_body (ngx_http_request_t * r,ngx_http_upstream_t * u,ngx_uint_t do_write)
name|ngx_http_upstream_send_request_body
parameter_list|(
name|ngx_http_request_t
modifier|*
...
literal|0
argument_list|,
literal|"http upstream send request body"
argument_list|)
expr_stmt|;
if|if
condition|(
...
condition|)
block|{
comment|/* read client request body */
name|rc
operator|=
...
expr_stmt|;
block|}
comment|/* stop if there is nothing to send */
if|if
condition|(
name|out
operator|==
...
specifier|static
name|void
DECL|function|ngx_http_upstream_read_request_handler (ngx_http_request_t * r)
name|ngx_http_upstream_read_request_handler
parameter_list|(
name|ngx_http_request_t
modifier|*
...
literal|0
argument_list|,
literal|"http upstream read request handler"
argument_list|)
expr_stmt|;
if|if
condition|(
...
literal|0
argument_list|,
literal|"http upstream not modified"
argument_list|)
expr_stmt|;
name|now
operator|=
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_upstream_process_trailers (ngx_http_request_t * r,ngx_http_upstream_t * u)
name|ngx_http_upstream_process_trailers
parameter_list|(
name|ngx_http_request_t
modifier|*
...
condition|)
block|{
comment|/* create cache if previously bypassed */
if|if
condition|(
...
literal|0
argument_list|,
literal|"connection upgrade in subrequest"
argument_list|)
expr_stmt|;
name|ngx_http_upstream_finalize_request
argument_list|(
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_upstream_thread_handler (ngx_thread_task_t * task,ngx_file_t * file)
name|ngx_http_upstream_thread_handler
parameter_list|(
name|ngx_thread_task_t
modifier|*
...
condition|)
block|{
comment|/*          * tolerate sendfile() calls if another operation is already          * running; this can happen due to subrequests, multiple calls          * of the next body filter from a filter, or in HTTP/2 due to          * a write event on the main connection          */
name|c
operator|=
name|r
operator|->
...
literal|0
argument_list|,
literal|"thread pool \"%V\" not found"
argument_list|,
operator|&
name|name
argument_list|)
...
specifier|static
name|void
DECL|function|ngx_http_upstream_thread_event_handler (ngx_event_t * ev)
name|ngx_http_upstream_thread_event_handler
parameter_list|(
name|ngx_event_t
modifier|*
...
literal|0
argument_list|,
literal|"http upstream thread: \"%V?%V\""
argument_list|,
operator|&
name|r
operator|->
...
condition|)
block|{
comment|/*          * for HTTP/2, update write event to make sure processing will          * reach the main connection to handle sendfile() in threads          */
name|c
operator|->
name|write
operator|->
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_upstream_output_filter (void * data,ngx_chain_t * chain)
name|ngx_http_upstream_output_filter
parameter_list|(
name|void
modifier|*
...
condition|)
block|{
comment|/*          * make sure to call ngx_event_pipe()          * if there is an incomplete aio write          */
if|if
condition|(
name|ngx_event_pipe
argument_list|(
...
literal|0
argument_list|,
literal|"upstream sent duplicate header line: \"%V: %V\", "
literal|"previous value: \"%V: %V\", ignored"
argument_list|,
operator|&
name|h
operator|->
...
literal|0
argument_list|,
literal|"upstream sent \"Content-Length\" and "
literal|"\"Transfer-Encoding\" headers at the same time"
argument_list|)
expr_stmt|;
return|return
name|NGX_HTTP_UPSTREAM_INVALID_HEADER
...
literal|0
argument_list|,
literal|"upstream sent invalid \"Content-Length\" header: "
literal|"\"%V: %V\""
argument_list|,
operator|&
name|h
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_upstream_process_last_modified (ngx_http_request_t * r,ngx_table_elt_t * h,ngx_uint_t offset)
name|ngx_http_upstream_process_last_modified
parameter_list|(
name|ngx_http_request_t
modifier|*
...
operator|*
operator|)
literal|"stale-while-revalidate="
argument_list|,
literal|23
operator|-
literal|1
...
literal|0
argument_list|,
literal|"upstream sent unknown \"Transfer-Encoding\": \"%V\""
argument_list|,
operator|&
name|h
operator|->
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_upstream_process_vary (ngx_http_request_t * r,ngx_table_elt_t * h,ngx_uint_t offset)
name|ngx_http_upstream_process_vary
parameter_list|(
name|ngx_http_request_t
modifier|*
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_upstream_trailer_variable (ngx_http_request_t * r,ngx_http_variable_value_t * v,uintptr_t data)
name|ngx_http_upstream_trailer_variable
parameter_list|(
name|ngx_http_request_t
modifier|*
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_upstream_cookie_variable (ngx_http_request_t * r,ngx_http_variable_value_t * v,uintptr_t data)
name|ngx_http_upstream_cookie_variable
parameter_list|(
name|ngx_http_request_t
modifier|*
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_upstream_cache_last_modified (ngx_http_request_t * r,ngx_http_variable_value_t * v,uintptr_t data)
name|ngx_http_upstream_cache_last_modified
parameter_list|(
name|ngx_http_request_t
modifier|*
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_upstream_cache_etag (ngx_http_request_t * r,ngx_http_variable_value_t * v,uintptr_t data)
name|ngx_http_upstream_cache_etag
parameter_list|(
name|ngx_http_request_t
modifier|*
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_upstream_set_local (ngx_http_request_t * r,ngx_http_upstream_t * u,ngx_http_upstream_local_t * local)
name|ngx_http_upstream_set_local
parameter_list|(
name|ngx_http_request_t
modifier|*
...
return|;
block|}
comment|/*      * special handling to preserve conf->hide_headers_hash      * in the "http" section to inherit it to all servers      */
if|if
condition|(
name|prev
operator|->
