...
name|offsetof
argument_list|(
argument|ngx_http_upstream_conf_t
argument_list|,
argument|pass_date
argument_list|)
block|}
...
literal|0
argument_list|,
literal|"http upstream check client, write event:%d"
argument_list|,
name|ev
operator|->
name|write
