...
begin_function
name|ngx_int_t
DECL|function|ngx_http_get_variable_index (ngx_http_core_main_conf_t * cmcf,ngx_str_t * name)
...
name|ngx_http_variable_value_t
modifier|*
DECL|function|ngx_http_variable_unknown_header (ngx_http_request_t * r,ngx_str_t * var)
name|ngx_http_variable_unknown_header
parameter_list|(
name|ngx_http_request_t
modifier|*
...
begin_function
name|ngx_int_t
DECL|function|ngx_http_core_variables_init (ngx_cycle_t * cycle)
