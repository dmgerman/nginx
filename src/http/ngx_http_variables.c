...
name|ngx_http_variable_value_t
modifier|*
DECL|function|ngx_http_variable_request_method (ngx_http_request_t * r,uintptr_t data)
name|ngx_http_variable_request_method
parameter_list|(
name|ngx_http_request_t
modifier|*
...
name|ngx_http_variable_value_t
modifier|*
DECL|function|ngx_http_variable_sent (ngx_http_request_t * r,uintptr_t data)
name|ngx_http_variable_sent
parameter_list|(
name|ngx_http_request_t
modifier|*
