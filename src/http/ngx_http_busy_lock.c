...
directive|if
literal|0
block_content|ngx_add_timer(bc->event, 1000);         bc->event->event_handler = bc->event_handler;
endif|#
directive|endif
...
directive|if
literal|0
block_content|bl->waiting++;         ngx_add_timer(bc->event, 1000);         bc->event->event_handler = bc->event_handler;
endif|#
directive|endif
comment|/* TODO: ngx_handle_level_read_event() */
return|return
