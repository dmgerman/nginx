...
begin_typedef
DECL|struct|__anon2b0daa6c0108
typedef|typedef
struct|struct
block|{
DECL|member|bufs
...
specifier|static
name|ssize_t
name|ngx_http_copy_aio_sendfile_preload
parameter_list|(
name|ngx_buf_t
modifier|*
name|file
...
specifier|static
name|ngx_int_t
name|ngx_http_copy_thread_handler
parameter_list|(
...
specifier|static
name|void
name|ngx_http_copy_thread_event_handler
parameter_list|(
name|ngx_event_t
modifier|*
name|ev
...
specifier|static
name|ssize_t
DECL|function|ngx_http_copy_aio_sendfile_preload (ngx_buf_t * file)
name|ngx_http_copy_aio_sendfile_preload
parameter_list|(
name|ngx_buf_t
modifier|*
...
condition|)
block|{
comment|/*          * for HTTP/2, update write event to make sure processing will          * reach the main connection to handle sendfile() preload          */
name|c
operator|->
name|write
operator|->
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_copy_thread_handler (ngx_thread_task_t * task,ngx_file_t * file)
name|ngx_http_copy_thread_handler
parameter_list|(
name|ngx_thread_task_t
modifier|*
...
specifier|static
name|void
DECL|function|ngx_http_copy_thread_event_handler (ngx_event_t * ev)
name|ngx_http_copy_thread_event_handler
parameter_list|(
name|ngx_event_t
modifier|*
