...
begin_function
DECL|function|ngx_http_init_client_request_body (ngx_http_request_t * r,int size)
name|int
...
begin_function
DECL|function|ngx_http_init_client_request_body_chain (ngx_http_request_t * r)
name|int
...
begin_function
DECL|function|ngx_http_reinit_client_request_body_hunks (ngx_http_request_t * r)
name|void
