...
literal|0
comment|/* STUB */
block_content|ngx_http_output_filter_set_stub(pool, ngx_http_modules);     ngx_http_write_filter_set_stub(pool, ngx_http_modules);     ngx_http_index_set_stub(pool, ngx_http_modules);      ngx_http_init_modules(pool, ngx_http_modules);
endif|#
directive|endif
