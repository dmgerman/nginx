...
specifier|static
name|ngx_int_t
name|ngx_http_escape_location_name
parameter_list|(
name|ngx_conf_t
modifier|*
name|cf
...
begin_decl_stmt
DECL|variable|ngx_http_top_request_body_filter
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_escape_location_name (ngx_conf_t * cf,ngx_http_core_loc_conf_t * clcf)
name|ngx_http_escape_location_name
parameter_list|(
name|ngx_conf_t
modifier|*
