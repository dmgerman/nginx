...
begin_define
DECL|macro|NGX_HTTP_SUBREQUEST_CLONE
define|#
directive|define
...
begin_define
DECL|macro|NGX_HTTP_SUBREQUEST_BACKGROUND
define|#
directive|define
...
begin_define
DECL|macro|NGX_HTTP_MISDIRECTED_REQUEST
define|#
directive|define
...
begin_typedef
DECL|struct|__anon27a860c80208
typedef|typedef
struct|struct
block|{
DECL|member|name
...
begin_typedef
DECL|struct|__anon27a860c80308
typedef|typedef
struct|struct
block|{
DECL|member|name
...
begin_typedef
DECL|struct|__anon27a860c80408
typedef|typedef
struct|struct
block|{
DECL|member|headers
...
begin_typedef
DECL|struct|__anon27a860c80508
typedef|typedef
struct|struct
block|{
DECL|member|headers
...
begin_typedef
DECL|struct|__anon27a860c80608
typedef|typedef
struct|struct
block|{
...
name|post_handler
decl_stmt|;
DECL|member|filter_need_buffering
name|unsigned
...
begin_typedef
DECL|struct|__anon27a860c80708
typedef|typedef
struct|struct
block|{
...
name|NGX_PCRE
operator|)
DECL|member|ssl_servername_regex
...
begin_typedef
DECL|struct|__anon27a860c80808
typedef|typedef
struct|struct
block|{
DECL|member|handler
...
literal|3
decl_stmt|;
DECL|member|request_body_no_buffering
name|unsigned
...
literal|3
decl_stmt|;
DECL|member|limit_rate_set
name|unsigned
name|limit_rate_set
range|:
literal|1
decl_stmt|;
DECL|member|limit_rate_after_set
name|unsigned
name|limit_rate_after_set
range|:
literal|1
decl_stmt|;
if|#
...
literal|1
decl_stmt|;
DECL|member|subrequest_ranges
name|unsigned
name|subrequest_ranges
range|:
literal|1
decl_stmt|;
DECL|member|single_range
name|unsigned
name|single_range
range|:
literal|1
decl_stmt|;
DECL|member|disable_not_modified
name|unsigned
...
begin_typedef
DECL|struct|__anon27a860c80908
typedef|typedef
struct|struct
block|{
