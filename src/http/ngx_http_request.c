...
specifier|static
name|ngx_int_t
name|ngx_http_postponed_handler
parameter_list|(
name|ngx_http_request_t
modifier|*
name|r
...
literal|0
argument_list|,
literal|"http finalize request: %d, \"%V\""
argument_list|,
name|rc
argument_list|,
operator|&
...
literal|0
argument_list|,
literal|"http writer output filter: %d, \"%V\""
argument_list|,
name|rc
argument_list|,
operator|&
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_postponed_handler (ngx_http_request_t * r)
name|ngx_http_postponed_handler
parameter_list|(
name|ngx_http_request_t
modifier|*
...
literal|0
argument_list|,
literal|"http postpone handler \"%V\""
argument_list|,
operator|&
name|r
operator|->
...
literal|0
argument_list|,
literal|"http postponed data \"%V\" %p"
argument_list|,
operator|&
name|r
operator|->
...
condition|)
block|{
comment|/* the request pool is already destroyed */
return|return
name|NGX_DONE
return|;
block|}
...
literal|0
argument_list|,
literal|"http postponed output filter: %d"
argument_list|,
name|rc
argument_list|)
expr_stmt|;
...
literal|0
argument_list|,
literal|"http requets empty handler"
argument_list|)
expr_stmt|;
return|return;
block|}
