...
directive|if
literal|0
block_content|if (r->invalid_header) {
comment|/* there was error while a header line parsing */
block_content|header.len = r->header_end - r->header_name_start;                 header.data = r->header_name_start;                  ngx_log_error(NGX_LOG_INFO, c->log, 0,                               "client sent invalid header line: \"%V\"",&header);                 continue;             }
endif|#
directive|endif
