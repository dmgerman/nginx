...
specifier|static
name|ngx_int_t
name|ngx_http_alloc_header_buf
parameter_list|(
name|ngx_http_request_t
modifier|*
name|r
...
directive|if
literal|1
comment|/* ngx_http_alloc_large_header_buffer() */
name|rc
operator|=
name|ngx_http_alloc_header_buf
argument_list|(
...
begin_function
DECL|function|ngx_http_alloc_header_buf (ngx_http_request_t * r,ngx_uint_t request_line)
specifier|static
name|ngx_int_t
name|ngx_http_alloc_header_buf
parameter_list|(
