...
literal|0
argument_list|,
literal|"http request: \"%V?%V\" still has postponed"
argument_list|,
operator|&
name|pr
operator|->
...
directive|if
literal|0
block_content|if (r->connection->read->pending_eof) {
if|#
directive|if
operator|(
name|NGX_HAVE_KQUEUE
operator|)
block_content|ngx_log_debug0(NGX_LOG_DEBUG_HTTP, r->connection->log,                        r->connection->read->kq_errno,                        "kevent() reported about an closed connection");
endif|#
directive|endif
block_content|ngx_http_close_request(r, 0);         return;     }
endif|#
directive|endif
if|if
condition|(
...
name|u_char
modifier|*
DECL|function|ngx_http_log_error_handler (ngx_http_request_t * r,u_char * buf,size_t len)
name|ngx_http_log_error_handler
parameter_list|(
name|ngx_http_request_t
modifier|*
...
name|u_char
modifier|*
DECL|function|ngx_http_log_error_info (ngx_http_request_t * r,u_char * buf,size_t len)
name|ngx_http_log_error_info
parameter_list|(
name|ngx_http_request_t
modifier|*
