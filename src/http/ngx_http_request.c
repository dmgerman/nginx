...
literal|0
argument_list|,
literal|"client SSL certificate verify error: %l "
argument_list|,
name|rc
argument_list|)
expr_stmt|;
...
specifier|static
name|void
DECL|function|ngx_http_find_virtual_server (ngx_http_request_t * r,ngx_http_virtual_names_t * vn,ngx_uint_t hash)
name|ngx_http_find_virtual_server
parameter_list|(
name|ngx_http_request_t
modifier|*
