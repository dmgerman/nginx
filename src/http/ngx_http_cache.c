...
begin_function
DECL|function|ngx_http_cache_get_data (ngx_http_request_t * r,ngx_http_cache_ctx_t * ctx)
name|int
name|ngx_http_cache_get_data
parameter_list|(
name|ngx_http_request_t
modifier|*
name|r
...
begin_function
DECL|function|ngx_http_cache_get_entry (ngx_http_request_t * r,ngx_http_cache_ctx_t * ctx)
name|ngx_http_cache_entry_t
modifier|*
name|ngx_http_cache_get_entry
parameter_list|(
name|ngx_http_request_t
modifier|*
name|r
...
condition|)
block|{
comment|/* looking for the oldest cache entry that is not used right now */
name|old
operator|=
name|ctx
operator|->
...
begin_comment
unit|int ngx_crc(char *data, size_t len) {     uint32_t  sum;      for (sum = 0; len; len--) {
comment|/*          * gcc 2.95.2 x86 and icc 7.1.006 compile that operator          * into the single rol opcode.          * msvc 6.0sp2 compiles it into four opcodes.          */
end_comment
