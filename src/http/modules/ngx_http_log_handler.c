...
begin_typedef
DECL|struct|__anon2b8447710108
typedef|typedef
struct|struct
block|{
DECL|member|file
...
begin_function
DECL|function|ngx_http_log_create_conf (ngx_conf_t * cf)
specifier|static
name|void
modifier|*
name|ngx_http_log_create_conf
...
begin_function
DECL|function|ngx_http_log_merge_conf (ngx_conf_t * cf,void * parent,void * child)
specifier|static
name|char
modifier|*
name|ngx_http_log_merge_conf
