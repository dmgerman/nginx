...
begin_typedef
DECL|struct|__anon2b4c2d2a0108
typedef|typedef
struct|struct
block|{
DECL|member|color
...
begin_typedef
DECL|struct|__anon2b4c2d2a0208
typedef|typedef
struct|struct
block|{
DECL|member|rbtree
...
begin_typedef
DECL|struct|__anon2b4c2d2a0308
typedef|typedef
struct|struct
block|{
DECL|member|sh
...
begin_typedef
DECL|struct|__anon2b4c2d2a0408
typedef|typedef
struct|struct
block|{
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_limit_req_lookup (ngx_http_limit_req_conf_t * lrcf,ngx_uint_t hash,u_char * data,size_t len,ngx_uint_t * ep)
name|ngx_http_limit_req_lookup
parameter_list|(
name|ngx_http_limit_req_conf_t
modifier|*
