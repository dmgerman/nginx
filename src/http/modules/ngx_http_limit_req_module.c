...
begin_typedef
DECL|struct|__anon292698ec0108
typedef|typedef
struct|struct
block|{
DECL|member|color
...
begin_typedef
DECL|struct|__anon292698ec0208
typedef|typedef
struct|struct
block|{
DECL|member|rbtree
...
begin_typedef
DECL|struct|__anon292698ec0308
typedef|typedef
struct|struct
block|{
...
literal|0
argument_list|,
literal|"limiting requests, %.3f r/s"
argument_list|,
name|rate
argument_list|)
expr_stmt|;
...
literal|0
argument_list|,
literal|"delaying requests, %.3f r/s"
argument_list|,
name|rate
argument_list|)
expr_stmt|;
...
return|;
block|}
comment|/*      * set by ngx_pcalloc():      *      *     conf->shm_zone = NULL;      *     conf->burst = 0.0;      *     conf->delay = 0;      */
return|return
name|conf
return|;
block|}
...
literal|0
argument_list|,
literal|"invalid clean_time value \"%V\""
argument_list|,
operator|&
name|value
index|[
