...
begin_typedef
DECL|struct|__anon2b59f03c0108
typedef|typedef
struct|struct
block|{
...
begin_typedef
DECL|struct|__anon2b59f03c0208
typedef|typedef
struct|struct
block|{
DECL|member|status
...
begin_decl_stmt
DECL|variable|ngx_http_uwsgi_hide_cache_headers
specifier|static
name|ngx_str_t
name|ngx_http_uwsgi_hide_cache_headers
index|[]
init|=
block|{
name|ngx_string
...
return|;
block|}
comment|/* 6 is a number of ngx_http_uwsgi_cache_headers entries */
name|conf
operator|->
name|params_source
operator|=
