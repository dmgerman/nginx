...
begin_typedef
DECL|struct|__anon2c0b09720108
typedef|typedef
struct|struct
block|{
DECL|member|caches
...
DECL|typedef|ngx_http_uwsgi_main_conf_t
block|}
name|ngx_http_uwsgi_main_conf_t
typedef|;
end_typedef

begin_typedef
DECL|struct|__anon2c0b09720208
typedef|typedef
struct|struct
block|{
DECL|member|flushes
...
name|hash
decl_stmt|;
DECL|typedef|ngx_http_uwsgi_params_t
block|}
name|ngx_http_uwsgi_params_t
typedef|;
end_typedef

begin_typedef
DECL|struct|__anon2c0b09720308
typedef|typedef
struct|struct
block|{
...
specifier|static
name|ngx_int_t
name|ngx_http_uwsgi_input_filter_init
parameter_list|(
name|void
modifier|*
name|data
...
name|void
modifier|*
name|ngx_http_uwsgi_create_main_conf
parameter_list|(
name|ngx_conf_t
modifier|*
name|cf
...
specifier|static
name|ngx_int_t
name|ngx_http_uwsgi_init_params
parameter_list|(
name|ngx_conf_t
modifier|*
name|cf
...
specifier|static
name|ngx_int_t
name|ngx_http_uwsgi_create_key
parameter_list|(
name|ngx_http_request_t
modifier|*
name|r
...
name|char
modifier|*
name|ngx_http_uwsgi_ssl_password_file
parameter_list|(
name|ngx_conf_t
modifier|*
name|cf
...
name|char
modifier|*
name|ngx_http_uwsgi_ssl_conf_command_check
parameter_list|(
name|ngx_conf_t
modifier|*
name|cf
...
begin_decl_stmt
DECL|variable|ngx_http_uwsgi_ssl_protocols
specifier|static
name|ngx_conf_bitmask_t
name|ngx_http_uwsgi_ssl_protocols
index|[]
init|=
block|{
block|{
...
begin_decl_stmt
DECL|variable|ngx_http_uwsgi_ssl_conf_command_post
specifier|static
name|ngx_conf_post_t
name|ngx_http_uwsgi_ssl_conf_command_post
init|=
block|{
name|ngx_http_uwsgi_ssl_conf_command_check
block|}
...
name|ngx_string
argument_list|(
literal|"uwsgi_request_buffering"
argument_list|)
block|,
name|NGX_HTTP_MAIN_CONF
operator||
...
name|ngx_string
argument_list|(
literal|"uwsgi_socket_keepalive"
argument_list|)
block|,
name|NGX_HTTP_MAIN_CONF
operator||
...
name|ngx_string
argument_list|(
literal|"uwsgi_cache_max_range_offset"
argument_list|)
block|,
name|NGX_HTTP_MAIN_CONF
operator||
...
name|ngx_string
argument_list|(
literal|"uwsgi_cache_lock_timeout"
argument_list|)
block|,
name|NGX_HTTP_MAIN_CONF
operator||
...
name|ngx_string
argument_list|(
literal|"uwsgi_cache_revalidate"
argument_list|)
block|,
name|NGX_HTTP_MAIN_CONF
operator||
...
name|ngx_string
argument_list|(
literal|"uwsgi_cache_background_update"
argument_list|)
block|,
name|NGX_HTTP_MAIN_CONF
operator||
...
name|ngx_string
argument_list|(
literal|"uwsgi_next_upstream_tries"
argument_list|)
block|,
name|NGX_HTTP_MAIN_CONF
operator||
...
name|ngx_string
argument_list|(
literal|"uwsgi_next_upstream_timeout"
argument_list|)
block|,
name|NGX_HTTP_MAIN_CONF
operator||
...
name|ngx_string
argument_list|(
literal|"uwsgi_ssl_session_reuse"
argument_list|)
block|,
name|NGX_HTTP_MAIN_CONF
operator||
...
name|ngx_string
argument_list|(
literal|"uwsgi_ssl_verify_depth"
argument_list|)
block|,
name|NGX_HTTP_MAIN_CONF
operator||
...
name|ngx_string
argument_list|(
literal|"uwsgi_ssl_trusted_certificate"
argument_list|)
block|,
name|NGX_HTTP_MAIN_CONF
operator||
...
name|ngx_string
argument_list|(
literal|"uwsgi_ssl_certificate_key"
argument_list|)
block|,
name|NGX_HTTP_MAIN_CONF
operator||
...
name|ngx_string
argument_list|(
literal|"uwsgi_ssl_password_file"
argument_list|)
block|,
name|NGX_HTTP_MAIN_CONF
operator||
...
name|ngx_string
argument_list|(
literal|"uwsgi_ssl_conf_command"
argument_list|)
block|,
name|NGX_HTTP_MAIN_CONF
operator||
...
begin_decl_stmt
DECL|variable|ngx_http_uwsgi_cache_headers
specifier|static
name|ngx_keyval_t
name|ngx_http_uwsgi_cache_headers
index|[]
init|=
block|{
block|{
...
literal|0
argument_list|,
literal|"suwsgi protocol requires SSL support"
argument_list|)
expr_stmt|;
return|return
name|NGX_ERROR
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_uwsgi_create_key (ngx_http_request_t * r)
name|ngx_http_uwsgi_create_key
parameter_list|(
name|ngx_http_request_t
modifier|*
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_uwsgi_input_filter_init (void * data)
name|ngx_http_uwsgi_input_filter_init
parameter_list|(
name|void
modifier|*
...
literal|0
argument_list|,
literal|"http uwsgi filter init s:%ui l:%O"
argument_list|,
name|u
operator|->
name|headers_in
...
name|void
modifier|*
DECL|function|ngx_http_uwsgi_create_main_conf (ngx_conf_t * cf)
name|ngx_http_uwsgi_create_main_conf
parameter_list|(
name|ngx_conf_t
modifier|*
...
literal|0
argument_list|,
literal|"\"uwsgi_cache\" zone \"%V\" is unknown"
argument_list|,
operator|&
name|shm_zone
operator|->
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_uwsgi_init_params (ngx_conf_t * cf,ngx_http_uwsgi_loc_conf_t * conf,ngx_http_uwsgi_params_t * params,ngx_keyval_t * default_params)
name|ngx_http_uwsgi_init_params
parameter_list|(
name|ngx_conf_t
modifier|*
...
name|char
modifier|*
DECL|function|ngx_http_uwsgi_store (ngx_conf_t * cf,ngx_command_t * cmd,void * conf)
name|ngx_http_uwsgi_store
parameter_list|(
name|ngx_conf_t
modifier|*
...
block|{
return|return
literal|"is incompatible with \"uwsgi_cache\""
return|;
block|}
endif|#
directive|endif
...
name|char
modifier|*
DECL|function|ngx_http_uwsgi_cache (ngx_conf_t * cf,ngx_command_t * cmd,void * conf)
name|ngx_http_uwsgi_cache
parameter_list|(
name|ngx_conf_t
modifier|*
...
block|{
return|return
literal|"is incompatible with \"uwsgi_store\""
return|;
block|}
name|uwcf
operator|->
...
name|char
modifier|*
DECL|function|ngx_http_uwsgi_cache_key (ngx_conf_t * cf,ngx_command_t * cmd,void * conf)
name|ngx_http_uwsgi_cache_key
parameter_list|(
name|ngx_conf_t
modifier|*
...
name|char
modifier|*
DECL|function|ngx_http_uwsgi_ssl_password_file (ngx_conf_t * cf,ngx_command_t * cmd,void * conf)
name|ngx_http_uwsgi_ssl_password_file
parameter_list|(
name|ngx_conf_t
modifier|*
...
name|char
modifier|*
DECL|function|ngx_http_uwsgi_ssl_conf_command_check (ngx_conf_t * cf,void * post,void * data)
name|ngx_http_uwsgi_ssl_conf_command_check
parameter_list|(
name|ngx_conf_t
modifier|*
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_uwsgi_merge_ssl (ngx_conf_t * cf,ngx_http_uwsgi_loc_conf_t * conf,ngx_http_uwsgi_loc_conf_t * prev)
name|ngx_http_uwsgi_merge_ssl
parameter_list|(
name|ngx_conf_t
modifier|*
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_uwsgi_set_ssl (ngx_conf_t * cf,ngx_http_uwsgi_loc_conf_t * uwcf)
name|ngx_http_uwsgi_set_ssl
parameter_list|(
name|ngx_conf_t
modifier|*
...
literal|0
argument_list|,
literal|"no \"uwsgi_ssl_certificate_key\" is defined "
...
literal|0
argument_list|,
literal|"no uwsgi_ssl_trusted_certificate for uwsgi_ssl_verify"
argument_list|)
expr_stmt|;
return|return
name|NGX_ERROR
