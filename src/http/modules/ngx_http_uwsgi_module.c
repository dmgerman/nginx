...
begin_typedef
DECL|struct|__anon2baf76350108
typedef|typedef
struct|struct
block|{
...
specifier|static
name|ngx_int_t
name|ngx_http_uwsgi_merge_params
parameter_list|(
name|ngx_conf_t
modifier|*
name|cf
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_uwsgi_merge_params (ngx_conf_t * cf,ngx_http_uwsgi_loc_conf_t * conf,ngx_http_uwsgi_loc_conf_t * prev)
name|ngx_http_uwsgi_merge_params
parameter_list|(
name|ngx_conf_t
modifier|*
