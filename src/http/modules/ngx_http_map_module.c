...
begin_define
DECL|macro|NGX_HTTP_MAP_HASH
define|#
directive|define
name|NGX_HTTP_MAP_HASH
value|10007
end_define

begin_typedef
DECL|struct|__anon2b532cf40108
typedef|typedef
struct|struct
block|{
...
begin_typedef
DECL|struct|__anon2b532cf40208
typedef|typedef
struct|struct
block|{
DECL|member|pool
...
begin_typedef
DECL|struct|__anon2b532cf40308
typedef|typedef
struct|struct
block|{
DECL|member|hash
...
name|NGX_HTTP_MAP_HASH
expr_stmt|;
comment|/* convert "*.example.com" into "com.example.\0" */
name|len
operator|=
literal|0
expr_stmt|;
