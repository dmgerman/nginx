...
literal|0
argument_list|,
literal|"unknown charset \"%V\" of main request"
argument_list|,
name|mc
argument_list|)
expr_stmt|;
...
literal|0
argument_list|,
literal|"unknown source charset \"%V\""
argument_list|,
operator|&
name|r
operator|->
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_charset_get_charset (ngx_http_charset_t * charsets,ngx_uint_t n,u_char * charset)
name|ngx_http_charset_get_charset
parameter_list|(
name|ngx_http_charset_t
modifier|*
