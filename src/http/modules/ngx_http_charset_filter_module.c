...
begin_define
DECL|macro|NGX_HTTP_CHARSET_OFF
define|#
directive|define
name|NGX_HTTP_CHARSET_OFF
value|-2
end_define
...
specifier|static
name|ngx_int_t
name|ngx_http_destination_charset
parameter_list|(
...
specifier|static
name|ngx_int_t
name|ngx_http_main_request_charset
parameter_list|(
name|ngx_http_request_t
modifier|*
name|r
...
return|;
block|}
comment|/* charset: charset index or NGX_HTTP_NO_CHARSET */
name|source_charset
operator|=
name|ngx_http_source_charset
argument_list|(
...
return|;
block|}
comment|/*      * source_charset: charset index, NGX_HTTP_NO_CHARSET,      *                 or NGX_HTTP_CHARSET_OFF      */
name|ngx_log_debug2
argument_list|(
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_destination_charset (ngx_http_request_t * r,ngx_str_t * name)
name|ngx_http_destination_charset
parameter_list|(
name|ngx_http_request_t
modifier|*
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_main_request_charset (ngx_http_request_t * r,ngx_str_t * src)
name|ngx_http_main_request_charset
parameter_list|(
name|ngx_http_request_t
modifier|*
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_source_charset (ngx_http_request_t * r,ngx_str_t * name)
name|ngx_http_source_charset
parameter_list|(
name|ngx_http_request_t
modifier|*
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_get_charset (ngx_http_request_t * r,ngx_str_t * name)
name|ngx_http_get_charset
parameter_list|(
name|ngx_http_request_t
modifier|*
...
name|ngx_inline
name|void
DECL|function|ngx_http_set_charset (ngx_http_request_t * r,ngx_str_t * charset)
name|ngx_http_set_charset
parameter_list|(
name|ngx_http_request_t
modifier|*
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_charset_ctx (ngx_http_request_t * r,ngx_http_charset_t * charsets,ngx_int_t charset,ngx_int_t source_charset)
name|ngx_http_charset_ctx
parameter_list|(
name|ngx_http_request_t
modifier|*
