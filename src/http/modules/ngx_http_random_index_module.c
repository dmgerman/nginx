...
begin_typedef
DECL|struct|__anon2b7b15420108
typedef|typedef
struct|struct
block|{
DECL|member|enable
...
specifier|static
name|ngx_int_t
name|ngx_http_random_index_add_variable
parameter_list|(
name|ngx_conf_t
modifier|*
name|cf
...
begin_decl_stmt
DECL|variable|ngx_http_random_index
specifier|static
name|ngx_str_t
name|ngx_http_random_index
init|=
name|ngx_string
argument_list|(
literal|"random_index"
...
begin_decl_stmt
DECL|variable|ngx_random_index_variable_index
specifier|static
name|ngx_int_t
name|ngx_random_index_variable_index
decl_stmt|;
end_decl_stmt
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_random_index_variable (ngx_http_request_t * r,ngx_http_variable_value_t * v,uintptr_t data)
name|ngx_http_random_index_variable
parameter_list|(
name|ngx_http_request_t
modifier|*
name|r
...
parameter_list|)
block|{
comment|/*      * the "random_index" directive stores index file name directly inside      * r->variables[] because request context is not preserved while      * an internal redirection      */
name|v
operator|->
name|not_found
operator|=
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_random_index_add_variable (ngx_conf_t * cf)
name|ngx_http_random_index_add_variable
parameter_list|(
name|ngx_conf_t
modifier|*
