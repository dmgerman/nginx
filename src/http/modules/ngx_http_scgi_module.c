...
begin_comment
comment|/*  * Copyright (C) Igor Sysoev  * Copyright (C) Nginx, Inc.  * Copyright (C) Manlio Perillo (manlio.perillo@gmail.com)  */
end_comment
...
begin_typedef
DECL|struct|__anon29e502d50108
typedef|typedef
struct|struct
block|{
DECL|member|caches
...
DECL|typedef|ngx_http_scgi_main_conf_t
block|}
name|ngx_http_scgi_main_conf_t
typedef|;
end_typedef

begin_typedef
DECL|struct|__anon29e502d50208
typedef|typedef
struct|struct
block|{
DECL|member|flushes
...
name|hash
decl_stmt|;
DECL|typedef|ngx_http_scgi_params_t
block|}
name|ngx_http_scgi_params_t
typedef|;
end_typedef

begin_typedef
DECL|struct|__anon29e502d50308
typedef|typedef
struct|struct
block|{
...
specifier|static
name|ngx_int_t
name|ngx_http_scgi_input_filter_init
parameter_list|(
name|void
modifier|*
name|data
...
name|void
modifier|*
name|ngx_http_scgi_create_main_conf
parameter_list|(
name|ngx_conf_t
modifier|*
name|cf
...
specifier|static
name|ngx_int_t
name|ngx_http_scgi_init_params
parameter_list|(
name|ngx_conf_t
modifier|*
name|cf
...
name|ngx_string
argument_list|(
literal|"scgi_request_buffering"
argument_list|)
block|,
name|NGX_HTTP_MAIN_CONF
operator||
...
name|ngx_string
argument_list|(
literal|"scgi_cache_max_range_offset"
argument_list|)
block|,
name|NGX_HTTP_MAIN_CONF
operator||
...
name|ngx_string
argument_list|(
literal|"scgi_cache_background_update"
argument_list|)
block|,
name|NGX_HTTP_MAIN_CONF
operator||
...
name|ngx_string
argument_list|(
literal|"scgi_next_upstream_tries"
argument_list|)
block|,
name|NGX_HTTP_MAIN_CONF
operator||
...
name|ngx_string
argument_list|(
literal|"scgi_next_upstream_timeout"
argument_list|)
block|,
name|NGX_HTTP_MAIN_CONF
operator||
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_scgi_input_filter_init (void * data)
name|ngx_http_scgi_input_filter_init
parameter_list|(
name|void
modifier|*
...
literal|0
argument_list|,
literal|"http scgi filter init s:%ui l:%O"
argument_list|,
name|u
operator|->
name|headers_in
...
name|void
modifier|*
DECL|function|ngx_http_scgi_create_main_conf (ngx_conf_t * cf)
name|ngx_http_scgi_create_main_conf
parameter_list|(
name|ngx_conf_t
modifier|*
...
literal|0
argument_list|,
literal|"no \"scgi_cache_key\" for \"scgi_cache\""
argument_list|)
expr_stmt|;
block|}
name|ngx_conf_merge_value
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_scgi_init_params (ngx_conf_t * cf,ngx_http_scgi_loc_conf_t * conf,ngx_http_scgi_params_t * params,ngx_keyval_t * default_params)
name|ngx_http_scgi_init_params
parameter_list|(
name|ngx_conf_t
modifier|*
