...
begin_typedef
DECL|struct|__anon2baa60b70108
typedef|typedef
struct|struct
block|{
DECL|member|flushes
...
begin_typedef
DECL|struct|__anon2baa60b70208
typedef|typedef
struct|struct
block|{
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_scgi_init_params (ngx_conf_t * cf,ngx_http_scgi_loc_conf_t * conf,ngx_http_scgi_params_t * params)
name|ngx_http_scgi_init_params
parameter_list|(
name|ngx_conf_t
modifier|*
