...
begin_typedef
DECL|struct|__anon2c77f2200108
typedef|typedef
struct|struct
block|{
DECL|member|name
...
begin_typedef
DECL|struct|__anon2c77f2200208
typedef|typedef
struct|struct
block|{
DECL|member|formats
...
begin_typedef
DECL|struct|__anon2c77f2200308
typedef|typedef
struct|struct
block|{
DECL|member|start
...
name|gzip
decl_stmt|;
DECL|typedef|ngx_http_log_buf_t
block|}
...
begin_typedef
DECL|struct|__anon2c77f2200408
typedef|typedef
struct|struct
block|{
DECL|member|lengths
...
begin_typedef
DECL|struct|__anon2c77f2200508
typedef|typedef
struct|struct
block|{
DECL|member|file
...
begin_typedef
DECL|struct|__anon2c77f2200608
typedef|typedef
struct|struct
block|{
DECL|member|logs
...
begin_typedef
DECL|struct|__anon2c77f2200708
typedef|typedef
struct|struct
block|{
DECL|member|name
...
begin_define
DECL|macro|NGX_HTTP_LOG_ESCAPE_DEFAULT
define|#
directive|define
name|NGX_HTTP_LOG_ESCAPE_DEFAULT
value|0
end_define

begin_define
DECL|macro|NGX_HTTP_LOG_ESCAPE_JSON
define|#
directive|define
name|NGX_HTTP_LOG_ESCAPE_JSON
value|1
end_define

begin_define
DECL|macro|NGX_HTTP_LOG_ESCAPE_NONE
define|#
directive|define
name|NGX_HTTP_LOG_ESCAPE_NONE
value|2
end_define
...
specifier|static
name|void
name|ngx_http_log_flush_handler
parameter_list|(
name|ngx_event_t
modifier|*
name|ev
...
specifier|static
name|size_t
name|ngx_http_log_json_variable_getlen
parameter_list|(
name|ngx_http_request_t
modifier|*
name|r
...
name|u_char
modifier|*
name|ngx_http_log_json_variable
parameter_list|(
name|ngx_http_request_t
modifier|*
name|r
...
specifier|static
name|size_t
name|ngx_http_log_unescaped_variable_getlen
parameter_list|(
name|ngx_http_request_t
modifier|*
name|r
...
name|u_char
modifier|*
name|ngx_http_log_unescaped_variable
parameter_list|(
name|ngx_http_request_t
modifier|*
name|r
...
specifier|static
name|ssize_t
DECL|function|ngx_http_log_gzip (ngx_fd_t fd,u_char * buf,size_t len,ngx_int_t level,ngx_log_t * log)
name|ngx_http_log_gzip
parameter_list|(
name|ngx_fd_t
name|fd
...
name|void
modifier|*
DECL|function|ngx_http_log_gzip_alloc (void * opaque,u_int items,u_int size)
name|ngx_http_log_gzip_alloc
parameter_list|(
name|void
modifier|*
...
specifier|static
name|void
DECL|function|ngx_http_log_gzip_free (void * opaque,void * address)
name|ngx_http_log_gzip_free
parameter_list|(
name|void
modifier|*
...
directive|if
literal|0
block_content|ngx_pool_t *pool = opaque;      ngx_log_debug1(NGX_LOG_DEBUG_HTTP, pool->log, 0, "gzip free: %p", address);
endif|#
directive|endif
block|}
end_function
...
specifier|static
name|void
DECL|function|ngx_http_log_flush (ngx_open_file_t * file,ngx_log_t * log)
name|ngx_http_log_flush
parameter_list|(
name|ngx_open_file_t
modifier|*
...
specifier|static
name|void
DECL|function|ngx_http_log_flush_handler (ngx_event_t * ev)
name|ngx_http_log_flush_handler
parameter_list|(
name|ngx_event_t
modifier|*
...
name|u_char
modifier|*
DECL|function|ngx_http_log_iso8601 (ngx_http_request_t * r,u_char * buf,ngx_http_log_op_t * op)
name|ngx_http_log_iso8601
parameter_list|(
name|ngx_http_request_t
modifier|*
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_log_variable_compile (ngx_conf_t * cf,ngx_http_log_op_t * op,ngx_str_t * value,ngx_uint_t escape)
name|ngx_http_log_variable_compile
parameter_list|(
name|ngx_conf_t
modifier|*
...
break|break;
default|default:
comment|/* NGX_HTTP_LOG_ESCAPE_DEFAULT */
name|op
operator|->
name|getlen
operator|=
...
specifier|static
name|size_t
DECL|function|ngx_http_log_json_variable_getlen (ngx_http_request_t * r,uintptr_t data)
name|ngx_http_log_json_variable_getlen
parameter_list|(
name|ngx_http_request_t
modifier|*
...
name|u_char
modifier|*
DECL|function|ngx_http_log_json_variable (ngx_http_request_t * r,u_char * buf,ngx_http_log_op_t * op)
name|ngx_http_log_json_variable
parameter_list|(
name|ngx_http_request_t
modifier|*
...
specifier|static
name|size_t
DECL|function|ngx_http_log_unescaped_variable_getlen (ngx_http_request_t * r,uintptr_t data)
name|ngx_http_log_unescaped_variable_getlen
parameter_list|(
name|ngx_http_request_t
modifier|*
...
name|u_char
modifier|*
DECL|function|ngx_http_log_unescaped_variable (ngx_http_request_t * r,u_char * buf,ngx_http_log_op_t * op)
name|ngx_http_log_unescaped_variable
parameter_list|(
name|ngx_http_request_t
modifier|*
