...
begin_typedef
DECL|struct|__anon290b568a0108
typedef|typedef
struct|struct
block|{
...
begin_typedef
DECL|struct|__anon290b568a0308
typedef|typedef
struct|struct
block|{
DECL|member|state
...
begin_typedef
DECL|struct|__anon290b568a0408
typedef|typedef
struct|struct
block|{
DECL|member|version
...
begin_typedef
DECL|struct|__anon290b568a0508
typedef|typedef
struct|struct
block|{
DECL|member|role_hi
...
begin_typedef
DECL|struct|__anon290b568a0608
typedef|typedef
struct|struct
block|{
DECL|member|version
...
begin_typedef
DECL|struct|__anon290b568a0708
typedef|typedef
struct|struct
block|{
DECL|member|h0
...
return|;
block|}
comment|/*      * set by ngx_pcalloc():      *      *     conf->upstream.bufs.num = 0;      *     conf->upstream.path = NULL;      *     conf->upstream.next_upstream = 0;      *     conf->upstream.temp_path = NULL;      *     conf->upstream.schema = { 0, NULL };      *     conf->upstream.uri = { 0, NULL };      *     conf->upstream.location = NULL;      *      *     conf->index.len = 0;      *     conf->index.data = NULL;      */
name|conf
operator|->
name|upstream
operator|.
