...
begin_typedef
DECL|struct|__anon293e49b20108
typedef|typedef
struct|struct
block|{
DECL|member|caches
...
DECL|typedef|ngx_http_fastcgi_main_conf_t
block|}
name|ngx_http_fastcgi_main_conf_t
typedef|;
end_typedef

begin_typedef
DECL|struct|__anon293e49b20208
typedef|typedef
struct|struct
block|{
DECL|member|flushes
...
name|hash
decl_stmt|;
DECL|typedef|ngx_http_fastcgi_params_t
block|}
name|ngx_http_fastcgi_params_t
typedef|;
end_typedef

begin_typedef
DECL|struct|__anon293e49b20308
typedef|typedef
struct|struct
block|{
...
name|NGX_PCRE
operator|)
DECL|member|split_regex
name|ngx_regex_t
modifier|*
name|split_regex
decl_stmt|;
DECL|member|split_name
name|ngx_str_t
name|split_name
decl_stmt|;
endif|#
...
begin_typedef
DECL|struct|__anon293e49b20508
typedef|typedef
struct|struct
block|{
DECL|member|start
...
begin_typedef
DECL|struct|__anon293e49b20608
typedef|typedef
struct|struct
block|{
DECL|member|state
...
begin_define
DECL|macro|NGX_HTTP_FASTCGI_KEEP_CONN
define|#
directive|define
name|NGX_HTTP_FASTCGI_KEEP_CONN
value|1
end_define
...
begin_typedef
DECL|struct|__anon293e49b20708
typedef|typedef
struct|struct
block|{
DECL|member|version
...
begin_typedef
DECL|struct|__anon293e49b20808
typedef|typedef
struct|struct
block|{
DECL|member|role_hi
...
begin_typedef
DECL|struct|__anon293e49b20908
typedef|typedef
struct|struct
block|{
DECL|member|version
...
begin_typedef
DECL|struct|__anon293e49b20a08
typedef|typedef
struct|struct
block|{
DECL|member|h0
...
specifier|static
name|ngx_int_t
name|ngx_http_fastcgi_create_key
parameter_list|(
name|ngx_http_request_t
modifier|*
name|r
...
specifier|static
name|ngx_int_t
name|ngx_http_fastcgi_body_output_filter
parameter_list|(
name|void
modifier|*
name|data
...
specifier|static
name|ngx_int_t
name|ngx_http_fastcgi_input_filter_init
parameter_list|(
name|void
modifier|*
name|data
...
specifier|static
name|ngx_int_t
name|ngx_http_fastcgi_non_buffered_filter
parameter_list|(
name|void
modifier|*
name|data
...
name|void
modifier|*
name|ngx_http_fastcgi_create_main_conf
parameter_list|(
name|ngx_conf_t
modifier|*
name|cf
...
specifier|static
name|ngx_int_t
name|ngx_http_fastcgi_init_params
parameter_list|(
name|ngx_conf_t
modifier|*
name|cf
...
specifier|static
name|ngx_int_t
name|ngx_http_fastcgi_path_info_variable
parameter_list|(
name|ngx_http_request_t
modifier|*
name|r
...
name|char
modifier|*
name|ngx_http_fastcgi_split_path_info
parameter_list|(
name|ngx_conf_t
modifier|*
name|cf
...
name|ngx_string
argument_list|(
literal|"fastcgi_split_path_info"
argument_list|)
block|,
name|NGX_HTTP_MAIN_CONF
operator||
...
name|ngx_string
argument_list|(
literal|"fastcgi_request_buffering"
argument_list|)
block|,
name|NGX_HTTP_MAIN_CONF
operator||
...
name|ngx_string
argument_list|(
literal|"fastcgi_cache_use_stale"
argument_list|)
block|,
name|NGX_HTTP_MAIN_CONF
operator||
...
name|ngx_string
argument_list|(
literal|"fastcgi_cache_lock_timeout"
argument_list|)
block|,
name|NGX_HTTP_MAIN_CONF
operator||
...
name|ngx_string
argument_list|(
literal|"fastcgi_cache_revalidate"
argument_list|)
block|,
name|NGX_HTTP_MAIN_CONF
operator||
...
name|ngx_string
argument_list|(
literal|"fastcgi_cache_background_update"
argument_list|)
block|,
name|NGX_HTTP_MAIN_CONF
operator||
...
begin_decl_stmt
DECL|variable|ngx_http_fastcgi_vars
specifier|static
name|ngx_http_variable_t
name|ngx_http_fastcgi_vars
index|[]
init|=
block|{
block|{
...
begin_decl_stmt
DECL|variable|ngx_http_fastcgi_cache_headers
specifier|static
name|ngx_keyval_t
name|ngx_http_fastcgi_cache_headers
index|[]
init|=
block|{
block|{
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_fastcgi_create_key (ngx_http_request_t * r)
name|ngx_http_fastcgi_create_key
parameter_list|(
name|ngx_http_request_t
modifier|*
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_fastcgi_body_output_filter (void * data,ngx_chain_t * in)
name|ngx_http_fastcgi_body_output_filter
parameter_list|(
name|void
modifier|*
...
condition|)
block|{
comment|/* reserve space for maximum possible padding, 7 bytes */
name|b
operator|->
name|start
operator|=
...
literal|0
argument_list|,
literal|"fastcgi output in  l:%d f:%d %p, pos %p, size: %z "
...
argument_list|)
expr_stmt|;
comment|/*              * restore b->start to preserve memory allocated in the buffer,              * to reuse it later for headers and padding              */
name|b
operator|->
name|start
operator|=
...
condition|)
block|{
comment|/* TODO: do not allocate buffers instead */
name|cl
operator|->
name|buf
operator|->
...
literal|0
argument_list|,
literal|"fastcgi output out l:%d f:%d %p, pos %p, size: %z "
literal|"file: %O, size: %O"
argument_list|,
name|cl
operator|->
...
literal|0
argument_list|,
literal|"FastCGI sent in stderr: \"%*s\""
argument_list|,
name|p
operator|-
name|msg
...
argument_list|)
expr_stmt|;
comment|/*              * A tail of large stderr output before HTTP header is placed              * in a cache file without a FastCGI record header.              * To workaround it we put a dummy FastCGI record header at the              * start of the stderr output or update r->cache_header_start,              * if there is no enough place for the record header.              */
if|if
condition|(
name|len
operator|>=
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_fastcgi_input_filter_init (void * data)
name|ngx_http_fastcgi_input_filter_init
parameter_list|(
name|void
modifier|*
...
block|{
comment|/* ngx_http_fastcgi_st_data */
name|p
operator|->
name|length
operator|=
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_fastcgi_non_buffered_filter (void * data,ssize_t bytes)
name|ngx_http_fastcgi_non_buffered_filter
parameter_list|(
name|void
modifier|*
...
literal|0
argument_list|,
literal|"http fastcgi output buf %p"
argument_list|,
name|b
operator|->
name|pos
...
name|void
modifier|*
DECL|function|ngx_http_fastcgi_create_main_conf (ngx_conf_t * cf)
name|ngx_http_fastcgi_create_main_conf
parameter_list|(
name|ngx_conf_t
modifier|*
...
return|;
block|}
comment|/*      * set by ngx_pcalloc():      *      *     conf->upstream.bufs.num = 0;      *     conf->upstream.ignore_headers = 0;      *     conf->upstream.next_upstream = 0;      *     conf->upstream.cache_zone = NULL;      *     conf->upstream.cache_use_stale = 0;      *     conf->upstream.cache_methods = 0;      *     conf->upstream.temp_path = NULL;      *     conf->upstream.hide_headers_hash = { NULL, 0 };      *     conf->upstream.store_lengths = NULL;      *     conf->upstream.store_values = NULL;      *      *     conf->index.len = { 0, NULL };      */
name|conf
operator|->
name|upstream
operator|.
...
literal|0
argument_list|,
literal|"\"fastcgi_cache\" zone \"%V\" is unknown"
argument_list|,
operator|&
name|shm_zone
operator|->
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_fastcgi_init_params (ngx_conf_t * cf,ngx_http_fastcgi_loc_conf_t * conf,ngx_http_fastcgi_params_t * params,ngx_keyval_t * default_params)
name|ngx_http_fastcgi_init_params
parameter_list|(
name|ngx_conf_t
modifier|*
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_fastcgi_path_info_variable (ngx_http_request_t * r,ngx_http_variable_value_t * v,uintptr_t data)
name|ngx_http_fastcgi_path_info_variable
parameter_list|(
name|ngx_http_request_t
modifier|*
...
name|ngx_http_fastcgi_ctx_t
modifier|*
DECL|function|ngx_http_fastcgi_split (ngx_http_request_t * r,ngx_http_fastcgi_loc_conf_t * flcf)
name|ngx_http_fastcgi_split
parameter_list|(
name|ngx_http_request_t
modifier|*
...
name|char
modifier|*
DECL|function|ngx_http_fastcgi_split_path_info (ngx_conf_t * cf,ngx_command_t * cmd,void * conf)
name|ngx_http_fastcgi_split_path_info
parameter_list|(
name|ngx_conf_t
modifier|*
...
literal|0
argument_list|,
literal|"pattern \"%V\" must have 2 captures"
argument_list|,
operator|&
name|value
index|[
...
literal|0
argument_list|,
literal|"\"%V\" requires PCRE library"
argument_list|,
operator|&
name|cmd
operator|->
...
name|char
modifier|*
DECL|function|ngx_http_fastcgi_cache (ngx_conf_t * cf,ngx_command_t * cmd,void * conf)
name|ngx_http_fastcgi_cache
parameter_list|(
name|ngx_conf_t
modifier|*
...
name|char
modifier|*
DECL|function|ngx_http_fastcgi_cache_key (ngx_conf_t * cf,ngx_command_t * cmd,void * conf)
name|ngx_http_fastcgi_cache_key
parameter_list|(
name|ngx_conf_t
modifier|*
