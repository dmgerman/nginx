...
begin_define
DECL|macro|NGX_HTTP_REWRITE_COPY_CAPTURE
define|#
directive|define
name|NGX_HTTP_REWRITE_COPY_CAPTURE
value|0
end_define
...
begin_define
DECL|macro|NGX_HTTP_REWRITE_START_ARGS
define|#
directive|define
name|NGX_HTTP_REWRITE_START_ARGS
value|3
end_define

begin_typedef
DECL|struct|__anon2bc205510108
typedef|typedef
struct|struct
block|{
DECL|member|op
...
begin_typedef
DECL|struct|__anon2bc205510208
typedef|typedef
struct|struct
block|{
DECL|member|regex
...
begin_typedef
DECL|struct|__anon2bc205510308
typedef|typedef
struct|struct
block|{
DECL|member|rules
...
begin_typedef
DECL|struct|__anon2bc205510408
typedef|typedef
struct|struct
block|{
...
begin_decl_stmt
DECL|variable|ngx_http_redirect_p
specifier|static
name|ngx_conf_post_handler_pt
name|ngx_http_redirect_p
init|=
name|ngx_http_redirect
decl_stmt|;
end_decl_stmt
...
block|{
comment|/* NGX_HTTP_REWRITE_COPY_CAPTURE */
name|m
operator|=
literal|2
operator|*
...
literal|0
argument_list|,
literal|"rewritten uri: \"%V\", args: \"%V\""
argument_list|,
operator|&
name|uri
argument_list|,
...
begin_function
DECL|function|ngx_http_redirect_handler (ngx_http_request_t * r)
specifier|static
name|ngx_int_t
name|ngx_http_redirect_handler
parameter_list|(
name|ngx_http_request_t
modifier|*
name|r
...
begin_function
DECL|function|ngx_http_redirect (ngx_conf_t * cf,void * post,void * data)
specifier|static
name|char
modifier|*
name|ngx_http_redirect
