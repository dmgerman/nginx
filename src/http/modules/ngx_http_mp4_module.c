...
begin_define
DECL|macro|NGX_HTTP_MP4_EDTS_ATOM
define|#
directive|define
name|NGX_HTTP_MP4_EDTS_ATOM
value|2
end_define

begin_define
DECL|macro|NGX_HTTP_MP4_ELST_ATOM
define|#
directive|define
name|NGX_HTTP_MP4_ELST_ATOM
value|3
end_define
...
begin_define
DECL|macro|NGX_HTTP_MP4_STSC_START
define|#
directive|define
name|NGX_HTTP_MP4_STSC_START
value|20
end_define
...
begin_define
DECL|macro|NGX_HTTP_MP4_STSC_END
define|#
directive|define
name|NGX_HTTP_MP4_STSC_END
value|22
end_define
...
begin_define
DECL|macro|NGX_HTTP_MP4_CO64_ATOM
define|#
directive|define
name|NGX_HTTP_MP4_CO64_ATOM
value|27
end_define

begin_define
DECL|macro|NGX_HTTP_MP4_CO64_DATA
define|#
directive|define
name|NGX_HTTP_MP4_CO64_DATA
value|28
end_define
...
value|NGX_HTTP_MP4_CO64_DATA
end_define

begin_typedef
DECL|struct|__anon2950cff20108
typedef|typedef
struct|struct
block|{
...
decl_stmt|;
DECL|member|start_key_frame
name|ngx_flag_t
name|start_key_frame
decl_stmt|;
...
begin_typedef
DECL|struct|__anon2950cff20208
typedef|typedef
struct|struct
block|{
DECL|member|chunk
...
begin_typedef
DECL|struct|__anon2950cff20308
typedef|typedef
struct|struct
block|{
DECL|member|size
...
index|]
decl_stmt|;
DECL|typedef|ngx_mp4_edts_atom_t
block|}
name|ngx_mp4_edts_atom_t
typedef|;
end_typedef

begin_typedef
DECL|struct|__anon2950cff20408
typedef|typedef
struct|struct
block|{
DECL|member|size
...
index|]
decl_stmt|;
DECL|typedef|ngx_mp4_elst_atom_t
block|}
name|ngx_mp4_elst_atom_t
typedef|;
end_typedef

begin_typedef
DECL|struct|__anon2950cff20508
typedef|typedef
struct|struct
block|{
...
name|start_chunk
decl_stmt|;
DECL|member|end_chunk
name|ngx_uint_t
name|end_chunk
decl_stmt|;
DECL|member|start_chunk_samples
name|ngx_uint_t
name|start_chunk_samples
decl_stmt|;
DECL|member|end_chunk_samples
name|ngx_uint_t
name|end_chunk_samples
decl_stmt|;
DECL|member|start_chunk_samples_size
name|uint64_t
name|start_chunk_samples_size
decl_stmt|;
DECL|member|end_chunk_samples_size
name|uint64_t
...
name|tkhd_atom_buf
decl_stmt|;
DECL|member|edts_atom_buf
name|ngx_buf_t
name|edts_atom_buf
decl_stmt|;
DECL|member|elst_atom_buf
name|ngx_buf_t
name|elst_atom_buf
decl_stmt|;
...
name|stsc_atom_buf
decl_stmt|;
DECL|member|stsc_start_chunk_buf
name|ngx_buf_t
name|stsc_start_chunk_buf
decl_stmt|;
DECL|member|stsc_end_chunk_buf
name|ngx_buf_t
name|stsc_end_chunk_buf
decl_stmt|;
...
name|stco_data_buf
decl_stmt|;
DECL|member|co64_atom_buf
name|ngx_buf_t
name|co64_atom_buf
decl_stmt|;
DECL|member|co64_data_buf
name|ngx_buf_t
name|co64_data_buf
decl_stmt|;
DECL|member|edts_atom
name|ngx_mp4_edts_atom_t
name|edts_atom
decl_stmt|;
DECL|member|elst_atom
name|ngx_mp4_elst_atom_t
name|elst_atom
decl_stmt|;
DECL|member|stsc_start_chunk_entry
name|ngx_mp4_stsc_entry_t
name|stsc_start_chunk_entry
decl_stmt|;
DECL|member|stsc_end_chunk_entry
name|ngx_mp4_stsc_entry_t
name|stsc_end_chunk_entry
decl_stmt|;
...
begin_typedef
DECL|struct|__anon2950cff20608
typedef|typedef
struct|struct
block|{
DECL|member|file
...
begin_typedef
DECL|struct|__anon2950cff20708
typedef|typedef
struct|struct
block|{
DECL|member|name
...
begin_define
DECL|macro|ngx_mp4_atom_data_size (t)
define|#
directive|define
name|ngx_mp4_atom_data_size
parameter_list|(
name|t
parameter_list|)
value|(uint64_t) (sizeof(t) - 8)
end_define
...
parameter_list|)
define|\                                                                               \
value|if (n> (size_t) (mp4->buffer_end - mp4->buffer_pos)) {                   \         mp4->buffer_pos = mp4->buffer_end;                                    \                                                                               \     } else {                                                                  \         mp4->buffer_pos += (size_t) n;                                        \     }                                                                         \                                                                               \     mp4->offset += n
end_define
...
begin_define
DECL|macro|ngx_mp4_get_16value (p)
define|#
directive|define
name|ngx_mp4_get_16value
parameter_list|(
name|p
parameter_list|)
define|\
...
begin_define
DECL|macro|ngx_mp4_set_16value (p,n)
define|#
directive|define
name|ngx_mp4_set_16value
parameter_list|(
name|p
parameter_list|,
name|n
parameter_list|)
define|\
value|((u_char *) (p))[0] = (u_char) ((n)>> 8);                                \     ((u_char *) (p))[1] = (u_char)  (n)
end_define
...
parameter_list|)
define|\
value|( ((uint32_t) ((u_char *) (p))[0]<< 24)                                  \     + (           ((u_char *) (p))[1]<< 16)                                  \     + (           ((u_char *) (p))[2]<< 8)                                   \     + (           ((u_char *) (p))[3]) )
end_define
...
parameter_list|)
define|\
value|((u_char *) (p))[0] = (u_char) ((uint64_t) (n)>> 56);                    \     ((u_char *) (p))[1] = (u_char) ((uint64_t) (n)>> 48);                    \     ((u_char *) (p))[2] = (u_char) ((uint64_t) (n)>> 40);                    \     ((u_char *) (p))[3] = (u_char) ((uint64_t) (n)>> 32);                    \     ((u_char *) (p))[4] = (u_char) (           (n)>> 24);                    \     ((u_char *) (p))[5] = (u_char) (           (n)>> 16);                    \     ((u_char *) (p))[6] = (u_char) (           (n)>> 8);                     \     ((u_char *) (p))[7] = (u_char)             (n)
end_define
...
specifier|static
name|void
name|ngx_http_mp4_update_mdhd_atom
parameter_list|(
name|ngx_http_mp4_file_t
modifier|*
name|mp4
...
specifier|static
name|void
name|ngx_http_mp4_update_edts_atom
parameter_list|(
name|ngx_http_mp4_file_t
modifier|*
name|mp4
...
specifier|static
name|ngx_int_t
name|ngx_http_mp4_crop_stts_data
parameter_list|(
name|ngx_http_mp4_file_t
modifier|*
name|mp4
...
specifier|static
name|uint32_t
name|ngx_http_mp4_seek_key_frame
parameter_list|(
name|ngx_http_mp4_file_t
modifier|*
name|mp4
...
specifier|static
name|void
name|ngx_http_mp4_crop_stss_data
parameter_list|(
name|ngx_http_mp4_file_t
modifier|*
name|mp4
...
specifier|static
name|void
name|ngx_http_mp4_crop_ctts_data
parameter_list|(
name|ngx_http_mp4_file_t
modifier|*
name|mp4
...
specifier|static
name|ngx_int_t
name|ngx_http_mp4_crop_stsc_data
parameter_list|(
name|ngx_http_mp4_file_t
modifier|*
name|mp4
...
specifier|static
name|ngx_int_t
name|ngx_http_mp4_read_co64_atom
parameter_list|(
name|ngx_http_mp4_file_t
modifier|*
name|mp4
...
specifier|static
name|ngx_int_t
name|ngx_http_mp4_update_co64_atom
parameter_list|(
name|ngx_http_mp4_file_t
modifier|*
name|mp4
...
specifier|static
name|void
name|ngx_http_mp4_adjust_co64_atom
parameter_list|(
name|ngx_http_mp4_file_t
modifier|*
name|mp4
...
literal|0
argument_list|,
literal|"mp4 start:%ui, length:%ui"
argument_list|,
name|mp4
operator|->
name|start
...
literal|0
argument_list|,
literal|"start time is out mp4 mdat atom in \"%s\""
argument_list|,
name|mp4
operator|->
name|file
...
begin_typedef
DECL|struct|__anon2950cff20808
typedef|typedef
struct|struct
block|{
DECL|member|size
...
begin_typedef
DECL|struct|__anon2950cff20908
typedef|typedef
struct|struct
block|{
DECL|member|size
...
literal|0
argument_list|,
literal|"\"%s\" mp4 atom too large:%uL"
argument_list|,
name|mp4
operator|->
name|file
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_mp4_read (ngx_http_mp4_file_t * mp4,size_t size)
name|ngx_http_mp4_read
parameter_list|(
name|ngx_http_mp4_file_t
modifier|*
...
literal|" read only %z of %z from \"%s\""
argument_list|,
name|n
argument_list|,
name|mp4
...
literal|0
argument_list|,
literal|"duplicate mp4 ftyp atom in \"%s\""
argument_list|,
name|mp4
operator|->
name|file
...
literal|0
argument_list|,
literal|"duplicate mp4 moov atom in \"%s\""
argument_list|,
name|mp4
operator|->
name|file
...
literal|0
argument_list|,
literal|"duplicate mp4 mdat atom in \"%s\""
argument_list|,
name|mp4
operator|->
name|file
...
specifier|static
name|size_t
DECL|function|ngx_http_mp4_update_mdat_atom (ngx_http_mp4_file_t * mp4,off_t start_offset,off_t end_offset)
name|ngx_http_mp4_update_mdat_atom
parameter_list|(
name|ngx_http_mp4_file_t
modifier|*
...
begin_typedef
DECL|struct|__anon2950cff20a08
typedef|typedef
struct|struct
block|{
DECL|member|size
...
begin_typedef
DECL|struct|__anon2950cff20b08
typedef|typedef
struct|struct
block|{
DECL|member|size
...
literal|0
argument_list|,
literal|"duplicate mp4 mvhd atom in \"%s\""
argument_list|,
name|mp4
operator|->
name|file
...
literal|0
argument_list|,
literal|"\"%s\" mp4 mvhd atom too small"
argument_list|,
name|mp4
operator|->
name|file
...
begin_typedef
DECL|struct|__anon2950cff20c08
typedef|typedef
struct|struct
block|{
DECL|member|size
...
begin_typedef
DECL|struct|__anon2950cff20d08
typedef|typedef
struct|struct
block|{
DECL|member|size
...
literal|0
argument_list|,
literal|"\"%s\" mp4 tkhd atom too small"
argument_list|,
name|mp4
operator|->
name|file
...
literal|0
argument_list|,
literal|"duplicate mp4 tkhd atom in \"%s\""
argument_list|,
name|mp4
operator|->
name|file
...
literal|0
argument_list|,
literal|"duplicate mp4 mdia atom in \"%s\""
argument_list|,
name|mp4
operator|->
name|file
...
begin_typedef
DECL|struct|__anon2950cff20e08
typedef|typedef
struct|struct
block|{
DECL|member|size
...
begin_typedef
DECL|struct|__anon2950cff20f08
typedef|typedef
struct|struct
block|{
DECL|member|size
...
literal|0
argument_list|,
literal|"\"%s\" mp4 mdhd atom too small"
argument_list|,
name|mp4
operator|->
name|file
...
literal|0
argument_list|,
literal|"duplicate mp4 mdhd atom in \"%s\""
argument_list|,
name|mp4
operator|->
name|file
...
specifier|static
name|void
DECL|function|ngx_http_mp4_update_mdhd_atom (ngx_http_mp4_file_t * mp4,ngx_http_mp4_trak_t * trak)
name|ngx_http_mp4_update_mdhd_atom
parameter_list|(
name|ngx_http_mp4_file_t
modifier|*
...
literal|0
argument_list|,
literal|"duplicate mp4 hdlr atom in \"%s\""
argument_list|,
name|mp4
operator|->
name|file
...
literal|0
argument_list|,
literal|"duplicate mp4 minf atom in \"%s\""
argument_list|,
name|mp4
operator|->
name|file
...
literal|0
argument_list|,
literal|"duplicate mp4 vmhd/smhd atom in \"%s\""
argument_list|,
name|mp4
operator|->
name|file
...
literal|0
argument_list|,
literal|"duplicate mp4 dinf atom in \"%s\""
argument_list|,
name|mp4
operator|->
name|file
...
literal|0
argument_list|,
literal|"duplicate mp4 stbl atom in \"%s\""
argument_list|,
name|mp4
operator|->
name|file
...
specifier|static
name|void
DECL|function|ngx_http_mp4_update_edts_atom (ngx_http_mp4_file_t * mp4,ngx_http_mp4_trak_t * trak)
name|ngx_http_mp4_update_edts_atom
parameter_list|(
name|ngx_http_mp4_file_t
modifier|*
...
literal|0
argument_list|,
literal|"mp4 edts atom update prefix:%uL"
argument_list|,
name|trak
operator|->
name|prefix
...
begin_typedef
DECL|struct|__anon2950cff21008
typedef|typedef
struct|struct
block|{
DECL|member|size
...
literal|0
argument_list|,
literal|"\"%s\" mp4 stsd atom too small"
argument_list|,
name|mp4
operator|->
name|file
...
literal|0
argument_list|,
literal|"duplicate mp4 stsd atom in \"%s\""
argument_list|,
name|mp4
operator|->
name|file
...
begin_typedef
DECL|struct|__anon2950cff21108
typedef|typedef
struct|struct
block|{
DECL|member|size
...
begin_typedef
DECL|struct|__anon2950cff21208
typedef|typedef
struct|struct
block|{
DECL|member|count
...
literal|0
argument_list|,
literal|"\"%s\" mp4 stts atom too small"
argument_list|,
name|mp4
operator|->
name|file
...
literal|0
argument_list|,
literal|"duplicate mp4 stts atom in \"%s\""
argument_list|,
name|mp4
operator|->
name|file
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_mp4_crop_stts_data (ngx_http_mp4_file_t * mp4,ngx_http_mp4_trak_t * trak,ngx_uint_t start)
name|ngx_http_mp4_crop_stts_data
parameter_list|(
name|ngx_http_mp4_file_t
modifier|*
...
specifier|static
name|uint32_t
DECL|function|ngx_http_mp4_seek_key_frame (ngx_http_mp4_file_t * mp4,ngx_http_mp4_trak_t * trak,uint32_t start_sample)
name|ngx_http_mp4_seek_key_frame
parameter_list|(
name|ngx_http_mp4_file_t
modifier|*
...
literal|0
argument_list|,
literal|"mp4 key frame prefix:%uD"
argument_list|,
name|key_prefix
argument_list|)
expr_stmt|;
...
begin_typedef
DECL|struct|__anon2950cff21308
typedef|typedef
struct|struct
block|{
DECL|member|size
...
literal|0
argument_list|,
literal|"\"%s\" mp4 stss atom too small"
argument_list|,
name|mp4
operator|->
name|file
...
literal|0
argument_list|,
literal|"duplicate mp4 stss atom in \"%s\""
argument_list|,
name|mp4
operator|->
name|file
...
specifier|static
name|void
DECL|function|ngx_http_mp4_crop_stss_data (ngx_http_mp4_file_t * mp4,ngx_http_mp4_trak_t * trak,ngx_uint_t start)
name|ngx_http_mp4_crop_stss_data
parameter_list|(
name|ngx_http_mp4_file_t
modifier|*
...
begin_typedef
DECL|struct|__anon2950cff21408
typedef|typedef
struct|struct
block|{
DECL|member|size
...
begin_typedef
DECL|struct|__anon2950cff21508
typedef|typedef
struct|struct
block|{
DECL|member|count
...
literal|0
argument_list|,
literal|"\"%s\" mp4 ctts atom too small"
argument_list|,
name|mp4
operator|->
name|file
...
literal|0
argument_list|,
literal|"duplicate mp4 ctts atom in \"%s\""
argument_list|,
name|mp4
operator|->
name|file
...
specifier|static
name|void
DECL|function|ngx_http_mp4_crop_ctts_data (ngx_http_mp4_file_t * mp4,ngx_http_mp4_trak_t * trak,ngx_uint_t start)
name|ngx_http_mp4_crop_ctts_data
parameter_list|(
name|ngx_http_mp4_file_t
modifier|*
...
begin_typedef
DECL|struct|__anon2950cff21608
typedef|typedef
struct|struct
block|{
DECL|member|size
...
literal|0
argument_list|,
literal|"\"%s\" mp4 stsc atom too small"
argument_list|,
name|mp4
operator|->
name|file
...
literal|0
argument_list|,
literal|"duplicate mp4 stsc atom in \"%s\""
argument_list|,
name|mp4
operator|->
name|file
...
literal|0
argument_list|,
literal|"zero number of entries in stsc atom in \"%s\""
argument_list|,
name|mp4
operator|->
name|file
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_mp4_crop_stsc_data (ngx_http_mp4_file_t * mp4,ngx_http_mp4_trak_t * trak,ngx_uint_t start)
name|ngx_http_mp4_crop_stsc_data
parameter_list|(
name|ngx_http_mp4_file_t
modifier|*
...
begin_typedef
DECL|struct|__anon2950cff21708
typedef|typedef
struct|struct
block|{
DECL|member|size
...
literal|0
argument_list|,
literal|"\"%s\" mp4 stsz atom too small"
argument_list|,
name|mp4
operator|->
name|file
...
literal|0
argument_list|,
literal|"duplicate mp4 stsz atom in \"%s\""
argument_list|,
name|mp4
operator|->
name|file
...
literal|0
argument_list|,
literal|"start time is out mp4 stsz samples in \"%s\""
argument_list|,
name|mp4
operator|->
name|file
...
literal|0
argument_list|,
literal|"chunk samples sizes:%uL"
argument_list|,
name|trak
operator|->
name|start_chunk_samples_size
...
literal|0
argument_list|,
literal|"end time is out mp4 stsz samples in \"%s\""
argument_list|,
name|mp4
operator|->
name|file
...
literal|0
argument_list|,
literal|"mp4 stsz end_chunk_samples_size:%uL"
argument_list|,
name|trak
operator|->
name|end_chunk_samples_size
...
begin_typedef
DECL|struct|__anon2950cff21808
typedef|typedef
struct|struct
block|{
DECL|member|size
...
literal|0
argument_list|,
literal|"\"%s\" mp4 stco atom too small"
argument_list|,
name|mp4
operator|->
name|file
...
literal|0
argument_list|,
literal|"duplicate mp4 stco/co64 atom in \"%s\""
argument_list|,
name|mp4
operator|->
name|file
...
literal|0
argument_list|,
literal|"end time is out mp4 stco chunks in \"%s\""
argument_list|,
name|mp4
operator|->
name|file
...
begin_typedef
DECL|struct|__anon2950cff21908
typedef|typedef
struct|struct
block|{
DECL|member|size
...
index|]
decl_stmt|;
DECL|typedef|ngx_mp4_co64_atom_t
block|}
name|ngx_mp4_co64_atom_t
typedef|;
end_typedef
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_mp4_read_co64_atom (ngx_http_mp4_file_t * mp4,uint64_t atom_data_size)
name|ngx_http_mp4_read_co64_atom
parameter_list|(
name|ngx_http_mp4_file_t
modifier|*
...
literal|0
argument_list|,
literal|"\"%s\" mp4 co64 atom too small"
argument_list|,
name|mp4
operator|->
name|file
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_mp4_update_co64_atom (ngx_http_mp4_file_t * mp4,ngx_http_mp4_trak_t * trak)
name|ngx_http_mp4_update_co64_atom
parameter_list|(
name|ngx_http_mp4_file_t
modifier|*
...
name|co64_atom
decl_stmt|;
comment|/*      * mdia.minf.stbl.co64 updating requires trak->start_chunk      * from mdia.minf.stbl.stsc which depends on value from mdia.mdhd      * atom which may reside after mdia.minf      */
name|ngx_log_debug0
argument_list|(
name|NGX_LOG_DEBUG_HTTP
argument_list|,
...
literal|0
argument_list|,
literal|"no mp4 co64 atoms were found in \"%s\""
argument_list|,
name|mp4
operator|->
name|file
...
literal|0
argument_list|,
literal|"start time is out mp4 co64 chunks in \"%s\""
argument_list|,
name|mp4
operator|->
name|file
...
literal|0
argument_list|,
literal|"end time is out mp4 co64 chunks in \"%s\""
argument_list|,
name|mp4
operator|->
name|file
...
specifier|static
name|void
DECL|function|ngx_http_mp4_adjust_co64_atom (ngx_http_mp4_file_t * mp4,ngx_http_mp4_trak_t * trak,off_t adjustment)
name|ngx_http_mp4_adjust_co64_atom
parameter_list|(
name|ngx_http_mp4_file_t
modifier|*
...
name|data
decl_stmt|;
comment|/*      * moov.trak.mdia.minf.stbl.co64 adjustment requires      * minimal start offset of all traks and new moov atom size      */
name|ngx_log_debug0
argument_list|(
name|NGX_LOG_DEBUG_HTTP
argument_list|,
...
literal|0
argument_list|,
literal|"mp4 co64 atom adjustment"
argument_list|)
expr_stmt|;
name|data
operator|=
