...
begin_typedef
DECL|struct|__anon2ba5d6720108
typedef|typedef
struct|struct
block|{
DECL|member|start
...
begin_typedef
DECL|struct|__anon2ba5d6720208
typedef|typedef
struct|struct
block|{
DECL|member|offset
...
specifier|static
name|ngx_int_t
name|ngx_http_range_singlepart_header
parameter_list|(
name|ngx_http_request_t
modifier|*
name|r
...
specifier|static
name|ngx_int_t
name|ngx_http_range_multipart_header
parameter_list|(
name|ngx_http_request_t
modifier|*
name|r
...
specifier|static
name|ngx_int_t
name|ngx_http_range_test_overlapped
parameter_list|(
name|ngx_http_request_t
modifier|*
name|r
...
specifier|static
name|ngx_int_t
name|ngx_http_range_singlepart_body
parameter_list|(
name|ngx_http_request_t
modifier|*
name|r
...
specifier|static
name|ngx_int_t
name|ngx_http_range_multipart_body
parameter_list|(
name|ngx_http_request_t
modifier|*
name|r
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_range_singlepart_header (ngx_http_request_t * r,ngx_http_range_filter_ctx_t * ctx)
name|ngx_http_range_singlepart_header
parameter_list|(
name|ngx_http_request_t
modifier|*
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_range_multipart_header (ngx_http_request_t * r,ngx_http_range_filter_ctx_t * ctx)
name|ngx_http_range_multipart_header
parameter_list|(
name|ngx_http_request_t
modifier|*
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_range_not_satisfiable (ngx_http_request_t * r)
name|ngx_http_range_not_satisfiable
parameter_list|(
name|ngx_http_request_t
modifier|*
...
return|;
block|}
comment|/*      * multipart ranges are supported only if whole body is in a single buffer      */
if|if
condition|(
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_range_test_overlapped (ngx_http_request_t * r,ngx_http_range_filter_ctx_t * ctx,ngx_chain_t * in)
name|ngx_http_range_test_overlapped
parameter_list|(
name|ngx_http_request_t
modifier|*
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_range_singlepart_body (ngx_http_request_t * r,ngx_http_range_filter_ctx_t * ctx,ngx_chain_t * in)
name|ngx_http_range_singlepart_body
parameter_list|(
name|ngx_http_request_t
modifier|*
...
literal|0
argument_list|,
literal|"http range body buf: %O-%O"
argument_list|,
name|start
argument_list|,
name|last
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_range_multipart_body (ngx_http_request_t * r,ngx_http_range_filter_ctx_t * ctx,ngx_chain_t * in)
name|ngx_http_range_multipart_body
parameter_list|(
name|ngx_http_request_t
modifier|*
