...
specifier|static
name|ngx_int_t
name|ngx_http_perl_get_interpreter
parameter_list|(
name|ngx_http_perl_main_conf_t
modifier|*
name|pmcf
...
name|char
modifier|*
name|ngx_http_perl_interp_max_unsupported
parameter_list|(
name|ngx_conf_t
modifier|*
name|cf
...
begin_decl_stmt
DECL|variable|ngx_http_perl_interp_max_p
specifier|static
name|ngx_conf_post_handler_pt
name|ngx_http_perl_interp_max_p
init|=
name|ngx_http_perl_interp_max_unsupported
decl_stmt|;
end_decl_stmt
...
argument|sv
argument_list|,
argument|&params[NGX_HTTP_PERL_SSI_ARG]
argument_list|,
argument|handler
argument_list|,
argument|NULL
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_perl_get_interpreter (ngx_http_perl_main_conf_t * pmcf,PerlInterpreter ** perl,ngx_log_t * log)
name|ngx_http_perl_get_interpreter
parameter_list|(
name|ngx_http_perl_main_conf_t
modifier|*
...
literal|0
argument_list|,
literal|"no free perl interpreter"
argument_list|)
expr_stmt|;
return|return
...
name|ngx_inline
name|void
DECL|function|ngx_http_perl_free_interpreter (ngx_http_perl_main_conf_t * pmcf,PerlInterpreter * perl)
name|ngx_http_perl_free_interpreter
parameter_list|(
name|ngx_http_perl_main_conf_t
modifier|*
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_perl_run_requires (ngx_array_t * requires,ngx_log_t * log)
name|ngx_http_perl_run_requires
parameter_list|(
name|ngx_array_t
modifier|*
...
begin_comment
comment|/*  * disable 'declaration hides parameter "my_perl"' warning for ENTER and LEAVE  */
end_comment
...
specifier|static
name|void
DECL|function|ngx_http_perl_cleanup_sv (void * data)
name|ngx_http_perl_cleanup_sv
parameter_list|(
name|void
modifier|*
...
name|char
modifier|*
DECL|function|ngx_http_perl_require (ngx_conf_t * cf,ngx_command_t * cmd,void * conf)
name|ngx_http_perl_require
parameter_list|(
name|ngx_conf_t
modifier|*
...
name|char
modifier|*
DECL|function|ngx_http_perl_interp_max_unsupported (ngx_conf_t * cf,void * post,void * data)
name|ngx_http_perl_interp_max_unsupported
parameter_list|(
name|ngx_conf_t
modifier|*
...
directive|else
return|return
literal|"to use perl_interp_max you have to build perl with "
literal|"-Dusemultiplicity or -Dusethreads options"
return|;
endif|#
directive|endif
block|}
