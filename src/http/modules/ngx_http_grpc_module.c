...
begin_typedef
DECL|struct|__anon2a22dad80108
typedef|typedef
struct|struct
block|{
DECL|member|flushes
...
begin_typedef
DECL|struct|__anon2a22dad80208
typedef|typedef
struct|struct
block|{
...
begin_typedef
DECL|struct|__anon2a22dad80408
typedef|typedef
struct|struct
block|{
...
begin_typedef
DECL|struct|__anon2a22dad80508
typedef|typedef
struct|struct
block|{
DECL|member|state
...
begin_typedef
DECL|struct|__anon2a22dad80608
typedef|typedef
struct|struct
block|{
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_grpc_merge_ssl (ngx_conf_t * cf,ngx_http_grpc_loc_conf_t * conf,ngx_http_grpc_loc_conf_t * prev)
name|ngx_http_grpc_merge_ssl
parameter_list|(
name|ngx_conf_t
modifier|*
