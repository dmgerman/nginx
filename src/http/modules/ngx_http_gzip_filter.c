...
begin_typedef
DECL|struct|__anon288c95150108
typedef|typedef
struct|struct
block|{
DECL|member|enable
...
begin_typedef
DECL|struct|__anon288c95150208
typedef|typedef
struct|struct
block|{
DECL|member|in
...
directive|if
literal|0
block|unsigned             pass:1;     unsigned             blocked:1;
endif|#
directive|endif
DECL|member|zin
name|size_t
...
literal|0
comment|/* OLD CODE */
block_content|if (ctx->out) {             if (ctx->pass) {                 ctx->pass = 0;              } else if (last == NGX_AGAIN) {                 return last;             }          } else if (ctx->busy->buf&& ngx_buf_size(ctx->busy->buf)) {             if (last != NGX_NONE) {                 return last;             }          } else if (ctx->blocked) {             if (last != NGX_NONE) {                 return last;             }          } else {             if (last == NGX_NONE) {                 return NGX_OK;             }              return last;         }
endif|#
directive|endif
comment|/* NEW CODE */
if|if
