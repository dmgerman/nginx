...
name|quote
decl_stmt|;
comment|/* unsigned  quote:1; */
DECL|typedef|ngx_http_xslt_param_t
block|}
name|ngx_http_xslt_param_t
typedef|;
end_typedef
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_xslt_params (ngx_http_request_t * r,ngx_http_xslt_filter_ctx_t * ctx,ngx_array_t * params,ngx_uint_t final)
name|ngx_http_xslt_params
parameter_list|(
name|ngx_http_request_t
modifier|*
...
literal|0
argument_list|,
literal|"xsltQuoteOneUserParam(\"%s\", \"%s\") failed"
argument_list|,
name|param
index|[
name|i
...
name|char
modifier|*
DECL|function|ngx_http_xslt_param (ngx_conf_t * cf,ngx_command_t * cmd,void * conf)
name|ngx_http_xslt_param
parameter_list|(
name|ngx_conf_t
modifier|*
