...
name|p
expr_stmt|;
comment|/* TODO: we ignore return value of ngx_http_read_client_request_body,            probably we should not return anything  */
...
condition|)
block|{
comment|/*              * TODO: use stale cached response if it exists and enabled              */
return|return;
block|}
block|}
name|p
...
argument_list|)
expr_stmt|;
comment|/* set by ngx_pcalloc():      conf->bufs.num = 0;      conf->path = NULL;      conf->next_upstream = 0;     conf->use_stale = 0;      conf->upstreams = NULL;     conf->peers = NULL;      conf->cache_path = NULL;     conf->temp_path = NULL;      */
name|conf
operator|->
name|request_buffer_size
operator|=
