...
argument|cl
argument_list|,
argument|ngx_http_proxy_create_request(p)
argument_list|)
block|{
...
directive|if
literal|0
block_content|cl = ngx_http_proxy_create_request(p);     if (cl == NULL) {         ngx_http_finalize_request(r, NGX_HTTP_INTERNAL_SERVER_ERROR);         return;     }
endif|#
directive|endif
if|if
condition|(
