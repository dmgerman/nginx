...
begin_endif
unit|static ngx_int_t ngx_http_proxy_cache_get(ngx_http_proxy_ctx_t *p);
endif|#
directive|endif
end_endif
...
begin_function
DECL|function|ngx_http_proxy_rd_check_broken_connection (ngx_http_request_t * r)
name|void
...
begin_function
DECL|function|ngx_http_proxy_wr_check_broken_connection (ngx_http_request_t * r)
name|void
...
begin_function
DECL|function|ngx_http_proxy_check_broken_connection (ngx_http_request_t * r,ngx_event_t * ev)
name|void
name|ngx_http_proxy_check_broken_connection
parameter_list|(
name|ngx_http_request_t
...
name|len
argument_list|,
literal|" while %s, client: %V, server: %V, URL: \"%V\","
...
return|;
block|}
comment|/*      * set by ngx_pcalloc():      *      *    conf->bufs.num = 0;      *    conf->path = NULL;      *    conf->next_upstream = 0;      *    conf->use_stale = 0;      *    conf->upstreams = NULL;      *    conf->peers = NULL;      *    conf->cache_path = NULL;      *    conf->temp_path = NULL;      *    conf->x_vars;      *    conf->busy_lock = NULL;      */
name|conf
operator|->
name|connect_timeout
operator|=
