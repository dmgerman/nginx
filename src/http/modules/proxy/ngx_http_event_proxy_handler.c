...
begin_function
DECL|function|ngx_http_proxy_read_upstream_body (ngx_event_t * rev)
specifier|static
name|int
...
begin_function
DECL|function|ngx_http_proxy_write_upstream_body (ngx_event_t * wev)
specifier|static
name|int
name|ngx_http_proxy_write_upstream_body
parameter_list|(
