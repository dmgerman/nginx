...
name|n
expr_stmt|;
comment|/* the state handlers are called in the following order:             ngx_http_proxy_process_upstream_status_line(r)             ngx_http_proxy_process_upstream_headers(r) */
do|do
block|{
name|rc
operator|=
...
directive|if
literal|0
block_content|*p->header_in->last = '\0';     ngx_log_debug(p->log, "PROXY:\n'%s'" _ p->header_in->pos);
endif|#
directive|endif
name|rc
operator|=
