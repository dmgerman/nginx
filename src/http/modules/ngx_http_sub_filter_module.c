...
begin_typedef
DECL|struct|__anon2a21a8830108
typedef|typedef
struct|struct
block|{
DECL|member|match
...
DECL|member|sub_lengths
name|ngx_array_t
modifier|*
name|sub_lengths
decl_stmt|;
DECL|member|sub_values
name|ngx_array_t
modifier|*
name|sub_values
decl_stmt|;
...
begin_typedef
DECL|struct|__anon2a21a8830308
typedef|typedef
struct|struct
block|{
DECL|member|match
...
name|char
modifier|*
DECL|function|ngx_http_sub_types (ngx_conf_t * cf,ngx_command_t * cmd,void * conf)
name|ngx_http_sub_types
parameter_list|(
name|ngx_conf_t
modifier|*
...
return|;
block|}
comment|/*      * set by ngx_pcalloc():      *      *     conf->match.len = 0;      *     conf->match.data = NULL;      *     conf->sub.len = 0;      *     conf->sub.data = NULL;      *     conf->sub_lengths = NULL;      *     conf->sub_values = NULL;      *     conf->types = NULL;      */
name|slcf
operator|->
name|once
operator|=
