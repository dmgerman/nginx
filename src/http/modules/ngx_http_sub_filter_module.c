...
begin_typedef
DECL|struct|__anon29f8a5670108
typedef|typedef
struct|struct
block|{
DECL|member|match
...
begin_typedef
DECL|struct|__anon29f8a5670208
typedef|typedef
struct|struct
block|{
DECL|member|match
...
begin_typedef
DECL|struct|__anon29f8a5670308
typedef|typedef
struct|struct
block|{
...
begin_typedef
DECL|struct|__anon29f8a5670408
typedef|typedef
struct|struct
block|{
DECL|member|dynamic
...
begin_typedef
DECL|struct|__anon29f8a5670508
typedef|typedef
struct|struct
block|{
DECL|member|saved
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_sub_parse (ngx_http_request_t * r,ngx_http_sub_ctx_t * ctx,ngx_uint_t flush)
name|ngx_http_sub_parse
parameter_list|(
name|ngx_http_request_t
modifier|*
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_sub_match (ngx_http_sub_ctx_t * ctx,ngx_int_t start,ngx_str_t * m)
name|ngx_http_sub_match
parameter_list|(
name|ngx_http_sub_ctx_t
modifier|*
