...
begin_typedef
DECL|struct|__anon27cede5e0108
typedef|typedef
struct|struct
block|{
DECL|member|match
...
begin_typedef
DECL|struct|__anon27cede5e0208
typedef|typedef
struct|struct
block|{
...
begin_typedef
DECL|struct|__anon27cede5e0308
typedef|typedef
struct|struct
block|{
DECL|member|tables
...
begin_typedef
DECL|struct|__anon27cede5e0408
typedef|typedef
struct|struct
block|{
DECL|member|saved
...
return|;
block|}
comment|/*      * set by ngx_pcalloc():      *      *     conf->tables = NULL;      *     conf->types = { NULL };      *     conf->types_keys = NULL;      *     conf->matches = NULL;      */
name|slcf
operator|->
name|once
operator|=
