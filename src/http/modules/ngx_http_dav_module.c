...
begin_typedef
DECL|struct|__anon277178790108
typedef|typedef
struct|struct
block|{
DECL|member|methods
...
begin_typedef
DECL|struct|__anon277178790208
typedef|typedef
struct|struct
block|{
DECL|member|path
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_dav_copy_file (ngx_tree_ctx_t * ctx,u_char * from,u_char * to)
name|ngx_http_dav_copy_file
parameter_list|(
name|ngx_tree_ctx_t
modifier|*
