...
begin_function
DECL|function|ngx_http_ssl_read (ngx_http_request_t * r,u_char * buf,size_t size)
name|ngx_int_t
...
begin_function
DECL|function|ngx_http_ssl_write (ngx_connection_t * c,ngx_chain_t * in,off_t limit)
name|ngx_chain_t
modifier|*
...
begin_function
DECL|function|ngx_http_ssl_shutdown (ngx_http_request_t * r)
name|ngx_int_t
...
begin_function
DECL|function|ngx_http_ssl_create_ssl (ngx_http_request_t * r)
specifier|static
name|ngx_int_t
name|ngx_http_ssl_create_ssl
parameter_list|(
