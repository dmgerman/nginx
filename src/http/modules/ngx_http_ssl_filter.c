...
begin_typedef
DECL|struct|__anon2b5acec00108
typedef|typedef
struct|struct
block|{
DECL|member|enable
...
begin_typedef
DECL|struct|__anon2b5acec00208
typedef|typedef
struct|struct
block|{
DECL|member|ssl
...
begin_function
DECL|function|ngx_http_ssl_writer (ngx_http_request_t * r,ngx_chain_t * in)
name|ngx_int_t
...
begin_function
DECL|function|ngx_http_ssl_write (ngx_http_request_t * r,ngx_http_ssl_ctx_t * ctx,ngx_chain_t * in,off_t limit)
specifier|static
name|ngx_chain_t
modifier|*
name|ngx_http_ssl_write
