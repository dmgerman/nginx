...
literal|0
argument_list|,
literal|"client closed connection while SSL handshake"
argument_list|)
expr_stmt|;
...
literal|0
argument_list|,
literal|"client sent HTTP request to HTTPS port"
argument_list|)
expr_stmt|;
name|ngx_http_ssl_close_request
argument_list|(
...
begin_function
DECL|function|ngx_http_ssl_close_request (SSL * ssl,int mode)
name|void
name|ngx_http_ssl_close_request
parameter_list|(
name|SSL
