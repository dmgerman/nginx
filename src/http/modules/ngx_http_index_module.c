...
begin_typedef
DECL|struct|__anon2c9aac5a0108
typedef|typedef
struct|struct
block|{
DECL|member|name
...
begin_typedef
DECL|struct|__anon2c9aac5a0208
typedef|typedef
struct|struct
block|{
DECL|member|indices
...
begin_typedef
DECL|struct|__anon2c9aac5a0308
typedef|typedef
struct|struct
block|{
DECL|member|current
...
directive|if
literal|0
block_content|if (rc == NGX_AGAIN) {             ctx->current = i;             return NGX_AGAIN;         }
endif|#
directive|endif
if|if
condition|(
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_index_test_dir (ngx_http_request_t * r,ngx_http_core_loc_conf_t * clcf,ngx_http_index_ctx_t * ctx)
name|ngx_http_index_test_dir
parameter_list|(
name|ngx_http_request_t
modifier|*
