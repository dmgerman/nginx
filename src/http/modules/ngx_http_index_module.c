...
begin_typedef
DECL|struct|__anon29bba25a0108
typedef|typedef
struct|struct
block|{
DECL|member|name
...
begin_typedef
DECL|struct|__anon29bba25a0208
typedef|typedef
struct|struct
block|{
DECL|member|indices
...
begin_typedef
DECL|struct|__anon29bba25a0308
typedef|typedef
struct|struct
block|{
DECL|member|current
...
name|r
expr_stmt|;
comment|/* 1 byte for terminating '\0' and 4 bytes is preallocation */
name|len
operator|=
literal|1
operator|+
