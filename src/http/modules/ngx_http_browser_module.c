...
specifier|static
name|ngx_int_t
name|ngx_http_browser_add_variables
parameter_list|(
name|ngx_conf_t
modifier|*
name|cf
...
begin_decl_stmt
DECL|variable|ngx_http_browser_vars
specifier|static
name|ngx_http_variable_t
name|ngx_http_browser_vars
index|[]
init|=
block|{
block|{
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_browser_add_variables (ngx_conf_t * cf)
name|ngx_http_browser_add_variables
parameter_list|(
name|ngx_conf_t
modifier|*
