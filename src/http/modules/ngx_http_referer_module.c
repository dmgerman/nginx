...
begin_typedef
DECL|struct|__anon2c77a08b0108
typedef|typedef
struct|struct
block|{
DECL|member|hash
...
literal|0
argument_list|,
literal|"URI part \"%s\" is deprecated, ignored"
argument_list|,
name|p
argument_list|)
expr_stmt|;
...
name|char
modifier|*
DECL|function|ngx_http_add_referer (ngx_conf_t * cf,ngx_hash_keys_arrays_t * keys,ngx_str_t * value)
name|ngx_http_add_referer
parameter_list|(
name|ngx_conf_t
modifier|*
...
literal|0
argument_list|,
literal|"invalid DNS wildcard \"%V\""
argument_list|,
name|value
argument_list|)
expr_stmt|;
