...
begin_typedef
DECL|struct|__anon2a2edd2e0108
typedef|typedef
struct|struct
block|{
DECL|member|hash
...
specifier|static
name|ngx_int_t
name|ngx_http_referer_add_variables
parameter_list|(
name|ngx_conf_t
modifier|*
name|cf
...
begin_decl_stmt
DECL|variable|ngx_http_invalid_referer_name
specifier|static
name|ngx_str_t
name|ngx_http_invalid_referer_name
init|=
name|ngx_string
argument_list|(
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_referer_add_variables (ngx_conf_t * cf)
name|ngx_http_referer_add_variables
parameter_list|(
name|ngx_conf_t
modifier|*
