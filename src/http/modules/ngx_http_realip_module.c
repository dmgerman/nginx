...
begin_define
DECL|macro|NGX_HTTP_REALIP_PROXY
define|#
directive|define
...
begin_typedef
DECL|struct|__anon2993e7580108
typedef|typedef
struct|struct
block|{
DECL|member|from
...
begin_typedef
DECL|struct|__anon2993e7580208
typedef|typedef
struct|struct
block|{
...
specifier|static
name|ngx_int_t
name|ngx_http_realip_add_variables
parameter_list|(
name|ngx_conf_t
modifier|*
name|cf
...
specifier|static
name|ngx_int_t
name|ngx_http_realip_remote_addr_variable
parameter_list|(
name|ngx_http_request_t
modifier|*
name|r
...
specifier|static
name|ngx_int_t
name|ngx_http_realip_remote_port_variable
parameter_list|(
name|ngx_http_request_t
modifier|*
name|r
...
begin_decl_stmt
DECL|variable|ngx_http_realip_vars
specifier|static
name|ngx_http_variable_t
name|ngx_http_realip_vars
index|[]
init|=
block|{
block|{
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_realip_set_addr (ngx_http_request_t * r,ngx_addr_t * addr)
name|ngx_http_realip_set_addr
parameter_list|(
name|ngx_http_request_t
modifier|*
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_realip_add_variables (ngx_conf_t * cf)
name|ngx_http_realip_add_variables
parameter_list|(
name|ngx_conf_t
modifier|*
...
name|ngx_http_realip_ctx_t
modifier|*
DECL|function|ngx_http_realip_get_module_ctx (ngx_http_request_t * r)
name|ngx_http_realip_get_module_ctx
parameter_list|(
name|ngx_http_request_t
modifier|*
...
condition|)
block|{
comment|/*          * if module context was reset, the original address          * can still be found in the cleanup handler          */
for|for
control|(
name|cln
operator|=
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_realip_remote_addr_variable (ngx_http_request_t * r,ngx_http_variable_value_t * v,uintptr_t data)
name|ngx_http_realip_remote_addr_variable
parameter_list|(
name|ngx_http_request_t
modifier|*
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_realip_remote_port_variable (ngx_http_request_t * r,ngx_http_variable_value_t * v,uintptr_t data)
name|ngx_http_realip_remote_port_variable
parameter_list|(
name|ngx_http_request_t
modifier|*
