...
begin_define
DECL|macro|NGX_HTTP_GZIP_STATIC_OFF
define|#
directive|define
name|NGX_HTTP_GZIP_STATIC_OFF
value|0
end_define

begin_define
DECL|macro|NGX_HTTP_GZIP_STATIC_ON
define|#
directive|define
name|NGX_HTTP_GZIP_STATIC_ON
value|1
end_define

begin_define
DECL|macro|NGX_HTTP_GZIP_STATIC_ALWAYS
define|#
directive|define
name|NGX_HTTP_GZIP_STATIC_ALWAYS
value|2
end_define
...
begin_decl_stmt
DECL|variable|ngx_http_gzip_static
specifier|static
name|ngx_conf_enum_t
name|ngx_http_gzip_static
index|[]
init|=
block|{
block|{
