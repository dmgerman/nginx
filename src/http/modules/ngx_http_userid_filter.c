...
begin_typedef
DECL|struct|__anon28b482100108
typedef|typedef
struct|struct
block|{
DECL|member|enable
...
begin_typedef
DECL|struct|__anon28b482100208
typedef|typedef
struct|struct
block|{
DECL|member|uid_got
...
begin_decl_stmt
DECL|variable|ngx_conf_check_domain_p
specifier|static
name|ngx_conf_post_handler_pt
name|ngx_conf_check_domain_p
init|=
name|ngx_conf_check_domain
decl_stmt|;
end_decl_stmt
...
return|;
block|}
comment|/* set by ngx_pcalloc():      conf->name.len = 0;     conf->name.date = NULL;     conf->domain.len = 0;     conf->domain.date = NULL;     conf->path.len = 0;     conf->path.date = NULL;      */
name|conf
operator|->
name|enable
operator|=
...
begin_function
DECL|function|ngx_conf_check_domain (ngx_conf_t * cf,void * post,void * data)
name|char
modifier|*
name|ngx_conf_check_domain
parameter_list|(
