...
name|text
decl_stmt|;
DECL|struct|__anon29e847750208
struct|struct
block|{
DECL|member|lengths
name|void
...
begin_typedef
DECL|struct|__anon29e847750308
typedef|typedef
struct|struct
block|{
...
begin_typedef
DECL|struct|__anon29e847750408
typedef|typedef
struct|struct
block|{
DECL|member|status
...
name|name
operator|=
literal|"proxy_hide_headers_hash"
expr_stmt|;
name|hash
operator|.
name|pool
