...
name|text
decl_stmt|;
DECL|struct|__anon2757b4530208
struct|struct
block|{
DECL|member|lengths
name|void
...
begin_typedef
DECL|struct|__anon2757b4530308
typedef|typedef
struct|struct
block|{
...
begin_typedef
DECL|struct|__anon2757b4530408
typedef|typedef
struct|struct
block|{
...
begin_typedef
DECL|struct|__anon2757b4530508
typedef|typedef
struct|struct
block|{
DECL|member|status
...
begin_decl_stmt
DECL|variable|ngx_conf_deprecated_proxy_header_buffer_size
specifier|static
name|ngx_conf_deprecated_t
name|ngx_conf_deprecated_proxy_header_buffer_size
init|=
block|{
...
begin_decl_stmt
DECL|variable|ngx_conf_deprecated_proxy_redirect_errors
specifier|static
name|ngx_conf_deprecated_t
name|ngx_conf_deprecated_proxy_redirect_errors
init|=
block|{
name|ngx_conf_deprecated
block|,
literal|"proxy_redirect_errors"
block|,
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_proxy_set_vars (ngx_pool_t * pool,ngx_url_t * u,ngx_http_proxy_vars_t * v)
name|ngx_http_proxy_set_vars
parameter_list|(
name|ngx_pool_t
modifier|*
