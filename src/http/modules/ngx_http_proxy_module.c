...
begin_typedef
DECL|struct|__anon28d726530108
typedef|typedef
struct|struct
block|{
DECL|member|caches
...
begin_typedef
DECL|struct|__anon28d726530308
typedef|typedef
struct|struct
block|{
...
begin_typedef
DECL|struct|__anon28d726530408
typedef|typedef
struct|struct
block|{
DECL|member|flushes
...
begin_typedef
DECL|struct|__anon28d726530508
typedef|typedef
struct|struct
block|{
...
begin_typedef
DECL|struct|__anon28d726530608
typedef|typedef
struct|struct
block|{
DECL|member|status
...
return|;
block|}
comment|/* provide continuous buffer for subrequests in memory */
if|if
condition|(
name|r
operator|->
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_proxy_rewrite_cookie_value (ngx_http_request_t * r,ngx_table_elt_t * h,u_char * value,ngx_array_t * rewrites)
name|ngx_http_proxy_rewrite_cookie_value
parameter_list|(
name|ngx_http_request_t
modifier|*
