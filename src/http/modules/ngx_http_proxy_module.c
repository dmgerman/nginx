...
name|text
decl_stmt|;
DECL|struct|__anon299b34540208
struct|struct
block|{
DECL|member|lengths
name|void
...
begin_typedef
DECL|struct|__anon299b34540308
typedef|typedef
struct|struct
block|{
...
begin_typedef
DECL|struct|__anon299b34540408
typedef|typedef
struct|struct
block|{
...
begin_typedef
DECL|struct|__anon299b34540508
typedef|typedef
struct|struct
block|{
DECL|member|status
...
name|char
modifier|*
name|ngx_http_proxy_upstream_max_fails_unsupported
parameter_list|(
name|ngx_conf_t
modifier|*
name|cf
...
name|char
modifier|*
name|ngx_http_proxy_upstream_fail_timeout_unsupported
parameter_list|(
name|ngx_conf_t
modifier|*
name|cf
...
begin_decl_stmt
DECL|variable|ngx_http_proxy_ignore_headers_masks
specifier|static
name|ngx_conf_bitmask_t
name|ngx_http_proxy_ignore_headers_masks
index|[]
init|=
block|{
block|{
...
name|ngx_string
argument_list|(
literal|"proxy_upstream_max_fails"
argument_list|)
block|,
name|NGX_HTTP_MAIN_CONF
operator||
...
name|ngx_string
argument_list|(
literal|"proxy_upstream_fail_timeout"
argument_list|)
block|,
name|NGX_HTTP_MAIN_CONF
operator||
...
begin_decl_stmt
DECL|variable|ngx_http_proxy_hide_cache_headers
specifier|static
name|ngx_str_t
name|ngx_http_proxy_hide_cache_headers
index|[]
init|=
block|{
name|ngx_string
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_proxy_parse_status_line (ngx_http_request_t * r,ngx_http_proxy_ctx_t * ctx)
name|ngx_http_proxy_parse_status_line
parameter_list|(
name|ngx_http_request_t
modifier|*
...
return|;
block|}
comment|/*      * set by ngx_pcalloc():      *      *     conf->upstream.bufs.num = 0;      *     conf->upstream.ignore_headers = 0;      *     conf->upstream.next_upstream = 0;      *     conf->upstream.use_stale_cache = 0;      *     conf->upstream.temp_path = NULL;      *     conf->upstream.hide_headers_hash = { NULL, 0 };      *     conf->upstream.uri = { 0, NULL };      *     conf->upstream.location = NULL;      *     conf->upstream.store_lengths = NULL;      *     conf->upstream.store_values = NULL;      *      *     conf->method = NULL;      *     conf->headers_source = NULL;      *     conf->headers_set_len = NULL;      *     conf->headers_set = NULL;      *     conf->headers_set_hash = NULL;      *     conf->body_set_len = NULL;      *     conf->body_set = NULL;      *     conf->body_source = { 0, NULL };      *     conf->rewrite_locations = NULL;      */
name|conf
operator|->
name|upstream
operator|.
...
name|char
modifier|*
DECL|function|ngx_http_proxy_upstream_max_fails_unsupported (ngx_conf_t * cf,ngx_command_t * cmd,void * conf)
name|ngx_http_proxy_upstream_max_fails_unsupported
parameter_list|(
name|ngx_conf_t
modifier|*
...
literal|0
argument_list|,
literal|"\"proxy_upstream_max_fails\" is not supported, "
...
name|char
modifier|*
DECL|function|ngx_http_proxy_upstream_fail_timeout_unsupported (ngx_conf_t * cf,ngx_command_t * cmd,void * conf)
name|ngx_http_proxy_upstream_fail_timeout_unsupported
parameter_list|(
name|ngx_conf_t
modifier|*
...
literal|0
argument_list|,
literal|"\"proxy_upstream_fail_timeout\" is not supported, "
