...
name|text
decl_stmt|;
DECL|struct|__anon28ae92b60208
struct|struct
block|{
DECL|member|lengths
name|void
...
begin_typedef
DECL|struct|__anon28ae92b60308
typedef|typedef
struct|struct
block|{
...
begin_typedef
DECL|struct|__anon28ae92b60408
typedef|typedef
struct|struct
block|{
DECL|member|status
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_proxy_parse_status_line (ngx_http_request_t * r,ngx_http_proxy_ctx_t * p)
name|ngx_http_proxy_parse_status_line
parameter_list|(
name|ngx_http_request_t
modifier|*
