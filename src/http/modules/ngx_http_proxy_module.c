...
name|text
decl_stmt|;
DECL|struct|__anon27fc82700208
struct|struct
block|{
DECL|member|lengths
name|void
...
begin_typedef
DECL|struct|__anon27fc82700308
typedef|typedef
struct|struct
block|{
...
begin_typedef
DECL|struct|__anon27fc82700408
typedef|typedef
struct|struct
block|{
DECL|member|status
...
begin_decl_stmt
DECL|variable|ngx_http_proxy_set_methods
specifier|static
name|ngx_conf_enum_t
name|ngx_http_proxy_set_methods
index|[]
init|=
block|{
block|{
