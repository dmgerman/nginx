...
name|text
decl_stmt|;
DECL|struct|__anon27709fc90208
struct|struct
block|{
DECL|member|lengths
name|void
...
begin_typedef
DECL|struct|__anon27709fc90308
typedef|typedef
struct|struct
block|{
...
begin_typedef
DECL|struct|__anon27709fc90408
typedef|typedef
struct|struct
block|{
DECL|member|status
...
return|;
block|}
comment|/*      * set by ngx_pcalloc():      *      *     conf->upstream.bufs.num = 0;      *     conf->upstream.path = NULL;      *     conf->upstream.next_upstream = 0;      *     conf->upstream.temp_path = NULL;      *     conf->upstream.schema = { 0, NULL };      *     conf->upstream.uri = { 0, NULL };      *     conf->upstream.location = NULL;      *      *     conf->method = NULL;      *     conf->headers_source = NULL;      *     conf->headers_set_len = NULL;      *     conf->headers_set = NULL;      *     conf->headers_set_hash = NULL;      *     conf->body_set_len = NULL;      *     conf->body_set = NULL;      *     conf->body_source = { 0, NULL };      *     conf->rewrite_locations = NULL;      */
name|conf
operator|->
name|upstream
operator|.
