...
name|ngx_inline
name|ngx_int_t
DECL|function|ngx_http_proxy_parse_chunked (ngx_http_request_t * r,ngx_buf_t * buf)
name|ngx_http_proxy_parse_chunked
parameter_list|(
name|ngx_http_request_t
modifier|*
name|r
...
literal|0
block|,
DECL|enumerator|sw_chunk_size
name|sw_chunk_size
block|,
DECL|enumerator|sw_chunk_extension
name|sw_chunk_extension
block|,
DECL|enumerator|sw_chunk_extension_almost_done
name|sw_chunk_extension_almost_done
block|,
DECL|enumerator|sw_chunk_data
name|sw_chunk_data
block|,
DECL|enumerator|sw_after_data
name|sw_after_data
block|,
DECL|enumerator|sw_after_data_almost_done
name|sw_after_data_almost_done
block|,
DECL|enumerator|sw_last_chunk_extension
name|sw_last_chunk_extension
block|,
DECL|enumerator|sw_last_chunk_extension_almost_done
name|sw_last_chunk_extension_almost_done
block|,
DECL|enumerator|sw_trailer
name|sw_trailer
block|,
DECL|enumerator|sw_trailer_almost_done
name|sw_trailer_almost_done
block|,
DECL|enumerator|sw_trailer_header
name|sw_trailer_header
block|,
DECL|enumerator|sw_trailer_header_almost_done
name|sw_trailer_header_almost_done
block|}
name|state
enum|;
name|ctx
...
literal|0
argument_list|,
literal|"http proxy chunked byte: %02Xd s:%d"
argument_list|,
name|ch
argument_list|,
name|state
