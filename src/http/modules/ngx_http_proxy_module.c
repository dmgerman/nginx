...
name|text
decl_stmt|;
DECL|struct|__anon2c881ea80208
struct|struct
block|{
DECL|member|lengths
name|void
...
begin_typedef
DECL|struct|__anon2c881ea80308
typedef|typedef
struct|struct
block|{
...
begin_typedef
DECL|struct|__anon2c881ea80408
typedef|typedef
struct|struct
block|{
DECL|member|status
...
name|ngx_string
argument_list|(
literal|"proxy_pass_x_powered_by"
argument_list|)
block|,
name|NGX_HTTP_MAIN_CONF
operator||
...
return|;
block|}
comment|/*      * set by ngx_pcalloc():      *      *     conf->upstream.bufs.num = 0;      *     conf->upstream.next_upstream = 0;      *     conf->upstream.temp_path = NULL;      *     conf->upstream.schema = { 0, NULL };      *     conf->upstream.uri = { 0, NULL };      *     conf->upstream.location = NULL;      *      *     conf->method = NULL;      *     conf->headers_source = NULL;      *     conf->headers_set_len = NULL;      *     conf->headers_set = NULL;      *     conf->headers_set_hash = NULL;      *     conf->body_set_len = NULL;      *     conf->body_set = NULL;      *     conf->body_source = { 0, NULL };      *     conf->rewrite_locations = NULL;      */
name|conf
operator|->
name|upstream
operator|.
