...
begin_typedef
DECL|struct|__anon2b84def80108
typedef|typedef
struct|struct
block|{
DECL|member|enable
...
begin_typedef
DECL|struct|__anon2b84def80208
typedef|typedef
struct|struct
block|{
DECL|member|uid_got
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_userid_variable (ngx_http_request_t * r,ngx_http_variable_value_t * v,uintptr_t data)
name|ngx_http_userid_variable
parameter_list|(
name|ngx_http_request_t
modifier|*
