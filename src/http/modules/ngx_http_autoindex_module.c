...
begin_define
DECL|macro|NGX_HTTP_AUTOINDEX_HTML
define|#
directive|define
name|NGX_HTTP_AUTOINDEX_HTML
value|0
end_define

begin_define
DECL|macro|NGX_HTTP_AUTOINDEX_JSON
define|#
directive|define
name|NGX_HTTP_AUTOINDEX_JSON
value|1
end_define

begin_define
DECL|macro|NGX_HTTP_AUTOINDEX_JSONP
define|#
directive|define
name|NGX_HTTP_AUTOINDEX_JSONP
value|2
end_define

begin_define
DECL|macro|NGX_HTTP_AUTOINDEX_XML
define|#
directive|define
name|NGX_HTTP_AUTOINDEX_XML
value|3
end_define
...
specifier|static
name|ngx_int_t
name|ngx_http_autoindex_jsonp_callback
parameter_list|(
name|ngx_http_request_t
modifier|*
name|r
...
begin_decl_stmt
DECL|variable|ngx_http_autoindex_format
specifier|static
name|ngx_conf_enum_t
name|ngx_http_autoindex_format
index|[]
init|=
block|{
block|{
...
break|break;
default|default:
comment|/* NGX_HTTP_AUTOINDEX_HTML */
name|ngx_str_set
argument_list|(
operator|&
name|r
...
name|ngx_buf_t
modifier|*
DECL|function|ngx_http_autoindex_html (ngx_http_request_t * r,ngx_array_t * entries)
name|ngx_http_autoindex_html
parameter_list|(
name|ngx_http_request_t
modifier|*
...
name|ngx_buf_t
modifier|*
DECL|function|ngx_http_autoindex_json (ngx_http_request_t * r,ngx_array_t * entries,ngx_str_t * callback)
name|ngx_http_autoindex_json
parameter_list|(
name|ngx_http_request_t
modifier|*
...
sizeof|sizeof
argument_list|(
literal|", \"mtime\":\"Wed, 31 Dec 1986 10:00:00 GMT\""
argument_list|)
operator|-
literal|1
expr_stmt|;
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_autoindex_jsonp_callback (ngx_http_request_t * r,ngx_str_t * callback)
name|ngx_http_autoindex_jsonp_callback
parameter_list|(
name|ngx_http_request_t
modifier|*
...
literal|0
argument_list|,
literal|"client sent too long callback name: \"%V\""
argument_list|,
name|callback
argument_list|)
expr_stmt|;
...
literal|0
argument_list|,
literal|"client sent invalid callback name: \"%V\""
argument_list|,
name|callback
argument_list|)
expr_stmt|;
...
name|ngx_buf_t
modifier|*
DECL|function|ngx_http_autoindex_xml (ngx_http_request_t * r,ngx_array_t * entries)
name|ngx_http_autoindex_xml
parameter_list|(
name|ngx_http_request_t
modifier|*
...
sizeof|sizeof
argument_list|(
literal|" mtime=\"1986-12-31T10:00:00Z\""
argument_list|)
operator|-
literal|1
expr_stmt|;
...
name|last
argument_list|,
literal|"%4d-%02d-%02dT%02d:%02d:%02dZ"
argument_list|,
name|tm
operator|.
name|ngx_tm_year
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_autoindex_init (ngx_conf_t * cf)
name|ngx_http_autoindex_init
parameter_list|(
name|ngx_conf_t
modifier|*
