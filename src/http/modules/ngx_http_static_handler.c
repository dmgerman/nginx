...
directive|if
literal|0
block_content|if (rc == NGX_AGAIN) {             ngx_http_set_write_handler(r);          } else {             ngx_http_finalize_request(r, 0);         }
endif|#
directive|endif
return|return
name|NGX_OK
...
directive|if
literal|0
block_content|h->type = r->main ? NGX_HUNK_FILE : NGX_HUNK_FILE|NGX_HUNK_LAST;
else|#
directive|else
name|h
operator|->
...
directive|if
literal|0
block_content|if (r->main == NULL) {         if (rc == NGX_AGAIN) {             ngx_http_set_write_handler(r);          } else {             ngx_http_finalize_request(r, 0);         }     }
endif|#
directive|endif
return|return
name|NGX_OK
