...
begin_typedef
DECL|struct|__anon28a5896f0108
typedef|typedef
struct|struct
block|{
DECL|member|realm
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_auth_basic_crypt_handler (ngx_http_request_t * r,ngx_str_t * passwd,ngx_str_t * realm)
name|ngx_http_auth_basic_crypt_handler
parameter_list|(
name|ngx_http_request_t
modifier|*
