...
begin_typedef
DECL|struct|__anon2aacfa4a0108
typedef|typedef
struct|struct
block|{
DECL|member|free
...
name|ngx_chain_t
modifier|*
name|ngx_http_chunked_create_trailers
parameter_list|(
...
name|ngx_chain_t
modifier|*
DECL|function|ngx_http_chunked_create_trailers (ngx_http_request_t * r,ngx_http_chunked_filter_ctx_t * ctx)
name|ngx_http_chunked_create_trailers
parameter_list|(
name|ngx_http_request_t
modifier|*
