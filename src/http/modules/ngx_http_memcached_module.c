...
begin_typedef
DECL|struct|__anon29aeace70108
typedef|typedef
struct|struct
block|{
...
begin_typedef
DECL|struct|__anon29aeace70208
typedef|typedef
struct|struct
block|{
DECL|member|rest
...
name|ngx_string
argument_list|(
literal|"memcached_socket_keepalive"
argument_list|)
block|,
name|NGX_HTTP_MAIN_CONF
operator||
...
name|ngx_string
argument_list|(
literal|"memcached_next_upstream_tries"
argument_list|)
block|,
name|NGX_HTTP_MAIN_CONF
operator||
...
name|ngx_string
argument_list|(
literal|"memcached_next_upstream_timeout"
argument_list|)
block|,
name|NGX_HTTP_MAIN_CONF
operator||
...
literal|0
argument_list|,
literal|"memcached sent invalid flags in response \"%V\" "
literal|"for key \"%V\""
argument_list|,
operator|&
name|line
...
return|;
block|}
comment|/*      * set by ngx_pcalloc():      *      *     conf->upstream.bufs.num = 0;      *     conf->upstream.next_upstream = 0;      *     conf->upstream.temp_path = NULL;      */
name|conf
operator|->
name|upstream
operator|.
