...
begin_typedef
DECL|struct|__anon2a368ae00108
typedef|typedef
struct|struct
block|{
...
begin_typedef
DECL|struct|__anon2a368ae00208
typedef|typedef
struct|struct
block|{
DECL|member|rest
...
return|;
block|}
comment|/*      * set by ngx_pcalloc():      *      *     conf->upstream.bufs.num = 0;      *     conf->upstream.next_upstream = 0;      *     conf->upstream.temp_path = NULL;      *     conf->upstream.schema = { 0, NULL };      *     conf->upstream.uri = { 0, NULL };      *     conf->upstream.location = NULL;      */
name|conf
operator|->
name|upstream
operator|.
