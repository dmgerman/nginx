...
begin_typedef
DECL|struct|__anon288962c10108
typedef|typedef
struct|struct
block|{
DECL|member|name
...
name|always
decl_stmt|;
comment|/* unsigned  always:1 */
block|}
struct|;
end_struct

begin_typedef
DECL|enum|__anon288962c10203
typedef|typedef
enum|enum
block|{
DECL|enumerator|NGX_HTTP_EXPIRES_OFF
name|NGX_HTTP_EXPIRES_OFF
block|,
DECL|enumerator|NGX_HTTP_EXPIRES_EPOCH
name|NGX_HTTP_EXPIRES_EPOCH
block|,
DECL|enumerator|NGX_HTTP_EXPIRES_MAX
name|NGX_HTTP_EXPIRES_MAX
block|,
DECL|enumerator|NGX_HTTP_EXPIRES_ACCESS
name|NGX_HTTP_EXPIRES_ACCESS
block|,
DECL|enumerator|NGX_HTTP_EXPIRES_MODIFIED
name|NGX_HTTP_EXPIRES_MODIFIED
block|,
DECL|enumerator|NGX_HTTP_EXPIRES_DAILY
name|NGX_HTTP_EXPIRES_DAILY
block|,
DECL|enumerator|NGX_HTTP_EXPIRES_UNSET
name|NGX_HTTP_EXPIRES_UNSET
DECL|typedef|ngx_http_expires_t
block|}
...
begin_typedef
DECL|struct|__anon288962c10308
typedef|typedef
struct|struct
block|{
DECL|member|expires
...
specifier|static
name|ngx_int_t
name|ngx_http_add_multi_header_lines
parameter_list|(
name|ngx_http_request_t
modifier|*
name|r
...
specifier|static
name|ngx_int_t
name|ngx_http_set_response_header
parameter_list|(
name|ngx_http_request_t
modifier|*
name|r
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_trailers_filter (ngx_http_request_t * r,ngx_chain_t * in)
name|ngx_http_trailers_filter
parameter_list|(
name|ngx_http_request_t
modifier|*
name|r
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_parse_expires (ngx_str_t * value,ngx_http_expires_t * expires,time_t * expires_time,char ** err)
name|ngx_http_parse_expires
parameter_list|(
name|ngx_str_t
modifier|*
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_add_multi_header_lines (ngx_http_request_t * r,ngx_http_header_val_t * hv,ngx_str_t * value)
name|ngx_http_add_multi_header_lines
parameter_list|(
name|ngx_http_request_t
modifier|*
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_set_response_header (ngx_http_request_t * r,ngx_http_header_val_t * hv,ngx_str_t * value)
name|ngx_http_set_response_header
parameter_list|(
name|ngx_http_request_t
modifier|*
...
return|;
block|}
comment|/*      * set by ngx_pcalloc():      *      *     conf->headers = NULL;      *     conf->trailers = NULL;      *     conf->expires_time = 0;      *     conf->expires_value = NULL;      */
name|conf
operator|->
name|expires
operator|=
