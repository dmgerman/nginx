...
begin_typedef
DECL|struct|__anon2a31d3a80108
typedef|typedef
struct|struct
block|{
DECL|member|name
...
begin_typedef
DECL|struct|__anon2a31d3a80308
typedef|typedef
struct|struct
block|{
DECL|member|expires
...
return|;
block|}
comment|/*      * set by ngx_pcalloc():      *      *     conf->headers = NULL;      *     conf->expires_time = 0;      *     conf->expires_value = NULL;      */
name|conf
operator|->
name|expires
operator|=
