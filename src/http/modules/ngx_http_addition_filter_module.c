...
begin_typedef
DECL|struct|__anon2bd1408b0108
typedef|typedef
struct|struct
block|{
...
begin_typedef
DECL|struct|__anon2bd1408b0208
typedef|typedef
struct|struct
block|{
...
literal|1
decl_stmt|;
DECL|member|after_body_sent
name|unsigned
name|after_body_sent
range|:
literal|1
decl_stmt|;
...
return|;
block|}
comment|/*      * set by ngx_pcalloc():      *      *     conf->before_body.len = 0;      *     conf->before_body.date = NULL;      *     conf->after_body.len = 0;      *     conf->after_body.date = NULL;      */
return|return
name|conf
return|;
block|}
