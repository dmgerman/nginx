...
name|value
decl_stmt|;
DECL|typedef|ngx_http_rewrite_variable_t
block|}
name|ngx_http_rewrite_variable_t
typedef|;
end_typedef
...
name|text_data
decl_stmt|;
DECL|typedef|ngx_http_rewrite_value_code_t
block|}
name|ngx_http_rewrite_value_code_t
typedef|;
end_typedef
...
begin_decl_stmt
DECL|variable|ngx_http_rewrite_null_value
specifier|static
name|ngx_http_variable_value_t
name|ngx_http_rewrite_null_value
init|=
block|{
literal|0
block|,
...
literal|0
argument_list|,
literal|"http rewrite regex end"
argument_list|)
expr_stmt|;
if|if
condition|(
...
specifier|static
name|void
DECL|function|ngx_http_rewrite_value_code (ngx_http_rewrite_engine_t * e)
name|ngx_http_rewrite_value_code
parameter_list|(
name|ngx_http_rewrite_engine_t
modifier|*
name|e
...
specifier|static
name|void
DECL|function|ngx_http_rewrite_set_var_code (ngx_http_rewrite_engine_t * e)
name|ngx_http_rewrite_set_var_code
parameter_list|(
name|ngx_http_rewrite_engine_t
modifier|*
name|e
...
name|ngx_http_variable_value_t
modifier|*
DECL|function|ngx_http_rewrite_var (ngx_http_request_t * r,uintptr_t data)
...
literal|0
argument_list|,
literal|"unknown rewrite code: %p"
argument_list|,
operator|*
name|code
argument_list|)
