...
begin_typedef
DECL|struct|__anon297e6f000108
typedef|typedef
struct|struct
block|{
DECL|member|codes
...
directive|if
literal|0
block|{ ngx_string("valid_referers"),       NGX_HTTP_SRV_CONF|NGX_HTTP_LOC_CONF|NGX_CONF_1MORE,       ngx_http_rewrite_valid_referers,       NGX_HTTP_LOC_CONF_OFFSET,       0,       NULL },
endif|#
directive|endif
block|{
name|ngx_string
