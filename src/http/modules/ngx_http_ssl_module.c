...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_ssl_client_s_dn (ngx_http_request_t * r,ngx_http_variable_value_t * v,uintptr_t data)
name|ngx_http_ssl_client_s_dn
parameter_list|(
name|ngx_http_request_t
modifier|*
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_ssl_client_i_dn (ngx_http_request_t * r,ngx_http_variable_value_t * v,uintptr_t data)
name|ngx_http_ssl_client_i_dn
parameter_list|(
name|ngx_http_request_t
modifier|*
...
return|;
block|}
comment|/*      * set by ngx_pcalloc():      *      *     scf->protocols = 0;       *     scf->certificate.len = 0;      *     scf->certificate.data = NULL;      *     scf->certificate_key.len = 0;      *     scf->certificate_key.data = NULL;      *     scf->client_certificate.len = 0;      *     scf->client_certificate.data = NULL;      *     scf->ciphers.len = 0;      *     scf->ciphers.data = NULL;      */
name|scf
operator|->
name|enable
operator|=
