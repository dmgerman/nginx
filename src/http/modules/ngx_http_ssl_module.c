...
begin_define
DECL|macro|NGX_HTTP_NPN_ADVERTISE
define|#
directive|define
...
specifier|static
name|int
name|ngx_http_ssl_npn_advertised
parameter_list|(
name|ngx_ssl_conn_t
modifier|*
name|ssl_conn
...
specifier|static
name|ngx_int_t
name|ngx_http_ssl_compile_certificates
parameter_list|(
name|ngx_conf_t
modifier|*
name|cf
...
name|char
modifier|*
name|ngx_http_ssl_password_file
parameter_list|(
name|ngx_conf_t
modifier|*
name|cf
...
name|char
modifier|*
name|ngx_http_ssl_conf_command_check
parameter_list|(
name|ngx_conf_t
modifier|*
name|cf
...
begin_decl_stmt
DECL|variable|ngx_http_ssl_ocsp
specifier|static
name|ngx_conf_enum_t
name|ngx_http_ssl_ocsp
index|[]
init|=
block|{
block|{
...
begin_decl_stmt
DECL|variable|ngx_http_ssl_deprecated
specifier|static
name|ngx_conf_deprecated_t
name|ngx_http_ssl_deprecated
init|=
block|{
...
begin_decl_stmt
DECL|variable|ngx_http_ssl_conf_command_post
specifier|static
name|ngx_conf_post_t
name|ngx_http_ssl_conf_command_post
init|=
block|{
name|ngx_http_ssl_conf_command_check
block|}
...
name|ngx_string
argument_list|(
literal|"ssl_stapling_responder"
argument_list|)
block|,
name|NGX_HTTP_MAIN_CONF
operator||
...
name|ngx_string
argument_list|(
literal|"ssl_client_s_dn_legacy"
argument_list|)
block|,
name|NULL
block|,
...
name|ngx_string
argument_list|(
literal|"ssl_client_i_dn_legacy"
argument_list|)
block|,
name|NULL
block|,
...
specifier|static
name|int
DECL|function|ngx_http_ssl_alpn_select (ngx_ssl_conn_t * ssl_conn,const unsigned char ** out,unsigned char * outlen,const unsigned char * in,unsigned int inlen,void * arg)
name|ngx_http_ssl_alpn_select
parameter_list|(
name|ngx_ssl_conn_t
modifier|*
...
specifier|static
name|int
DECL|function|ngx_http_ssl_npn_advertised (ngx_ssl_conn_t * ssl_conn,const unsigned char ** out,unsigned int * outlen,void * arg)
name|ngx_http_ssl_npn_advertised
parameter_list|(
name|ngx_ssl_conn_t
modifier|*
...
return|;
block|}
comment|/*      * set by ngx_pcalloc():      *      *     sscf->protocols = 0;      *     sscf->certificate_values = NULL;      *     sscf->dhparam = { 0, NULL };      *     sscf->ecdh_curve = { 0, NULL };      *     sscf->client_certificate = { 0, NULL };      *     sscf->trusted_certificate = { 0, NULL };      *     sscf->crl = { 0, NULL };      *     sscf->ciphers = { 0, NULL };      *     sscf->shm_zone = NULL;      *     sscf->ocsp_responder = { 0, NULL };      *     sscf->stapling_file = { 0, NULL };      *     sscf->stapling_responder = { 0, NULL };      */
name|sscf
operator|->
name|enable
operator|=
...
comment|/* install callback to lookup certificates */
...
literal|0
argument_list|,
literal|"variables in "
literal|"\"ssl_certificate\" and \"ssl_certificate_key\" "
literal|"directives are not supported on this platform"
argument_list|)
expr_stmt|;
return|return
name|NGX_CONF_ERROR
...
condition|)
block|{
comment|/* configure certificates */
if|if
condition|(
...
literal|0
argument_list|,
literal|"\"ssl_ocsp\" is incompatible with "
literal|"\"ssl_verify_client optional_no_ca\""
argument_list|)
expr_stmt|;
return|return
name|NGX_CONF_ERROR
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_ssl_compile_certificates (ngx_conf_t * cf,ngx_http_ssl_srv_conf_t * conf)
name|ngx_http_ssl_compile_certificates
parameter_list|(
name|ngx_conf_t
modifier|*
...
name|char
modifier|*
DECL|function|ngx_http_ssl_password_file (ngx_conf_t * cf,ngx_command_t * cmd,void * conf)
name|ngx_http_ssl_password_file
parameter_list|(
name|ngx_conf_t
modifier|*
...
name|char
modifier|*
DECL|function|ngx_http_ssl_ocsp_cache (ngx_conf_t * cf,ngx_command_t * cmd,void * conf)
name|ngx_http_ssl_ocsp_cache
parameter_list|(
name|ngx_conf_t
modifier|*
...
literal|0
argument_list|,
literal|"OCSP cache \"%V\" is too small"
argument_list|,
operator|&
name|value
index|[
...
name|char
modifier|*
DECL|function|ngx_http_ssl_conf_command_check (ngx_conf_t * cf,void * post,void * data)
name|ngx_http_ssl_conf_command_check
parameter_list|(
name|ngx_conf_t
modifier|*
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_ssl_init (ngx_conf_t * cf)
name|ngx_http_ssl_init
parameter_list|(
name|ngx_conf_t
modifier|*
...
return|;
block|}
comment|/*              * if no certificates are defined in the default server,              * check all non-default server blocks              */
name|cscfp
operator|=
name|addr
index|[
