...
begin_define
DECL|macro|SOME_LINGERING_TIME
define|#
directive|define
name|SOME_LINGERING_TIME
value|30
end_define
...
directive|if
literal|0
block_content|static int ngx_http_keepalive_handler(ngx_event_t *ev) {     ngx_connection_t    *c;     ngx_http_log_ctx_t  *ctx;      ngx_log_debug(ev->log, "http keepalive");      if (ev->timedout)         return NGX_DONE;      if (closed)
