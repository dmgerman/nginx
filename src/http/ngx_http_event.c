...
specifier|static
name|int
name|ngx_http_process_http_request
parameter_list|(
name|ngx_http_request_t
modifier|*
name|r
...
name|srv
expr_stmt|;
comment|/* TODO: request's pool size */
name|ngx_test_null
argument_list|(
name|r
operator|->
...
name|ngx_http_log_error
expr_stmt|;
comment|/* STUB return ngx_http_error(r, NGX_HTTP_BAD_REQUEST)  */
return|return
name|ngx_http_close_request
argument_list|(
name|r
...
begin_function
DECL|function|ngx_http_process_http_request (ngx_http_request_t * r)
specifier|static
name|int
name|ngx_http_process_http_request
parameter_list|(
