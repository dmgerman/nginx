...
begin_function
DECL|function|ngx_http_process_request (ngx_event_t * rev)
specifier|static
name|int
name|ngx_http_process_request
parameter_list|(
...
directive|if
literal|0
block_content|wev = c->write;         ngx_add_timer(wev, 5000);         wev->delayed = 1;         wev->timer_set = 1;
endif|#
directive|endif
name|rc
operator|=
...
expr_stmt|;
block|}
comment|/* a handler has done its work completely */
if|if
condition|(
name|rc
operator|==
...
return|;
block|}
comment|/* NGX_AGAIN: a handler has done its work                   but the transfer is still not completed */
name|wev
operator|=
name|r
operator|->
