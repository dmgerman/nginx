...
argument_list|)
expr_stmt|;
comment|/* STUB: should be ngx_inet_ntop() */
if|#
directive|if
operator|(
name|WIN32
...
argument_list|)
expr_stmt|;
comment|/* THINK: when to create out.headers ? */
name|r
operator|->
name|headers_out
operator|.
...
directive|if
literal|0
block_content|int ngx_http_handler(ngx_http_request_t *r) {     int  rc;      r->connection->unexpected_eof = 0;     r->lingering_close = 1;
...
directive|endif
block_content|rc = ngx_http_set_default_handler(r);      if (rc>= NGX_HTTP_SPECIAL_RESPONSE)         return ngx_http_special_response(r, rc);      rc = r->handler(r);      return rc; }
endif|#
directive|endif
if|#
directive|if
literal|0
block_content|static int ngx_http_set_default_handler(ngx_http_request_t *r) {     ngx_err_t  err;     char      *name, *loc, *file;
if|#
directive|if
literal|0
comment|/* STUB */
