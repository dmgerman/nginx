...
name|ngx_string
argument_list|(
literal|"%addr - - [%time] \"%request\" %status %length "
...
directive|if
literal|0
block_content|ngx_tm_t  tm;      ngx_localtime(&tm);      return buf + ngx_snprintf(buf, sizeof("28/Sep/1970:12:00:00"),                               "%02d/%s/%d:%02d:%02d:%02d",                               tm.ngx_tm_mday, months[tm.ngx_tm_mon - 1],                               tm.ngx_tm_year,                               tm.ngx_tm_hour, tm.ngx_tm_min, tm.ngx_tm_sec);
endif|#
directive|endif
block|}
end_function
