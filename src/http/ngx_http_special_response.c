...
directive|if
literal|0
block_content|if (rc == NGX_AGAIN) {             ngx_http_set_write_handler(r);             return NGX_AGAIN;         }
endif|#
directive|endif
return|return
name|NGX_OK
...
directive|if
literal|0
block_content|if (r->main == NULL) {         if (rc == NGX_AGAIN) {             ngx_http_set_write_handler(r);             return NGX_AGAIN;         }     }
endif|#
directive|endif
return|return
name|NGX_OK
