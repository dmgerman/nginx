...
begin_typedef
DECL|struct|__anon2b52a6290108
typedef|typedef
struct|struct
block|{
DECL|member|bufs
...
begin_typedef
DECL|struct|__anon2b52a6290208
typedef|typedef
struct|struct
block|{
...
specifier|static
name|int
name|ngx_http_output_filter_need_to_copy
parameter_list|(
...
condition|)
block|{
comment|/* move the chain link to the chain ctx->out */
name|cl
operator|=
name|ctx
operator|->
...
begin_function
DECL|function|ngx_http_output_filter_need_to_copy (ngx_http_request_t * r,ngx_hunk_t * hunk)
name|ngx_inline
specifier|static
name|int
name|ngx_http_output_filter_need_to_copy
