...
name|void
modifier|*
name|ngx_http_output_filter_set_hunk_size
parameter_list|(
name|ngx_pool_t
modifier|*
name|pool
...
begin_function
DECL|function|ngx_http_output_filter_stub_init (ngx_pool_t * pool,void * loc_conf)
name|int
name|ngx_http_output_filter_stub_init
parameter_list|(
name|ngx_pool_t
modifier|*
name|pool
...
begin_function
DECL|function|ngx_http_output_filter_set_hunk_size (ngx_pool_t * pool,void * conf,char * size)
specifier|static
name|void
modifier|*
name|ngx_http_output_filter_set_hunk_size
