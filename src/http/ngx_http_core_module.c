...
begin_typedef
DECL|struct|__anon27eafa2b0108
typedef|typedef
struct|struct
block|{
DECL|member|name
...
begin_function
name|ngx_int_t
DECL|function|ngx_http_get_forwarded_addr (ngx_http_request_t * r,ngx_addr_t * addr,u_char * xff,size_t xfflen,ngx_array_t * proxies,int recursive)
