...
begin_typedef
DECL|struct|__anon276148370108
typedef|typedef
struct|struct
block|{
DECL|member|name
...
begin_comment
comment|/*  * gzip is enabled for the following quantities:  *     "gzip; q=0.001" ... "gzip; q=0.999", "gzip; q=1"  * gzip is disabled for the following quantities:  *     "gzip; q=0" ... "gzip; q=0.000", and for any invalid cases  */
end_comment
