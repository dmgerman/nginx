...
begin_typedef
DECL|struct|__anon2b72657a0108
typedef|typedef
struct|struct
block|{
DECL|member|name
...
condition|)
block|{
comment|/*          * test for the most common case "gzip,...":          *   MSIE:    "gzip, deflate"          *   Firefox: "gzip,deflate"          *   Chrome:  "gzip,deflate,sdch"          *   Safari:  "gzip, deflate"          *   Opera:   "gzip, deflate"          */
goto|goto
name|found
goto|;
block|}
