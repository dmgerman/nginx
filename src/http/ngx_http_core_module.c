...
begin_typedef
DECL|struct|__anon2aa099410108
typedef|typedef
struct|struct
block|{
DECL|member|name
...
begin_function
name|ngx_int_t
DECL|function|ngx_http_get_forwarded_addr (ngx_http_request_t * r,ngx_addr_t * addr,ngx_table_elt_t * headers,ngx_str_t * value,ngx_array_t * proxies,int recursive)
...
expr_stmt|;
block|}
comment|/* iterate over all headers in reverse order */
name|rc
operator|=
name|NGX_DECLINED
expr_stmt|;
...
begin_function
name|ngx_int_t
DECL|function|ngx_http_link_multi_headers (ngx_http_request_t * r)
name|ngx_http_link_multi_headers
parameter_list|(
name|ngx_http_request_t
modifier|*
name|r
...
name|NULL
expr_stmt|;
comment|/*          * search for previous headers with the same name;          * if there are any, link to them          */
name|ppart
operator|=
operator|&
name|r
