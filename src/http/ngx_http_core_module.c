...
argument_list|)
expr_stmt|;
comment|/* set by ngx_pcalloc():      lcf->doc_root.len = 0;     lcf->doc_root.data = NULL;     lcf->types = NULL;     lcf->default_type.len = 0;     lcf->default_type.data = NULL;     lcf->err_log = NULL;     lcf->error_pages = NULL;      lcf->regex = NULL;     lcf->exact_match = 0;     lcf->auto_redirect = 0;      */
name|lcf
operator|->
name|client_body_timeout
operator|=
...
directive|if
literal|0
block_content|ngx_str_t  *value;      value = cf->args->elts;
endif|#
directive|endif
name|ngx_test_null
argument_list|(
