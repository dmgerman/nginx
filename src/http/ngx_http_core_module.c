...
argument_list|)
expr_stmt|;
comment|/* set by ngx_pcalloc():      lcf->doc_root.len = 0;     lcf->doc_root.data = NULL;     lcf->types = NULL;     lcf->default_type.len = 0;     lcf->default_type.data = NULL;     lcf->err_log = NULL;     lcf->error_pages = NULL;      */
name|lcf
operator|->
name|client_body_timeout
operator|=
