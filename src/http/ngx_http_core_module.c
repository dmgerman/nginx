...
begin_typedef
DECL|struct|__anon2abd20d20108
typedef|typedef
struct|struct
block|{
DECL|member|name
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_core_find_location (ngx_http_request_t * r,ngx_array_t * locations,ngx_uint_t regex_start,size_t len)
name|ngx_http_core_find_location
parameter_list|(
name|ngx_http_request_t
modifier|*
