...
begin_typedef
DECL|struct|__anon2b4b87e30108
typedef|typedef
struct|struct
block|{
DECL|member|name
...
specifier|static
name|void
name|ngx_http_core_auth_delay_handler
parameter_list|(
name|ngx_http_request_t
modifier|*
name|r
...
specifier|static
name|ngx_int_t
name|ngx_http_gzip_accept_encoding
parameter_list|(
name|ngx_str_t
modifier|*
name|ae
...
specifier|static
name|ngx_int_t
name|ngx_http_get_forwarded_addr_internal
parameter_list|(
name|ngx_http_request_t
modifier|*
name|r
...
name|char
modifier|*
name|ngx_http_disable_symlinks
parameter_list|(
name|ngx_conf_t
modifier|*
name|cf
...
begin_decl_stmt
DECL|variable|ngx_http_core_lingering_close
specifier|static
name|ngx_conf_enum_t
name|ngx_http_core_lingering_close
index|[]
init|=
block|{
block|{
...
begin_decl_stmt
DECL|variable|ngx_http_core_server_tokens
specifier|static
name|ngx_conf_enum_t
name|ngx_http_core_server_tokens
index|[]
init|=
block|{
block|{
...
begin_decl_stmt
DECL|variable|ngx_http_client_temp_path
specifier|static
...
name|ngx_string
argument_list|(
literal|"client_body_in_single_buffer"
argument_list|)
block|,
name|NGX_HTTP_MAIN_CONF
operator||
...
name|ngx_string
argument_list|(
literal|"subrequest_output_buffer_size"
argument_list|)
block|,
name|NGX_HTTP_MAIN_CONF
operator||
...
name|NGX_CONF_TAKE1
block|,
name|ngx_http_set_complex_value_size_slot
block|,
name|NGX_HTTP_LOC_CONF_OFFSET
block|,
name|offsetof
...
name|ngx_string
argument_list|(
literal|"chunked_transfer_encoding"
argument_list|)
block|,
name|NGX_HTTP_MAIN_CONF
operator||
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_core_auth_delay (ngx_http_request_t * r)
name|ngx_http_core_auth_delay
parameter_list|(
name|ngx_http_request_t
modifier|*
...
literal|0
argument_list|,
literal|"delaying unauthorized request"
argument_list|)
expr_stmt|;
if|if
condition|(
...
argument_list|)
expr_stmt|;
comment|/*      * trigger an additional event loop iteration      * to ensure constant-time processing      */
name|ngx_post_event
argument_list|(
name|r
operator|->
...
specifier|static
name|void
DECL|function|ngx_http_core_auth_delay_handler (ngx_http_request_t * r)
name|ngx_http_core_auth_delay_handler
parameter_list|(
name|ngx_http_request_t
modifier|*
...
condition|)
block|{
comment|/*              * Safari may send a POST request to a closed keepalive              * connection and may stall for some time, see              *     https://bugs.webkit.org/show_bug.cgi?id=5760              */
name|r
operator|->
name|keepalive
operator|=
...
begin_function
name|ngx_int_t
DECL|function|ngx_http_set_etag (ngx_http_request_t * r)
...
begin_function
name|void
DECL|function|ngx_http_weak_etag (ngx_http_request_t * r)
...
begin_function
name|ngx_int_t
DECL|function|ngx_http_send_response (ngx_http_request_t * r,ngx_uint_t status,ngx_str_t * ct,ngx_http_complex_value_t * cv)
...
return|;
block|}
comment|/*      * test first for the most common case "gzip,...":      *   MSIE:    "gzip, deflate"      *   Firefox: "gzip,deflate"      *   Chrome:  "gzip,deflate,sdch"      *   Safari:  "gzip, deflate"      *   Opera:   "gzip, deflate"      */
if|if
condition|(
name|ngx_memcmp
argument_list|(
...
begin_comment
comment|/*  * gzip is enabled for the following quantities:  *     "gzip; q=0.001" ... "gzip; q=1.000"  * gzip is disabled for the following quantities:  *     "gzip; q=0" ... "gzip; q=0.000", and for any invalid cases  */
end_comment

begin_function
specifier|static
name|ngx_int_t
DECL|function|ngx_http_gzip_accept_encoding (ngx_str_t * ae)
name|ngx_http_gzip_accept_encoding
parameter_list|(
name|ngx_str_t
modifier|*
...
literal|0
argument_list|,
literal|"nested in-memory subrequest \"%V\""
argument_list|,
name|uri
argument_list|)
expr_stmt|;
...
begin_function
name|ngx_int_t
DECL|function|ngx_http_set_disable_symlinks (ngx_http_request_t * r,ngx_http_core_loc_conf_t * clcf,ngx_str_t * path,ngx_open_file_info_t * of)
...
begin_function
name|ngx_int_t
DECL|function|ngx_http_get_forwarded_addr (ngx_http_request_t * r,ngx_addr_t * addr,ngx_array_t * headers,ngx_str_t * value,ngx_array_t * proxies,int recursive)
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_get_forwarded_addr_internal (ngx_http_request_t * r,ngx_addr_t * addr,u_char * xff,size_t xfflen,ngx_array_t * proxies,int recursive)
name|ngx_http_get_forwarded_addr_internal
parameter_list|(
name|ngx_http_request_t
modifier|*
...
return|;
block|}
comment|/*      * set by ngx_pcalloc():      *      *     clcf->root = { 0, NULL };      *     clcf->limit_except = 0;      *     clcf->post_action = { 0, NULL };      *     clcf->types = NULL;      *     clcf->default_type = { 0, NULL };      *     clcf->error_log = NULL;      *     clcf->error_pages = NULL;      *     clcf->client_body_path = NULL;      *     clcf->regex = NULL;      *     clcf->exact_match = 0;      *     clcf->auto_redirect = 0;      *     clcf->alias = 0;      *     clcf->limit_rate = NULL;      *     clcf->limit_rate_after = NULL;      *     clcf->gzip_proxied = 0;      *     clcf->keepalive_disable = 0;      */
name|clcf
operator|->
name|client_max_body_size
operator|=
...
literal|0
argument_list|,
literal|"empty regex in server name \"%V\""
argument_list|,
operator|&
name|value
index|[
...
name|char
modifier|*
DECL|function|ngx_http_core_set_aio (ngx_conf_t * cf,ngx_command_t * cmd,void * conf)
name|ngx_http_core_set_aio
parameter_list|(
name|ngx_conf_t
modifier|*
...
argument_list|,
literal|"\"aio on\" "
literal|"is unsupported on this platform"
argument_list|)
expr_stmt|;
return|return
name|NGX_CONF_ERROR
...
literal|0
argument_list|,
literal|"the \"sendfile\" parameter of "
literal|"the \"aio\" directive is deprecated"
argument_list|)
expr_stmt|;
return|return
name|NGX_CONF_OK
...
literal|"builtin \"msie6\" and \"degradation\" mask only"
argument_list|)
expr_stmt|;
return|return
name|NGX_CONF_ERROR
...
name|char
modifier|*
DECL|function|ngx_http_disable_symlinks (ngx_conf_t * cf,ngx_command_t * cmd,void * conf)
name|ngx_http_disable_symlinks
parameter_list|(
name|ngx_conf_t
modifier|*
...
literal|0
argument_list|,
literal|"\"%V\" must have \"off\", \"on\" "
literal|"or \"if_not_owner\" parameter"
argument_list|,
operator|&
name|cmd
operator|->
...
literal|0
argument_list|,
literal|"duplicate parameters \"%V %V\""
argument_list|,
operator|&
name|value
index|[
...
literal|0
argument_list|,
literal|"\"from=\" cannot be used with \"off\" parameter"
argument_list|)
expr_stmt|;
return|return
name|NGX_CONF_ERROR
