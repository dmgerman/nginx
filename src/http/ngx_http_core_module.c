...
specifier|static
name|ngx_int_t
name|ngx_http_core_init_process
parameter_list|(
name|ngx_cycle_t
modifier|*
name|cycle
...
begin_function
DECL|function|ngx_http_core_init_process (ngx_cycle_t * cycle)
specifier|static
name|ngx_int_t
name|ngx_http_core_init_process
parameter_list|(
...
directive|if
literal|0
block_content|ngx_http_core_init_module:      ngx_http_handler_pt         *h;      ngx_test_null(h, ngx_push_array(&cmcf->phases[NGX_HTTP_TRANSLATE_PHASE].handlers),                   NGX_ERROR);     *h = ngx_http_delay_handler;
endif|#
directive|endif
name|cscfp
operator|=
