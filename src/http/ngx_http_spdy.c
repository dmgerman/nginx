...
begin_typedef
DECL|struct|__anon29aec3f90108
typedef|typedef
struct|struct
block|{
DECL|member|hash
...
name|u_char
modifier|*
name|ngx_http_spdy_state_detect_settings
parameter_list|(
name|ngx_http_spdy_connection_t
modifier|*
name|sc
...
name|u_char
modifier|*
DECL|function|ngx_http_spdy_state_detect_settings (ngx_http_spdy_connection_t * sc,u_char * pos,u_char * end)
name|ngx_http_spdy_state_detect_settings
parameter_list|(
name|ngx_http_spdy_connection_t
modifier|*
...
return|;
block|}
comment|/*      * Since this is the first frame in a buffer,      * then it is properly aligned      */
if|if
condition|(
operator|*
operator|(
...
literal|0
argument_list|,
literal|"spdy SETTINGS frame received, size: %uz"
argument_list|,
name|sc
operator|->
name|length
...
DECL|struct|__anon29aec3f90308
specifier|static
specifier|const
struct|struct
block|{
