...
begin_typedef
DECL|struct|__anon28b959440108
typedef|typedef
struct|struct
block|{
DECL|member|hash
...
name|u_char
modifier|*
name|ngx_http_spdy_state_inflate_error
parameter_list|(
name|ngx_http_spdy_connection_t
modifier|*
name|sc
...
name|u_char
modifier|*
DECL|function|ngx_http_spdy_proxy_protocol (ngx_http_spdy_connection_t * sc,u_char * pos,u_char * end)
name|ngx_http_spdy_proxy_protocol
parameter_list|(
name|ngx_http_spdy_connection_t
modifier|*
...
literal|"with invalid Stream-ID %ui"
argument_list|,
name|sid
argument_list|)
expr_stmt|;
...
literal|0
argument_list|,
literal|"client sent SYN_STREAM frame with header "
literal|"block encoded using wrong dictionary: %ul"
argument_list|,
operator|(
name|u_long
operator|)
...
literal|0
argument_list|,
literal|"inflateSetDictionary() failed: %d"
argument_list|,
name|z
argument_list|)
expr_stmt|;
...
literal|0
argument_list|,
literal|"incorrect number of spdy header block entries"
argument_list|)
expr_stmt|;
return|return
name|ngx_http_spdy_state_headers_error
...
literal|0
argument_list|,
literal|"client sent SYN_STREAM frame for stream %ui "
literal|"with invalid header block"
argument_list|,
name|stream
operator|->
name|id
...
literal|0
argument_list|,
literal|"spdy WINDOW_UPDATE sid:%ui delta:%uz"
argument_list|,
name|sid
argument_list|,
name|delta
...
name|u_char
modifier|*
DECL|function|ngx_http_spdy_state_inflate_error (ngx_http_spdy_connection_t * sc,int rc)
name|ngx_http_spdy_state_inflate_error
parameter_list|(
name|ngx_http_spdy_connection_t
modifier|*
...
literal|0
argument_list|,
literal|"client sent SYN_STREAM frame with "
literal|"corrupted header block, inflate() failed: %d"
argument_list|,
name|rc
argument_list|)
expr_stmt|;
...
name|pos
expr_stmt|;
comment|/*      * One more byte is needed for null-termination      * and another one for further progress.      */
if|if
condition|(
name|rest
operator|>
...
DECL|struct|__anon28b959440308
specifier|static
specifier|const
struct|struct
block|{
