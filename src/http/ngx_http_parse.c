...
name|sw_port
block|,
DECL|enumerator|sw_host_http_09
name|sw_host_http_09
block|,
...
name|sw_check_uri
block|,
DECL|enumerator|sw_check_uri_http_09
name|sw_check_uri_http_09
block|,
...
block|}
break|break;
comment|/* space+ after "http://host[:port] " */
case|case
name|sw_host_http_09
case|:
switch|switch
...
begin_function
name|ngx_int_t
DECL|function|ngx_http_parse_set_cookie_lines (ngx_array_t * headers,ngx_str_t * name,ngx_str_t * value)
