...
block|,
DECL|enumerator|sw_host_start
name|sw_host_start
block|,
DECL|enumerator|sw_host
name|sw_host
block|,
DECL|enumerator|sw_host_end
name|sw_host_end
block|,
DECL|enumerator|sw_host_ip_literal
name|sw_host_ip_literal
block|,
...
begin_function
name|ngx_int_t
DECL|function|ngx_http_parse_uri (ngx_http_request_t * r)
...
begin_function
name|ngx_int_t
DECL|function|ngx_http_parse_status_line (ngx_http_request_t * r,ngx_buf_t * b,ngx_http_status_t * status)
...
modifier|*
DECL|function|ngx_http_parse_multi_header_lines (ngx_http_request_t * r,ngx_table_elt_t * headers,ngx_str_t * name,ngx_str_t * value)
...
name|ngx_table_elt_t
modifier|*
DECL|function|ngx_http_parse_set_cookie_lines (ngx_http_request_t * r,ngx_table_elt_t * headers,ngx_str_t * name,ngx_str_t * value)
...
begin_function
name|ngx_int_t
DECL|function|ngx_http_parse_chunked (ngx_http_request_t * r,ngx_buf_t * b,ngx_http_chunked_t * ctx)
...
literal|0
argument_list|,
literal|"http chunked byte: %02Xd s:%d"
argument_list|,
name|ch
argument_list|,
name|state
