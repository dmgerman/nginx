...
specifier|static
name|void
name|ngx_http_file_cache_lock_wait_handler
parameter_list|(
name|ngx_event_t
modifier|*
name|ev
...
specifier|static
name|void
name|ngx_http_file_cache_lock_wait
parameter_list|(
name|ngx_http_request_t
modifier|*
name|r
...
specifier|static
name|ngx_int_t
name|ngx_http_cache_thread_handler
parameter_list|(
...
specifier|static
name|void
name|ngx_http_cache_thread_event_handler
parameter_list|(
name|ngx_event_t
modifier|*
name|ev
...
specifier|static
name|void
name|ngx_http_file_cache_vary_header
parameter_list|(
name|ngx_http_request_t
modifier|*
name|r
...
specifier|static
name|ngx_int_t
name|ngx_http_file_cache_reopen
parameter_list|(
name|ngx_http_request_t
modifier|*
name|r
...
specifier|static
name|ngx_int_t
name|ngx_http_file_cache_update_variant
parameter_list|(
name|ngx_http_request_t
modifier|*
name|r
...
specifier|static
name|ngx_int_t
name|ngx_http_file_cache_manage_directory
parameter_list|(
name|ngx_tree_ctx_t
modifier|*
name|ctx
...
specifier|static
name|void
name|ngx_http_file_cache_set_watermark
parameter_list|(
name|ngx_http_file_cache_t
modifier|*
name|cache
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_file_cache_lock (ngx_http_request_t * r,ngx_http_cache_t * c)
name|ngx_http_file_cache_lock
parameter_list|(
name|ngx_http_request_t
modifier|*
...
literal|0
argument_list|,
literal|"http file cache lock u:%d wt:%M"
argument_list|,
name|c
operator|->
name|updating
...
specifier|static
name|void
DECL|function|ngx_http_file_cache_lock_wait_handler (ngx_event_t * ev)
name|ngx_http_file_cache_lock_wait_handler
parameter_list|(
name|ngx_event_t
modifier|*
...
literal|0
argument_list|,
literal|"http file cache wait: \"%V?%V\""
argument_list|,
operator|&
name|r
operator|->
...
specifier|static
name|void
DECL|function|ngx_http_file_cache_lock_wait (ngx_http_request_t * r,ngx_http_cache_t * c)
name|ngx_http_file_cache_lock_wait
parameter_list|(
name|ngx_http_request_t
modifier|*
...
literal|0
argument_list|,
literal|"cache file \"%s\" version mismatch"
argument_list|,
name|c
operator|->
name|file
...
literal|0
argument_list|,
literal|"cache file \"%s\" has too long header"
argument_list|,
name|c
operator|->
name|file
...
literal|0
argument_list|,
literal|"cache file \"%s\" has incorrect vary length"
argument_list|,
name|c
operator|->
name|file
...
literal|0
argument_list|,
literal|"http file cache vary mismatch"
argument_list|)
expr_stmt|;
return|return
name|ngx_http_file_cache_reopen
...
literal|0
argument_list|,
literal|"http file cache aio: \"%V?%V\""
argument_list|,
operator|&
name|r
operator|->
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_cache_thread_handler (ngx_thread_task_t * task,ngx_file_t * file)
name|ngx_http_cache_thread_handler
parameter_list|(
name|ngx_thread_task_t
modifier|*
...
specifier|static
name|void
DECL|function|ngx_http_cache_thread_event_handler (ngx_event_t * ev)
name|ngx_http_cache_thread_event_handler
parameter_list|(
name|ngx_event_t
modifier|*
...
literal|0
argument_list|,
literal|"http file cache thread: \"%V?%V\""
argument_list|,
operator|&
name|r
operator|->
...
specifier|static
name|void
DECL|function|ngx_http_file_cache_vary (ngx_http_request_t * r,u_char * vary,size_t len,u_char * hash)
name|ngx_http_file_cache_vary
parameter_list|(
name|ngx_http_request_t
modifier|*
...
literal|0
argument_list|,
literal|"http file cache vary: \"%*s\""
argument_list|,
name|len
argument_list|,
name|vary
...
literal|0
argument_list|,
literal|"http file cache vary: %V"
argument_list|,
operator|&
name|name
argument_list|)
...
specifier|static
name|void
DECL|function|ngx_http_file_cache_vary_header (ngx_http_request_t * r,ngx_md5_t * md5,ngx_str_t * name)
name|ngx_http_file_cache_vary_header
parameter_list|(
name|ngx_http_request_t
modifier|*
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_file_cache_reopen (ngx_http_request_t * r,ngx_http_cache_t * c)
name|ngx_http_file_cache_reopen
parameter_list|(
name|ngx_http_request_t
modifier|*
...
literal|0
argument_list|,
literal|"http file cache reopen"
argument_list|)
expr_stmt|;
if|if
condition|(
...
literal|0
argument_list|,
literal|"cache file \"%s\" has incorrect vary hash"
argument_list|,
name|c
operator|->
name|file
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_file_cache_update_variant (ngx_http_request_t * r,ngx_http_cache_t * c)
name|ngx_http_file_cache_update_variant
parameter_list|(
name|ngx_http_request_t
modifier|*
...
return|;
block|}
comment|/*      * if the variant hash doesn't match one we used as a secondary      * cache key, switch back to the original key      */
name|cache
operator|=
name|c
operator|->
...
literal|0
argument_list|,
literal|"http file cache main key"
argument_list|)
expr_stmt|;
name|ngx_shmtx_lock
argument_list|(
...
begin_function
name|void
DECL|function|ngx_http_file_cache_update_header (ngx_http_request_t * r)
...
literal|0
argument_list|,
literal|"http file cache update header"
argument_list|)
expr_stmt|;
name|c
operator|=
...
name|ngx_errno
expr_stmt|;
comment|/* cache file may have been deleted */
if|if
condition|(
name|err
operator|==
...
literal|0
argument_list|,
literal|"http file cache \"%s\" not found"
argument_list|,
name|file
operator|.
name|name
...
return|return;
block|}
comment|/*      * make sure cache file wasn't replaced;      * if it was, do nothing      */
if|if
condition|(
name|ngx_fd_info
argument_list|(
...
literal|0
argument_list|,
literal|"http file cache \"%s\" changed"
argument_list|,
name|file
operator|.
name|name
...
literal|0
argument_list|,
literal|"http file cache \"%s\" content changed"
argument_list|,
name|file
operator|.
name|name
...
goto|;
block|}
comment|/*      * update cache file header with new data,      * notably h.valid_sec and h.date      */
name|ngx_memzero
argument_list|(
operator|&
name|h
...
begin_function
name|void
DECL|function|ngx_http_file_cache_free (ngx_http_cache_t * c,ngx_temp_file_t * tf)
...
literal|0
argument_list|,
literal|"stalled cache updating, error:%ui"
argument_list|,
name|c
operator|->
name|error
...
argument_list|)
expr_stmt|;
comment|/*          * abnormally exited workers may leave locked cache entries,          * and although it may be safe to remove them completely,          * we prefer to just move them to the top of the inactive queue          */
name|ngx_queue_remove
argument_list|(
name|q
argument_list|)
...
literal|0
argument_list|,
literal|"http file cache size: %O c:%ui w:%i"
argument_list|,
name|size
argument_list|,
name|count
...
literal|0
argument_list|,
literal|"http file cache free: %O"
argument_list|,
name|free
argument_list|)
expr_stmt|;
...
literal|0
argument_list|,
literal|"http file cache manager: %ui e:%M n:%M"
argument_list|,
name|cache
operator|->
name|files
...
literal|0
argument_list|,
literal|"http file cache loader time elapsed: %M"
argument_list|,
name|elapsed
argument_list|)
expr_stmt|;
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_file_cache_manage_directory (ngx_tree_ctx_t * ctx,ngx_str_t * path)
name|ngx_http_file_cache_manage_directory
parameter_list|(
name|ngx_tree_ctx_t
modifier|*
...
return|;
block|}
comment|/*      * Temporary files in cache have a suffix consisting of a dot      * followed by 10 digits.      */
if|if
condition|(
name|name
operator|->
...
specifier|static
name|void
DECL|function|ngx_http_file_cache_set_watermark (ngx_http_file_cache_t * cache)
name|ngx_http_file_cache_set_watermark
parameter_list|(
name|ngx_http_file_cache_t
modifier|*
...
literal|0
argument_list|,
literal|"http file cache watermark: %ui"
argument_list|,
name|cache
operator|->
name|sh
...
literal|0
argument_list|,
literal|"invalid use_temp_path value \"%V\", "
...
literal|0
argument_list|,
literal|"keys zone \"%V\" is too small"
argument_list|,
operator|&
name|value
index|[
...
literal|0
argument_list|,
literal|"invalid min_free value \"%V\""
argument_list|,
operator|&
name|value
index|[
...
literal|0
argument_list|,
literal|"min_free is not supported "
...
literal|0
argument_list|,
literal|"invalid loader_files value \"%V\""
argument_list|,
operator|&
name|value
index|[
...
literal|0
argument_list|,
literal|"invalid loader_sleep value \"%V\""
argument_list|,
operator|&
name|value
index|[
...
literal|0
argument_list|,
literal|"invalid loader_threshold value \"%V\""
argument_list|,
operator|&
name|value
index|[
...
literal|0
argument_list|,
literal|"invalid manager_files value \"%V\""
argument_list|,
operator|&
name|value
index|[
...
literal|0
argument_list|,
literal|"invalid manager_sleep value \"%V\""
argument_list|,
operator|&
name|value
index|[
...
literal|0
argument_list|,
literal|"invalid manager_threshold value \"%V\""
argument_list|,
operator|&
name|value
index|[
