...
specifier|static
name|ngx_int_t
name|ngx_http_file_cache_clean_noop
parameter_list|(
name|ngx_tree_ctx_t
modifier|*
name|ctx
...
specifier|static
name|ngx_int_t
name|ngx_http_file_cache_clean_file
parameter_list|(
name|ngx_tree_ctx_t
modifier|*
name|ctx
...
literal|0
argument_list|,
literal|"http file cache expired: %T %T"
argument_list|,
name|c
operator|->
name|valid_sec
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_file_cache_exists (ngx_http_request_t * r,ngx_http_file_cache_t * cache)
name|ngx_http_file_cache_exists
parameter_list|(
name|ngx_http_request_t
modifier|*
...
specifier|static
name|time_t
DECL|function|ngx_http_file_cache_expire (ngx_http_file_cache_t * cache,ngx_uint_t forced)
name|ngx_http_file_cache_expire
parameter_list|(
name|ngx_http_file_cache_t
modifier|*
...
begin_function
name|time_t
DECL|function|ngx_http_file_cache_cleaner (void * data)
name|ngx_http_file_cache_cleaner
parameter_list|(
name|void
modifier|*
name|data
...
literal|0
argument_list|,
literal|"clean unused cache files"
argument_list|)
expr_stmt|;
name|tree
operator|.
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_file_cache_clean_noop (ngx_tree_ctx_t * ctx,ngx_str_t * path)
name|ngx_http_file_cache_clean_noop
parameter_list|(
name|ngx_tree_ctx_t
modifier|*
...
specifier|static
name|ngx_int_t
DECL|function|ngx_http_file_cache_clean_file (ngx_tree_ctx_t * ctx,ngx_str_t * path)
name|ngx_http_file_cache_clean_file
parameter_list|(
name|ngx_tree_ctx_t
modifier|*
...
literal|0
argument_list|,
literal|"http file cache clean: \"%s\""
argument_list|,
name|path
operator|->
name|data
