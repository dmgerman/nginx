...
begin_decl_stmt
DECL|variable|ngx_http_v2_recv_timeout_deprecated
specifier|static
name|ngx_conf_deprecated_t
name|ngx_http_v2_recv_timeout_deprecated
init|=
block|{
...
begin_decl_stmt
DECL|variable|ngx_http_v2_idle_timeout_deprecated
specifier|static
name|ngx_conf_deprecated_t
name|ngx_http_v2_idle_timeout_deprecated
init|=
block|{
name|ngx_conf_deprecated
block|,
...
begin_decl_stmt
DECL|variable|ngx_http_v2_max_requests_deprecated
specifier|static
name|ngx_conf_deprecated_t
name|ngx_http_v2_max_requests_deprecated
init|=
block|{
name|ngx_conf_deprecated
block|,
...
begin_decl_stmt
DECL|variable|ngx_http_v2_max_field_size_deprecated
specifier|static
name|ngx_conf_deprecated_t
name|ngx_http_v2_max_field_size_deprecated
init|=
block|{
name|ngx_conf_deprecated
block|,
...
begin_decl_stmt
DECL|variable|ngx_http_v2_max_header_size_deprecated
specifier|static
name|ngx_conf_deprecated_t
name|ngx_http_v2_max_header_size_deprecated
init|=
block|{
name|ngx_conf_deprecated
block|,
...
name|char
modifier|*
DECL|function|ngx_http_v2_obsolete (ngx_conf_t * cf,ngx_command_t * cmd,void * conf)
name|ngx_http_v2_obsolete
parameter_list|(
name|ngx_conf_t
modifier|*
...
literal|0
argument_list|,
literal|"the \"%s\" directive is obsolete, "
