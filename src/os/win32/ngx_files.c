...
begin_function
name|ngx_int_t
DECL|function|ngx_close_dir (ngx_dir_t * dir)
name|ngx_close_dir
parameter_list|(
name|ngx_dir_t
modifier|*
...
begin_function
name|off_t
DECL|function|ngx_fs_available (u_char * name)
...
specifier|static
name|ngx_int_t
DECL|function|ngx_win32_check_filename (u_char * name,u_short * u,size_t len)
name|ngx_win32_check_filename
parameter_list|(
name|u_char
modifier|*
...
literal|0
block|,
DECL|enumerator|sw_normal
name|sw_normal
block|,
DECL|enumerator|sw_after_slash
name|sw_after_slash
block|,
DECL|enumerator|sw_after_colon
name|sw_after_colon
block|,
DECL|enumerator|sw_after_dot
name|sw_after_dot
block|}
name|state
enum|;
comment|/* check for NTFS streams (":"), trailing dots and spaces */
name|lu
operator|=
name|NULL
expr_stmt|;
...
name|sw_start
case|:
comment|/*              * skip till first "/" to allow paths starting with drive and              * relative path, like "c:html/"              */
if|if
condition|(
name|ch
operator|==
...
goto|;
block|}
comment|/* check if long name match */
name|lu
operator|=
name|malloc
argument_list|(
