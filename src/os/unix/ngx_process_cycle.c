...
directive|if
literal|0
block_content|if (ngx_cond_wait(thr->cv, ngx_posted_events_mutex) == NGX_ERROR) {             return (ngx_thread_value_t) 1;         }
endif|#
directive|endif
if|if
condition|(
...
directive|if
literal|0
block_content|if (ngx_event_thread_process_posted(cycle) == NGX_ERROR) {             return (ngx_thread_value_t) 1;         }          if (ngx_event_thread_process_posted(cycle) == NGX_ERROR) {             return (ngx_thread_value_t) 1;         }
endif|#
directive|endif
if|if
condition|(
