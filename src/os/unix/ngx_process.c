...
specifier|static
name|void
DECL|function|ngx_signal_handler (int signo,siginfo_t * siginfo,void * ucontext)
name|ngx_signal_handler
parameter_list|(
name|int
name|signo
...
literal|0
argument_list|,
literal|"signal %d (%s) received from %P%s"
argument_list|,
name|signo
argument_list|,
name|sig
...
specifier|static
name|void
DECL|function|ngx_unlock_mutexes (ngx_pid_t pid)
name|ngx_unlock_mutexes
parameter_list|(
name|ngx_pid_t
name|pid
...
expr_stmt|;
block|}
comment|/*      * unlock shared memory mutexes if held by the abnormally exited      * process      */
name|part
operator|=
operator|(
name|ngx_list_part_t
...
literal|0
argument_list|,
literal|"shared memory zone \"%V\" was locked by %P"
argument_list|,
operator|&
name|shm_zone
index|[
