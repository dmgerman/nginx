...
begin_function
name|ngx_int_t
DECL|function|ngx_lock_file (ngx_file_t * file)
name|ngx_lock_file
parameter_list|(
name|ngx_file_t
modifier|*
...
name|err
argument_list|,
literal|"fcntl(%s, F_SETLK, F_WRLCK) failed"
argument_list|,
name|file
operator|->
name|name
...
begin_function
name|ngx_int_t
DECL|function|ngx_unlock_file (ngx_file_t * file)
name|ngx_unlock_file
parameter_list|(
name|ngx_file_t
modifier|*
name|file
...
name|err
argument_list|,
literal|"fcntl(%s, F_SETLK, F_UNLCK) failed"
argument_list|,
name|file
operator|->
name|name
