...
directive|if
operator|(
name|NGX_HAVE_STRERRORDESC_NP
operator|)
end_if

begin_comment
comment|/*  * The strerrordesc_np() function, introduced in glibc 2.32, is  * async-signal-safe.  This makes it possible to use it directly,  * without copying error messages.  */
end_comment
