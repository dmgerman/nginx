...
begin_define
DECL|macro|NGX_FILE_DIRECTORY
define|#
directive|define
name|NGX_FILE_DIRECTORY
value|O_DIRECTORY
end_define
...
parameter_list|)
define|\
value|(((sb)->st_blocks * 512> (sb)->st_size                                  \&& (sb)->st_blocks * 512< (sb)->st_size + 8 * (sb)->st_blksize)        \      ? (sb)->st_blocks * 512 : (sb)->st_size)
end_define
